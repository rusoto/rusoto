...
impl CreateEnvironmentEC2Error {
    ...
    ) -> RusotoError<CreateEnvironmentEC2Error> {
        match err {
...
impl DeleteEnvironmentError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<DeleteEnvironmentError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DescribeEnvironmentStatusError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DescribeEnvironmentStatusError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DescribeEnvironmentsError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DescribeEnvironmentsError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ListEnvironmentsError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<ListEnvironmentsError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl UpdateEnvironmentError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<UpdateEnvironmentError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl Cloud9 for Cloud9Client {
    ...
    async fn create_environment_ec2(
        ...
        let response = self
            ...
            .await
            .map_err(CreateEnvironmentEC2Error::refine)?;
    ...
    ) -> Result<CreateEnvironmentMembershipResult, RusotoError<CreateEnvironmentMembershipError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(CreateEnvironmentMembershipError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn delete_environment(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DeleteEnvironmentError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    ) -> Result<DeleteEnvironmentMembershipResult, RusotoError<DeleteEnvironmentMembershipError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DeleteEnvironmentMembershipError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    > {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeEnvironmentMembershipsError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn describe_environment_status(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeEnvironmentStatusError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn list_environments(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListEnvironmentsError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    ) -> Result<UpdateEnvironmentMembershipResult, RusotoError<UpdateEnvironmentMembershipError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(UpdateEnvironmentMembershipError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
