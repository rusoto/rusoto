...
pub struct AccountSettings {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub unmetered_devices: Option<::std::collections::HashMap<DevicePlatform, i64>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub unmetered_remote_access_devices: Option<::std::collections::HashMap<DevicePlatform, i64>>,
}
...
pub struct UnknownArtifactCategory {
    name: String,
}
...
pub enum ArtifactCategory {
    ...
    Screenshot,
    #[doc(hidden)]
    UnknownVariant(UnknownArtifactCategory),
}

impl Default for ArtifactCategory {
    fn default() -> Self {
        "".into()
    }
}
...
impl rusoto_core::param::ToParam for ArtifactCategory {
...
impl Into<String> for ArtifactCategory {
    fn into(self) -> String {
        match self {
            ArtifactCategory::File => "FILE".to_string(),
            ArtifactCategory::Log => "LOG".to_string(),
            ArtifactCategory::Screenshot => "SCREENSHOT".to_string(),
            ArtifactCategory::UnknownVariant(UnknownArtifactCategory { name: original }) => {
                original
            }
        }
    }
...
impl<'a> Into<&'a str> for &'a ArtifactCategory {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for ArtifactCategory {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => ArtifactCategory::UnknownVariant(UnknownArtifactCategory {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for ArtifactCategory {
    fn from(name: String) -> Self {
        match &*name {
            "FILE" => ArtifactCategory::File,
            "LOG" => ArtifactCategory::Log,
            "SCREENSHOT" => ArtifactCategory::Screenshot,
            _ => ArtifactCategory::UnknownVariant(UnknownArtifactCategory { name }),
        }
    }
}
...
impl Serialize for ArtifactCategory {
...
pub enum ArtifactType {
    ...
    XctestLog,
    #[doc(hidden)]
    UnknownVariant(UnknownArtifactType),
}
...
impl rusoto_core::param::ToParam for ArtifactType {
    fn to_param(&self) -> String {
        self.to_string()
    }
}
...
impl Into<String> for ArtifactType {
    fn into(self) -> String {
        match self {
            ArtifactType::AppiumJavaOutput => "APPIUM_JAVA_OUTPUT".to_string(),
            ArtifactType::AppiumJavaXmlOutput => "APPIUM_JAVA_XML_OUTPUT".to_string(),
            ArtifactType::AppiumPythonOutput => "APPIUM_PYTHON_OUTPUT".to_string(),
            ArtifactType::AppiumPythonXmlOutput => "APPIUM_PYTHON_XML_OUTPUT".to_string(),
            ArtifactType::AppiumServerOutput => "APPIUM_SERVER_OUTPUT".to_string(),
            ArtifactType::ApplicationCrashReport => "APPLICATION_CRASH_REPORT".to_string(),
            ArtifactType::AutomationOutput => "AUTOMATION_OUTPUT".to_string(),
            ArtifactType::CalabashJavaXmlOutput => "CALABASH_JAVA_XML_OUTPUT".to_string(),
            ArtifactType::CalabashJsonOutput => "CALABASH_JSON_OUTPUT".to_string(),
            ArtifactType::CalabashPrettyOutput => "CALABASH_PRETTY_OUTPUT".to_string(),
            ArtifactType::CalabashStandardOutput => "CALABASH_STANDARD_OUTPUT".to_string(),
            ArtifactType::CustomerArtifact => "CUSTOMER_ARTIFACT".to_string(),
            ArtifactType::CustomerArtifactLog => "CUSTOMER_ARTIFACT_LOG".to_string(),
            ArtifactType::DeviceLog => "DEVICE_LOG".to_string(),
            ArtifactType::ExerciserMonkeyOutput => "EXERCISER_MONKEY_OUTPUT".to_string(),
            ArtifactType::ExplorerEventLog => "EXPLORER_EVENT_LOG".to_string(),
            ArtifactType::ExplorerSummaryLog => "EXPLORER_SUMMARY_LOG".to_string(),
            ArtifactType::InstrumentationOutput => "INSTRUMENTATION_OUTPUT".to_string(),
            ArtifactType::MessageLog => "MESSAGE_LOG".to_string(),
            ArtifactType::ResultLog => "RESULT_LOG".to_string(),
            ArtifactType::Screenshot => "SCREENSHOT".to_string(),
            ArtifactType::ServiceLog => "SERVICE_LOG".to_string(),
            ArtifactType::TestspecOutput => "TESTSPEC_OUTPUT".to_string(),
            ArtifactType::Unknown => "UNKNOWN".to_string(),
            ArtifactType::Video => "VIDEO".to_string(),
            ArtifactType::VideoLog => "VIDEO_LOG".to_string(),
            ArtifactType::WebkitLog => "WEBKIT_LOG".to_string(),
            ArtifactType::XctestLog => "XCTEST_LOG".to_string(),
            ArtifactType::UnknownVariant(UnknownArtifactType { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a ArtifactType {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for ArtifactType {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => ArtifactType::UnknownVariant(UnknownArtifactType {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for ArtifactType {
    fn from(name: String) -> Self {
        match &*name {
            ...
            "WEBKIT_LOG" => ArtifactType::WebkitLog,
            "XCTEST_LOG" => ArtifactType::XctestLog,
            _ => ArtifactType::UnknownVariant(UnknownArtifactType { name }),
        }
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownBillingMethod {
    name: String,
}
...
pub enum BillingMethod {
    ...
    Unmetered,
    #[doc(hidden)]
    UnknownVariant(UnknownBillingMethod),
}

impl Default for BillingMethod {
    fn default() -> Self {
        "".into()
    }
}
...
impl rusoto_core::param::ToParam for BillingMethod {
    fn to_param(&self) -> String {
        self.to_string()
    }
}
...
impl Into<String> for BillingMethod {
    fn into(self) -> String {
        match self {
            BillingMethod::Metered => "METERED".to_string(),
            BillingMethod::Unmetered => "UNMETERED".to_string(),
            BillingMethod::UnknownVariant(UnknownBillingMethod { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a BillingMethod {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for BillingMethod {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => BillingMethod::UnknownVariant(UnknownBillingMethod {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for BillingMethod {
    fn from(name: String) -> Self {
        match &*name {
            "METERED" => BillingMethod::Metered,
            "UNMETERED" => BillingMethod::Unmetered,
            _ => BillingMethod::UnknownVariant(UnknownBillingMethod { name }),
        }
    }
}
...
impl Serialize for BillingMethod {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> Deserialize<'de> for BillingMethod {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownDeviceAttribute {
    name: String,
}
...
pub enum DeviceAttribute {
    ...
    RemoteDebugEnabled,
    #[doc(hidden)]
    UnknownVariant(UnknownDeviceAttribute),
}
...
impl rusoto_core::param::ToParam for DeviceAttribute {
    fn to_param(&self) -> String {
        self.to_string()
    }
}
...
impl Into<String> for DeviceAttribute {
    fn into(self) -> String {
        match self {
            DeviceAttribute::AppiumVersion => "APPIUM_VERSION".to_string(),
            DeviceAttribute::Arn => "ARN".to_string(),
            DeviceAttribute::Availability => "AVAILABILITY".to_string(),
            DeviceAttribute::FleetType => "FLEET_TYPE".to_string(),
            DeviceAttribute::FormFactor => "FORM_FACTOR".to_string(),
            DeviceAttribute::InstanceArn => "INSTANCE_ARN".to_string(),
            DeviceAttribute::InstanceLabels => "INSTANCE_LABELS".to_string(),
            DeviceAttribute::Manufacturer => "MANUFACTURER".to_string(),
            DeviceAttribute::Model => "MODEL".to_string(),
            DeviceAttribute::OsVersion => "OS_VERSION".to_string(),
            DeviceAttribute::Platform => "PLATFORM".to_string(),
            DeviceAttribute::RemoteAccessEnabled => "REMOTE_ACCESS_ENABLED".to_string(),
            DeviceAttribute::RemoteDebugEnabled => "REMOTE_DEBUG_ENABLED".to_string(),
            DeviceAttribute::UnknownVariant(UnknownDeviceAttribute { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a DeviceAttribute {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for DeviceAttribute {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => DeviceAttribute::UnknownVariant(UnknownDeviceAttribute {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for DeviceAttribute {
    fn from(name: String) -> Self {
        match &*name {
            ...
            "REMOTE_ACCESS_ENABLED" => DeviceAttribute::RemoteAccessEnabled,
            "REMOTE_DEBUG_ENABLED" => DeviceAttribute::RemoteDebugEnabled,
            _ => DeviceAttribute::UnknownVariant(UnknownDeviceAttribute { name }),
        }
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownDeviceAvailability {
    name: String,
}
...
pub enum DeviceAvailability {
    ...
    #[doc(hidden)]
    UnknownVariant(UnknownDeviceAvailability),
}
...
impl fmt::Display for DeviceAvailability {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.into())
    }
}

impl rusoto_core::param::ToParam for DeviceAvailability {
    fn to_param(&self) -> String {
        self.to_string()
    }
}

impl Into<String> for DeviceAvailability {
    fn into(self) -> String {
        match self {
            DeviceAvailability::Available => "AVAILABLE".to_string(),
            DeviceAvailability::Busy => "BUSY".to_string(),
            DeviceAvailability::HighlyAvailable => "HIGHLY_AVAILABLE".to_string(),
            DeviceAvailability::TemporaryNotAvailable => "TEMPORARY_NOT_AVAILABLE".to_string(),
            DeviceAvailability::UnknownVariant(UnknownDeviceAvailability { name: original }) => {
                original
            }
        }
    }
...
impl<'a> Into<&'a str> for &'a DeviceAvailability {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for DeviceAvailability {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => DeviceAvailability::UnknownVariant(UnknownDeviceAvailability {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for DeviceAvailability {
    fn from(name: String) -> Self {
        match &*name {
            "AVAILABLE" => DeviceAvailability::Available,
            "BUSY" => DeviceAvailability::Busy,
            "HIGHLY_AVAILABLE" => DeviceAvailability::HighlyAvailable,
            "TEMPORARY_NOT_AVAILABLE" => DeviceAvailability::TemporaryNotAvailable,
            _ => DeviceAvailability::UnknownVariant(UnknownDeviceAvailability { name }),
        }
    }
}
...
#[cfg(any(test, feature = "serialize_structs"))]
impl Serialize for DeviceAvailability {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> Deserialize<'de> for DeviceAvailability {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownDeviceFilterAttribute {
    name: String,
}
...
pub enum DeviceFilterAttribute {
    ...
    RemoteDebugEnabled,
    #[doc(hidden)]
    UnknownVariant(UnknownDeviceFilterAttribute),
}

impl Default for DeviceFilterAttribute {
    fn default() -> Self {
        "".into()
    }
}

impl fmt::Display for DeviceFilterAttribute {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.into())
    }
}

impl rusoto_core::param::ToParam for DeviceFilterAttribute {
    fn to_param(&self) -> String {
        self.to_string()
    }
}

impl Into<String> for DeviceFilterAttribute {
    fn into(self) -> String {
        match self {
            DeviceFilterAttribute::Arn => "ARN".to_string(),
            DeviceFilterAttribute::Availability => "AVAILABILITY".to_string(),
            DeviceFilterAttribute::FleetType => "FLEET_TYPE".to_string(),
            DeviceFilterAttribute::FormFactor => "FORM_FACTOR".to_string(),
            DeviceFilterAttribute::InstanceArn => "INSTANCE_ARN".to_string(),
            DeviceFilterAttribute::InstanceLabels => "INSTANCE_LABELS".to_string(),
            DeviceFilterAttribute::Manufacturer => "MANUFACTURER".to_string(),
            DeviceFilterAttribute::Model => "MODEL".to_string(),
            DeviceFilterAttribute::OsVersion => "OS_VERSION".to_string(),
            DeviceFilterAttribute::Platform => "PLATFORM".to_string(),
            DeviceFilterAttribute::RemoteAccessEnabled => "REMOTE_ACCESS_ENABLED".to_string(),
            DeviceFilterAttribute::RemoteDebugEnabled => "REMOTE_DEBUG_ENABLED".to_string(),
            DeviceFilterAttribute::UnknownVariant(UnknownDeviceFilterAttribute {
                name: original,
            }) => original,
        }
    }
...
impl<'a> Into<&'a str> for &'a DeviceFilterAttribute {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for DeviceFilterAttribute {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => DeviceFilterAttribute::UnknownVariant(UnknownDeviceFilterAttribute {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for DeviceFilterAttribute {
    fn from(name: String) -> Self {
        match &*name {
            "ARN" => DeviceFilterAttribute::Arn,
            "AVAILABILITY" => DeviceFilterAttribute::Availability,
            ...
            "REMOTE_ACCESS_ENABLED" => DeviceFilterAttribute::RemoteAccessEnabled,
            "REMOTE_DEBUG_ENABLED" => DeviceFilterAttribute::RemoteDebugEnabled,
            _ => DeviceFilterAttribute::UnknownVariant(UnknownDeviceFilterAttribute { name }),
        }
    }
}
...
impl Serialize for DeviceFilterAttribute {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> Deserialize<'de> for DeviceFilterAttribute {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownDeviceFormFactor {
    name: String,
}
...
pub enum DeviceFormFactor {
    ...
    Tablet,
    #[doc(hidden)]
    UnknownVariant(UnknownDeviceFormFactor),
}
...
impl fmt::Display for DeviceFormFactor {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.into())
    }
}

impl rusoto_core::param::ToParam for DeviceFormFactor {
    fn to_param(&self) -> String {
        self.to_string()
    }
}
...
impl Into<String> for DeviceFormFactor {
    fn into(self) -> String {
        match self {
            DeviceFormFactor::Phone => "PHONE".to_string(),
            DeviceFormFactor::Tablet => "TABLET".to_string(),
            DeviceFormFactor::UnknownVariant(UnknownDeviceFormFactor { name: original }) => {
                original
            }
        }
    }
...
impl<'a> Into<&'a str> for &'a DeviceFormFactor {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for DeviceFormFactor {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => DeviceFormFactor::UnknownVariant(UnknownDeviceFormFactor {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for DeviceFormFactor {
    fn from(name: String) -> Self {
        match &*name {
            "PHONE" => DeviceFormFactor::Phone,
            "TABLET" => DeviceFormFactor::Tablet,
            _ => DeviceFormFactor::UnknownVariant(UnknownDeviceFormFactor { name }),
        }
    }
}
...
#[cfg(any(test, feature = "serialize_structs"))]
impl Serialize for DeviceFormFactor {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> Deserialize<'de> for DeviceFormFactor {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownDevicePlatform {
    name: String,
}
...
pub enum DevicePlatform {
    ...
    Ios,
    #[doc(hidden)]
    UnknownVariant(UnknownDevicePlatform),
}
...
impl rusoto_core::param::ToParam for DevicePlatform {
    fn to_param(&self) -> String {
        self.to_string()
    }
}
...
impl Into<String> for DevicePlatform {
    fn into(self) -> String {
        match self {
            ...
            DevicePlatform::UnknownVariant(UnknownDevicePlatform { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a DevicePlatform {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for DevicePlatform {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => DevicePlatform::UnknownVariant(UnknownDevicePlatform {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for DevicePlatform {
    fn from(name: String) -> Self {
        match &*name {
            "ANDROID" => DevicePlatform::Android,
            "IOS" => DevicePlatform::Ios,
            _ => DevicePlatform::UnknownVariant(UnknownDevicePlatform { name }),
        }
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownDevicePoolType {
    name: String,
}
...
pub enum DevicePoolType {
    ...
    Private,
    #[doc(hidden)]
    UnknownVariant(UnknownDevicePoolType),
}

impl Default for DevicePoolType {
    fn default() -> Self {
        "".into()
    }
}

impl fmt::Display for DevicePoolType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.into())
    }
}

impl rusoto_core::param::ToParam for DevicePoolType {
    fn to_param(&self) -> String {
        self.to_string()
    }
}
...
impl Into<String> for DevicePoolType {
    fn into(self) -> String {
        match self {
            DevicePoolType::Curated => "CURATED".to_string(),
            DevicePoolType::Private => "PRIVATE".to_string(),
            DevicePoolType::UnknownVariant(UnknownDevicePoolType { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a DevicePoolType {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for DevicePoolType {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => DevicePoolType::UnknownVariant(UnknownDevicePoolType {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for DevicePoolType {
    fn from(name: String) -> Self {
        match &*name {
            "CURATED" => DevicePoolType::Curated,
            "PRIVATE" => DevicePoolType::Private,
            _ => DevicePoolType::UnknownVariant(UnknownDevicePoolType { name }),
        }
    }
}
...
impl Serialize for DevicePoolType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> Deserialize<'de> for DevicePoolType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownExecutionResult {
    name: String,
}
...
pub enum ExecutionResult {
    ...
    Warned,
    #[doc(hidden)]
    UnknownVariant(UnknownExecutionResult),
}
...
impl rusoto_core::param::ToParam for ExecutionResult {
    fn to_param(&self) -> String {
        self.to_string()
    }
}
...
impl Into<String> for ExecutionResult {
    fn into(self) -> String {
        match self {
            ExecutionResult::Errored => "ERRORED".to_string(),
            ExecutionResult::Failed => "FAILED".to_string(),
            ExecutionResult::Passed => "PASSED".to_string(),
            ExecutionResult::Pending => "PENDING".to_string(),
            ExecutionResult::Skipped => "SKIPPED".to_string(),
            ExecutionResult::Stopped => "STOPPED".to_string(),
            ExecutionResult::Warned => "WARNED".to_string(),
            ExecutionResult::UnknownVariant(UnknownExecutionResult { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a ExecutionResult {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for ExecutionResult {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => ExecutionResult::UnknownVariant(UnknownExecutionResult {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for ExecutionResult {
    fn from(name: String) -> Self {
        match &*name {
            ...
            "STOPPED" => ExecutionResult::Stopped,
            "WARNED" => ExecutionResult::Warned,
            _ => ExecutionResult::UnknownVariant(UnknownExecutionResult { name }),
        }
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownExecutionResultCode {
    name: String,
}
...
pub enum ExecutionResultCode {
    ...
    #[doc(hidden)]
    UnknownVariant(UnknownExecutionResultCode),
}

impl Default for ExecutionResultCode {
    fn default() -> Self {
        "".into()
    }
}

impl fmt::Display for ExecutionResultCode {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.into())
    }
}

impl rusoto_core::param::ToParam for ExecutionResultCode {
    fn to_param(&self) -> String {
        self.to_string()
    }
}

impl Into<String> for ExecutionResultCode {
    fn into(self) -> String {
        match self {
            ExecutionResultCode::ParsingFailed => "PARSING_FAILED".to_string(),
            ExecutionResultCode::VpcEndpointSetupFailed => "VPC_ENDPOINT_SETUP_FAILED".to_string(),
            ExecutionResultCode::UnknownVariant(UnknownExecutionResultCode { name: original }) => {
                original
            }
        }
    }
...
impl<'a> Into<&'a str> for &'a ExecutionResultCode {
    fn into(self) -> &'a str {
        match self {
...
impl From<String> for ExecutionResultCode {
    fn from(name: String) -> Self {
        match &*name {
            "PARSING_FAILED" => ExecutionResultCode::ParsingFailed,
            "VPC_ENDPOINT_SETUP_FAILED" => ExecutionResultCode::VpcEndpointSetupFailed,
            _ => ExecutionResultCode::UnknownVariant(UnknownExecutionResultCode { name }),
        }
    }
}
...
#[cfg(any(test, feature = "serialize_structs"))]
impl Serialize for ExecutionResultCode {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> Deserialize<'de> for ExecutionResultCode {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
impl Into<String> for ExecutionStatus {
    fn into(self) -> String {
        match self {
            ...
            ExecutionStatus::PendingConcurrency => "PENDING_CONCURRENCY".to_string(),
            ExecutionStatus::PendingDevice => "PENDING_DEVICE".to_string(),
            ExecutionStatus::Preparing => "PREPARING".to_string(),
            ExecutionStatus::Processing => "PROCESSING".to_string(),
            ExecutionStatus::Running => "RUNNING".to_string(),
            ExecutionStatus::Scheduling => "SCHEDULING".to_string(),
...
impl From<&str> for ExecutionStatus {
    fn from(name: &str) -> Self {
        match name {
            ...
            "PENDING_CONCURRENCY" => ExecutionStatus::PendingConcurrency,
...
impl Into<String> for InstanceStatus {
    fn into(self) -> String {
        match self {
            InstanceStatus::Available => "AVAILABLE".to_string(),
            InstanceStatus::InUse => "IN_USE".to_string(),
            InstanceStatus::NotAvailable => "NOT_AVAILABLE".to_string(),
            InstanceStatus::Preparing => "PREPARING".to_string(),
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownInteractionMode {
    name: String,
}
...
pub enum InteractionMode {
    ...
    VideoOnly,
    #[doc(hidden)]
    UnknownVariant(UnknownInteractionMode),
}
...
impl rusoto_core::param::ToParam for InteractionMode {
    fn to_param(&self) -> String {
        self.to_string()
    }
}

impl Into<String> for InteractionMode {
    fn into(self) -> String {
        match self {
            InteractionMode::Interactive => "INTERACTIVE".to_string(),
            InteractionMode::NoVideo => "NO_VIDEO".to_string(),
            InteractionMode::VideoOnly => "VIDEO_ONLY".to_string(),
            InteractionMode::UnknownVariant(UnknownInteractionMode { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a InteractionMode {
    fn into(self) -> &'a str {
        match self {
...
impl From<String> for InteractionMode {
    fn from(name: String) -> Self {
        match &*name {
            "INTERACTIVE" => InteractionMode::Interactive,
            "NO_VIDEO" => InteractionMode::NoVideo,
            "VIDEO_ONLY" => InteractionMode::VideoOnly,
            _ => InteractionMode::UnknownVariant(UnknownInteractionMode { name }),
        }
    }
}
...
pub struct ListTestGridSessionArtifactsRequest {
    ...
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub type_: Option<TestGridSessionArtifactCategory>,
}
...
pub struct ListUniqueProblemsResult {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub unique_problems: Option<::std::collections::HashMap<ExecutionResult, Vec<UniqueProblem>>>,
}
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownNetworkProfileType {
    name: String,
}
...
pub enum NetworkProfileType {
    ...
    Private,
    #[doc(hidden)]
    UnknownVariant(UnknownNetworkProfileType),
}

impl Default for NetworkProfileType {
    fn default() -> Self {
        "".into()
    }
}

impl fmt::Display for NetworkProfileType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.into())
    }
}

impl rusoto_core::param::ToParam for NetworkProfileType {
    fn to_param(&self) -> String {
        self.to_string()
    }
}
...
impl Into<String> for NetworkProfileType {
    fn into(self) -> String {
        match self {
            NetworkProfileType::Curated => "CURATED".to_string(),
            NetworkProfileType::Private => "PRIVATE".to_string(),
            NetworkProfileType::UnknownVariant(UnknownNetworkProfileType { name: original }) => {
                original
            }
        }
    }
...
impl<'a> Into<&'a str> for &'a NetworkProfileType {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for NetworkProfileType {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => NetworkProfileType::UnknownVariant(UnknownNetworkProfileType {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for NetworkProfileType {
    fn from(name: String) -> Self {
        match &*name {
            "CURATED" => NetworkProfileType::Curated,
            "PRIVATE" => NetworkProfileType::Private,
            _ => NetworkProfileType::UnknownVariant(UnknownNetworkProfileType { name }),
        }
    }
}
...
impl Serialize for NetworkProfileType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> Deserialize<'de> for NetworkProfileType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownOfferingTransactionType {
    name: String,
}
...
pub enum OfferingTransactionType {
    ...
    System,
    #[doc(hidden)]
    UnknownVariant(UnknownOfferingTransactionType),
}

impl Default for OfferingTransactionType {
    fn default() -> Self {
        "".into()
    }
}

impl fmt::Display for OfferingTransactionType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.into())
    }
}

impl rusoto_core::param::ToParam for OfferingTransactionType {
    fn to_param(&self) -> String {
        self.to_string()
    }
}
...
impl Into<String> for OfferingTransactionType {
    fn into(self) -> String {
        match self {
            OfferingTransactionType::Purchase => "PURCHASE".to_string(),
            OfferingTransactionType::Renew => "RENEW".to_string(),
            OfferingTransactionType::System => "SYSTEM".to_string(),
            OfferingTransactionType::UnknownVariant(UnknownOfferingTransactionType {
                name: original,
            }) => original,
        }
    }
...
impl<'a> Into<&'a str> for &'a OfferingTransactionType {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for OfferingTransactionType {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => OfferingTransactionType::UnknownVariant(UnknownOfferingTransactionType {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for OfferingTransactionType {
    fn from(name: String) -> Self {
        match &*name {
            "PURCHASE" => OfferingTransactionType::Purchase,
            "RENEW" => OfferingTransactionType::Renew,
            "SYSTEM" => OfferingTransactionType::System,
            _ => OfferingTransactionType::UnknownVariant(UnknownOfferingTransactionType { name }),
        }
    }
}
...
#[cfg(any(test, feature = "serialize_structs"))]
impl Serialize for OfferingTransactionType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> Deserialize<'de> for OfferingTransactionType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
impl Into<String> for OfferingType {
    fn into(self) -> String {
        match self {
            OfferingType::Recurring => "RECURRING".to_string(),
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownRecurringChargeFrequency {
    name: String,
}
...
pub enum RecurringChargeFrequency {
    Monthly,
    #[doc(hidden)]
    UnknownVariant(UnknownRecurringChargeFrequency),
}

impl Default for RecurringChargeFrequency {
    fn default() -> Self {
        "".into()
    }
}

impl fmt::Display for RecurringChargeFrequency {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.into())
    }
}

impl rusoto_core::param::ToParam for RecurringChargeFrequency {
    fn to_param(&self) -> String {
        self.to_string()
    }
}
...
impl Into<String> for RecurringChargeFrequency {
    fn into(self) -> String {
        match self {
            RecurringChargeFrequency::Monthly => "MONTHLY".to_string(),
            RecurringChargeFrequency::UnknownVariant(UnknownRecurringChargeFrequency {
                name: original,
            }) => original,
        }
    }
...
impl<'a> Into<&'a str> for &'a RecurringChargeFrequency {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for RecurringChargeFrequency {
    fn from(name: &str) -> Self {
        match name {
            "MONTHLY" => RecurringChargeFrequency::Monthly,
            _ => RecurringChargeFrequency::UnknownVariant(UnknownRecurringChargeFrequency {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for RecurringChargeFrequency {
    fn from(name: String) -> Self {
        match &*name {
            "MONTHLY" => RecurringChargeFrequency::Monthly,
            _ => RecurringChargeFrequency::UnknownVariant(UnknownRecurringChargeFrequency { name }),
        }
    }
}
...
#[cfg(any(test, feature = "serialize_structs"))]
impl Serialize for RecurringChargeFrequency {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> Deserialize<'de> for RecurringChargeFrequency {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownRuleOperator {
    name: String,
}
...
pub enum RuleOperator {
    ...
    NotIn,
    #[doc(hidden)]
    UnknownVariant(UnknownRuleOperator),
}
...
impl rusoto_core::param::ToParam for RuleOperator {
    fn to_param(&self) -> String {
        self.to_string()
    }
}
...
impl Into<String> for RuleOperator {
    fn into(self) -> String {
        match self {
            ...
            RuleOperator::GreaterThanOrEquals => "GREATER_THAN_OR_EQUALS".to_string(),
            RuleOperator::In => "IN".to_string(),
            RuleOperator::LessThan => "LESS_THAN".to_string(),
            RuleOperator::LessThanOrEquals => "LESS_THAN_OR_EQUALS".to_string(),
            RuleOperator::NotIn => "NOT_IN".to_string(),
            RuleOperator::UnknownVariant(UnknownRuleOperator { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a RuleOperator {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for RuleOperator {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => RuleOperator::UnknownVariant(UnknownRuleOperator {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for RuleOperator {
    fn from(name: String) -> Self {
        match &*name {
            ...
            "LESS_THAN_OR_EQUALS" => RuleOperator::LessThanOrEquals,
            "NOT_IN" => RuleOperator::NotIn,
            _ => RuleOperator::UnknownVariant(UnknownRuleOperator { name }),
        }
    }
}
...
impl Serialize for RuleOperator {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
pub enum SampleType {
    ...
    TxRate,
    #[doc(hidden)]
    UnknownVariant(UnknownSampleType),
}
...
impl rusoto_core::param::ToParam for SampleType {
    fn to_param(&self) -> String {
        self.to_string()
    }
}
...
impl Into<String> for SampleType {
    fn into(self) -> String {
        match self {
            SampleType::Cpu => "CPU".to_string(),
            SampleType::Memory => "MEMORY".to_string(),
            SampleType::NativeAvgDrawtime => "NATIVE_AVG_DRAWTIME".to_string(),
            SampleType::NativeFps => "NATIVE_FPS".to_string(),
            SampleType::NativeFrames => "NATIVE_FRAMES".to_string(),
            SampleType::NativeMaxDrawtime => "NATIVE_MAX_DRAWTIME".to_string(),
            SampleType::NativeMinDrawtime => "NATIVE_MIN_DRAWTIME".to_string(),
            SampleType::OpenglAvgDrawtime => "OPENGL_AVG_DRAWTIME".to_string(),
            SampleType::OpenglFps => "OPENGL_FPS".to_string(),
            SampleType::OpenglFrames => "OPENGL_FRAMES".to_string(),
            SampleType::OpenglMaxDrawtime => "OPENGL_MAX_DRAWTIME".to_string(),
            SampleType::OpenglMinDrawtime => "OPENGL_MIN_DRAWTIME".to_string(),
            SampleType::Rx => "RX".to_string(),
            SampleType::RxRate => "RX_RATE".to_string(),
            SampleType::Threads => "THREADS".to_string(),
            SampleType::Tx => "TX".to_string(),
            SampleType::TxRate => "TX_RATE".to_string(),
            SampleType::UnknownVariant(UnknownSampleType { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a SampleType {
    fn into(self) -> &'a str {
        match self {
            SampleType::Cpu => &"CPU",
...
impl From<&str> for SampleType {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => SampleType::UnknownVariant(UnknownSampleType {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for SampleType {
    fn from(name: String) -> Self {
        match &*name {
            "CPU" => SampleType::Cpu,
            "MEMORY" => SampleType::Memory,
            ...
            "TX" => SampleType::Tx,
            "TX_RATE" => SampleType::TxRate,
            _ => SampleType::UnknownVariant(UnknownSampleType { name }),
        }
    }
}
...
pub struct TestGridSessionArtifact {
    ...
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub type_: Option<TestGridSessionArtifactType>,
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownTestGridSessionArtifactCategory {
    name: String,
}
...
pub enum TestGridSessionArtifactCategory {
    ...
    Video,
    #[doc(hidden)]
    UnknownVariant(UnknownTestGridSessionArtifactCategory),
}

impl Default for TestGridSessionArtifactCategory {
    fn default() -> Self {
        "".into()
    }
}

impl fmt::Display for TestGridSessionArtifactCategory {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.into())
    }
}

impl rusoto_core::param::ToParam for TestGridSessionArtifactCategory {
    fn to_param(&self) -> String {
        self.to_string()
    }
}

impl Into<String> for TestGridSessionArtifactCategory {
    fn into(self) -> String {
        match self {
            TestGridSessionArtifactCategory::Log => "LOG".to_string(),
            TestGridSessionArtifactCategory::Video => "VIDEO".to_string(),
            TestGridSessionArtifactCategory::UnknownVariant(
                UnknownTestGridSessionArtifactCategory { name: original },
            ) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a TestGridSessionArtifactCategory {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for TestGridSessionArtifactCategory {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => TestGridSessionArtifactCategory::UnknownVariant(
                UnknownTestGridSessionArtifactCategory {
                    name: name.to_owned(),
                },
            ),
        }
...
impl From<String> for TestGridSessionArtifactCategory {
    fn from(name: String) -> Self {
        match &*name {
            "LOG" => TestGridSessionArtifactCategory::Log,
            "VIDEO" => TestGridSessionArtifactCategory::Video,
            _ => TestGridSessionArtifactCategory::UnknownVariant(
                UnknownTestGridSessionArtifactCategory { name },
            ),
        }
    }
}
...
impl Serialize for TestGridSessionArtifactCategory {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
#[cfg(feature = "deserialize_structs")]
impl<'de> Deserialize<'de> for TestGridSessionArtifactCategory {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownTestGridSessionArtifactType {
    name: String,
}
...
pub enum TestGridSessionArtifactType {
    ...
    Video,
    #[doc(hidden)]
    UnknownVariant(UnknownTestGridSessionArtifactType),
}

impl Default for TestGridSessionArtifactType {
    fn default() -> Self {
        "".into()
    }
}

impl fmt::Display for TestGridSessionArtifactType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.into())
    }
}

impl rusoto_core::param::ToParam for TestGridSessionArtifactType {
    fn to_param(&self) -> String {
        self.to_string()
    }
}

impl Into<String> for TestGridSessionArtifactType {
    fn into(self) -> String {
        match self {
            TestGridSessionArtifactType::SeleniumLog => "SELENIUM_LOG".to_string(),
            TestGridSessionArtifactType::Unknown => "UNKNOWN".to_string(),
            TestGridSessionArtifactType::Video => "VIDEO".to_string(),
            TestGridSessionArtifactType::UnknownVariant(UnknownTestGridSessionArtifactType {
                name: original,
            }) => original,
        }
    }
...
impl<'a> Into<&'a str> for &'a TestGridSessionArtifactType {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for TestGridSessionArtifactType {
    fn from(name: &str) -> Self {
        match name {
            "SELENIUM_LOG" => TestGridSessionArtifactType::SeleniumLog,
            "UNKNOWN" => TestGridSessionArtifactType::Unknown,
            "VIDEO" => TestGridSessionArtifactType::Video,
            _ => TestGridSessionArtifactType::UnknownVariant(UnknownTestGridSessionArtifactType {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for TestGridSessionArtifactType {
    fn from(name: String) -> Self {
        match &*name {
            "SELENIUM_LOG" => TestGridSessionArtifactType::SeleniumLog,
            "UNKNOWN" => TestGridSessionArtifactType::Unknown,
...
#[cfg(any(test, feature = "serialize_structs"))]
impl Serialize for TestGridSessionArtifactType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> Deserialize<'de> for TestGridSessionArtifactType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownTestGridSessionStatus {
    name: String,
}
...
pub enum TestGridSessionStatus {
    ...
    Errored,
    #[doc(hidden)]
    UnknownVariant(UnknownTestGridSessionStatus),
}

impl Default for TestGridSessionStatus {
    fn default() -> Self {
        "".into()
    }
}

impl fmt::Display for TestGridSessionStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.into())
    }
}

impl rusoto_core::param::ToParam for TestGridSessionStatus {
    fn to_param(&self) -> String {
        self.to_string()
    }
}

impl Into<String> for TestGridSessionStatus {
    fn into(self) -> String {
        match self {
            TestGridSessionStatus::Active => "ACTIVE".to_string(),
            TestGridSessionStatus::Closed => "CLOSED".to_string(),
            TestGridSessionStatus::Errored => "ERRORED".to_string(),
            TestGridSessionStatus::UnknownVariant(UnknownTestGridSessionStatus {
                name: original,
            }) => original,
        }
    }
...
impl<'a> Into<&'a str> for &'a TestGridSessionStatus {
    fn into(self) -> &'a str {
        match self {
...
impl From<String> for TestGridSessionStatus {
    fn from(name: String) -> Self {
        match &*name {
            "ACTIVE" => TestGridSessionStatus::Active,
            "CLOSED" => TestGridSessionStatus::Closed,
            "ERRORED" => TestGridSessionStatus::Errored,
            _ => TestGridSessionStatus::UnknownVariant(UnknownTestGridSessionStatus { name }),
        }
    }
}
...
impl Serialize for TestGridSessionStatus {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> Deserialize<'de> for TestGridSessionStatus {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
pub enum TestType {
    ...
    XctestUi,
    #[doc(hidden)]
    UnknownVariant(UnknownTestType),
}
...
impl rusoto_core::param::ToParam for TestType {
    fn to_param(&self) -> String {
        self.to_string()
    }
}
...
impl Into<String> for TestType {
    fn into(self) -> String {
        match self {
            TestType::AppiumJavaJunit => "APPIUM_JAVA_JUNIT".to_string(),
            TestType::AppiumJavaTestng => "APPIUM_JAVA_TESTNG".to_string(),
            TestType::AppiumNode => "APPIUM_NODE".to_string(),
            TestType::AppiumPython => "APPIUM_PYTHON".to_string(),
            TestType::AppiumRuby => "APPIUM_RUBY".to_string(),
            TestType::AppiumWebJavaJunit => "APPIUM_WEB_JAVA_JUNIT".to_string(),
            TestType::AppiumWebJavaTestng => "APPIUM_WEB_JAVA_TESTNG".to_string(),
            TestType::AppiumWebNode => "APPIUM_WEB_NODE".to_string(),
            TestType::AppiumWebPython => "APPIUM_WEB_PYTHON".to_string(),
            TestType::AppiumWebRuby => "APPIUM_WEB_RUBY".to_string(),
            TestType::BuiltinExplorer => "BUILTIN_EXPLORER".to_string(),
            TestType::BuiltinFuzz => "BUILTIN_FUZZ".to_string(),
            TestType::Calabash => "CALABASH".to_string(),
            TestType::Instrumentation => "INSTRUMENTATION".to_string(),
            TestType::RemoteAccessRecord => "REMOTE_ACCESS_RECORD".to_string(),
            TestType::RemoteAccessReplay => "REMOTE_ACCESS_REPLAY".to_string(),
            TestType::Uiautomation => "UIAUTOMATION".to_string(),
            TestType::Uiautomator => "UIAUTOMATOR".to_string(),
            TestType::WebPerformanceProfile => "WEB_PERFORMANCE_PROFILE".to_string(),
            TestType::Xctest => "XCTEST".to_string(),
            TestType::XctestUi => "XCTEST_UI".to_string(),
            TestType::UnknownVariant(UnknownTestType { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a TestType {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for TestType {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => TestType::UnknownVariant(UnknownTestType {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for TestType {
    fn from(name: String) -> Self {
        match &*name {
            ...
            "XCTEST" => TestType::Xctest,
            "XCTEST_UI" => TestType::XctestUi,
            _ => TestType::UnknownVariant(UnknownTestType { name }),
        }
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownUploadCategory {
    name: String,
}
...
pub enum UploadCategory {
    ...
    Private,
    #[doc(hidden)]
    UnknownVariant(UnknownUploadCategory),
}

impl Default for UploadCategory {
    fn default() -> Self {
        "".into()
    }
}
...
impl rusoto_core::param::ToParam for UploadCategory {
    fn to_param(&self) -> String {
        self.to_string()
    }
}

impl Into<String> for UploadCategory {
    fn into(self) -> String {
        match self {
            UploadCategory::Curated => "CURATED".to_string(),
            UploadCategory::Private => "PRIVATE".to_string(),
            UploadCategory::UnknownVariant(UnknownUploadCategory { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a UploadCategory {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for UploadCategory {
    fn from(name: &str) -> Self {
        match name {
            "CURATED" => UploadCategory::Curated,
            "PRIVATE" => UploadCategory::Private,
            _ => UploadCategory::UnknownVariant(UnknownUploadCategory {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for UploadCategory {
    fn from(name: String) -> Self {
        match &*name {
            "CURATED" => UploadCategory::Curated,
            "PRIVATE" => UploadCategory::Private,
            _ => UploadCategory::UnknownVariant(UnknownUploadCategory { name }),
        }
    }
}
...
impl Into<String> for UploadStatus {
    fn into(self) -> String {
        match self {
            ...
            UploadStatus::Initialized => "INITIALIZED".to_string(),
...
pub enum UploadType {
    ...
    XctestUiTestSpec,
    #[doc(hidden)]
    UnknownVariant(UnknownUploadType),
}
...
impl rusoto_core::param::ToParam for UploadType {
    fn to_param(&self) -> String {
        self.to_string()
    }
}
...
impl Into<String> for UploadType {
    fn into(self) -> String {
        match self {
            UploadType::AndroidApp => "ANDROID_APP".to_string(),
            UploadType::AppiumJavaJunitTestPackage => "APPIUM_JAVA_JUNIT_TEST_PACKAGE".to_string(),
            UploadType::AppiumJavaJunitTestSpec => "APPIUM_JAVA_JUNIT_TEST_SPEC".to_string(),
            UploadType::AppiumJavaTestngTestPackage => {
                "APPIUM_JAVA_TESTNG_TEST_PACKAGE".to_string()
            }
            UploadType::AppiumJavaTestngTestSpec => "APPIUM_JAVA_TESTNG_TEST_SPEC".to_string(),
            UploadType::AppiumNodeTestPackage => "APPIUM_NODE_TEST_PACKAGE".to_string(),
            UploadType::AppiumNodeTestSpec => "APPIUM_NODE_TEST_SPEC".to_string(),
            UploadType::AppiumPythonTestPackage => "APPIUM_PYTHON_TEST_PACKAGE".to_string(),
            UploadType::AppiumPythonTestSpec => "APPIUM_PYTHON_TEST_SPEC".to_string(),
            UploadType::AppiumRubyTestPackage => "APPIUM_RUBY_TEST_PACKAGE".to_string(),
            UploadType::AppiumRubyTestSpec => "APPIUM_RUBY_TEST_SPEC".to_string(),
            UploadType::AppiumWebJavaJunitTestPackage => {
                "APPIUM_WEB_JAVA_JUNIT_TEST_PACKAGE".to_string()
            }
            UploadType::AppiumWebJavaJunitTestSpec => "APPIUM_WEB_JAVA_JUNIT_TEST_SPEC".to_string(),
            UploadType::AppiumWebJavaTestngTestPackage => {
                "APPIUM_WEB_JAVA_TESTNG_TEST_PACKAGE".to_string()
            }
            UploadType::AppiumWebJavaTestngTestSpec => {
                "APPIUM_WEB_JAVA_TESTNG_TEST_SPEC".to_string()
            }
            UploadType::AppiumWebNodeTestPackage => "APPIUM_WEB_NODE_TEST_PACKAGE".to_string(),
            UploadType::AppiumWebNodeTestSpec => "APPIUM_WEB_NODE_TEST_SPEC".to_string(),
            UploadType::AppiumWebPythonTestPackage => "APPIUM_WEB_PYTHON_TEST_PACKAGE".to_string(),
            UploadType::AppiumWebPythonTestSpec => "APPIUM_WEB_PYTHON_TEST_SPEC".to_string(),
            UploadType::AppiumWebRubyTestPackage => "APPIUM_WEB_RUBY_TEST_PACKAGE".to_string(),
            UploadType::AppiumWebRubyTestSpec => "APPIUM_WEB_RUBY_TEST_SPEC".to_string(),
            UploadType::CalabashTestPackage => "CALABASH_TEST_PACKAGE".to_string(),
            UploadType::ExternalData => "EXTERNAL_DATA".to_string(),
            UploadType::InstrumentationTestPackage => "INSTRUMENTATION_TEST_PACKAGE".to_string(),
            UploadType::InstrumentationTestSpec => "INSTRUMENTATION_TEST_SPEC".to_string(),
            UploadType::IosApp => "IOS_APP".to_string(),
            UploadType::UiautomationTestPackage => "UIAUTOMATION_TEST_PACKAGE".to_string(),
            UploadType::UiautomatorTestPackage => "UIAUTOMATOR_TEST_PACKAGE".to_string(),
            UploadType::WebApp => "WEB_APP".to_string(),
            UploadType::XctestTestPackage => "XCTEST_TEST_PACKAGE".to_string(),
            UploadType::XctestUiTestPackage => "XCTEST_UI_TEST_PACKAGE".to_string(),
            UploadType::XctestUiTestSpec => "XCTEST_UI_TEST_SPEC".to_string(),
            UploadType::UnknownVariant(UnknownUploadType { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a UploadType {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for UploadType {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => UploadType::UnknownVariant(UnknownUploadType {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for UploadType {
    fn from(name: String) -> Self {
        match &*name {
            "ANDROID_APP" => UploadType::AndroidApp,
            "APPIUM_JAVA_JUNIT_TEST_PACKAGE" => UploadType::AppiumJavaJunitTestPackage,
            ...
            "XCTEST_UI_TEST_PACKAGE" => UploadType::XctestUiTestPackage,
            "XCTEST_UI_TEST_SPEC" => UploadType::XctestUiTestSpec,
            _ => UploadType::UnknownVariant(UnknownUploadType { name }),
        }
    }
}
