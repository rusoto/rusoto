...
pub trait AWSSupport {
    ...
    fn create_case(&self, input: CreateCaseRequest) -> Request<CreateCaseRequest>;
    ...
    fn describe_cases(&self, input: DescribeCasesRequest) -> Request<DescribeCasesRequest>;
    ...
    fn resolve_case(&self, input: ResolveCaseRequest) -> Request<ResolveCaseRequest>;
}
...
impl ServiceRequest for AddAttachmentsToSetRequest {
    type Output = AddAttachmentsToSetResponse;
    type Error = AddAttachmentsToSetError;
    ...
    fn dispatch(
        ...
        let mut request = SignedRequest::new("POST", "support", region, "/");
...
impl ServiceRequest for AddCommunicationToCaseRequest {
    type Output = AddCommunicationToCaseResponse;
    type Error = AddCommunicationToCaseError;
...
impl ServiceRequest for CreateCaseRequest {
    type Output = CreateCaseResponse;
    type Error = CreateCaseError;
...
impl ServiceRequest for DescribeAttachmentRequest {
    type Output = DescribeAttachmentResponse;
    type Error = DescribeAttachmentError;
...
impl ServiceRequest for DescribeCasesRequest {
    type Output = DescribeCasesResponse;
    type Error = DescribeCasesError;
...
impl ServiceRequest for DescribeCommunicationsRequest {
    type Output = DescribeCommunicationsResponse;
    type Error = DescribeCommunicationsError;
...
impl ServiceRequest for DescribeSeverityLevelsRequest {
    type Output = DescribeSeverityLevelsResponse;
    type Error = DescribeSeverityLevelsError;
...
impl ServiceRequest for DescribeTrustedAdvisorCheckRefreshStatusesRequest {
    type Output = DescribeTrustedAdvisorCheckRefreshStatusesResponse;
    type Error = DescribeTrustedAdvisorCheckRefreshStatusesError;
...
impl ServiceRequest for DescribeTrustedAdvisorCheckResultRequest {
    type Output = DescribeTrustedAdvisorCheckResultResponse;
    type Error = DescribeTrustedAdvisorCheckResultError;
...
impl ServiceRequest for DescribeTrustedAdvisorCheckSummariesRequest {
    type Output = DescribeTrustedAdvisorCheckSummariesResponse;
    type Error = DescribeTrustedAdvisorCheckSummariesError;
...
impl ServiceRequest for DescribeTrustedAdvisorChecksRequest {
    type Output = DescribeTrustedAdvisorChecksResponse;
    type Error = DescribeTrustedAdvisorChecksError;
...
impl ServiceRequest for RefreshTrustedAdvisorCheckRequest {
    type Output = RefreshTrustedAdvisorCheckResponse;
    type Error = RefreshTrustedAdvisorCheckError;
...
impl ServiceRequest for ResolveCaseRequest {
    type Output = ResolveCaseResponse;
    type Error = ResolveCaseError;
