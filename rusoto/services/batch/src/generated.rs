...
pub trait Batch {
    ...
    fn create_job_queue(
        ...
        Box<
            dyn Future<Output = Result<CreateJobQueueResponse, RusotoError<CreateJobQueueError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_job_queue(
        ...
        Box<
            dyn Future<Output = Result<DeleteJobQueueResponse, RusotoError<DeleteJobQueueError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn describe_job_queues(
        ...
        Box<
            dyn Future<
                    Output = Result<DescribeJobQueuesResponse, RusotoError<DescribeJobQueuesError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn describe_jobs(
        ...
        Box<
            dyn Future<Output = Result<DescribeJobsResponse, RusotoError<DescribeJobsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn submit_job(
        ...
        Box<
            dyn Future<Output = Result<SubmitJobResponse, RusotoError<SubmitJobError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn terminate_job(
        ...
        Box<
            dyn Future<Output = Result<TerminateJobResponse, RusotoError<TerminateJobError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn update_job_queue(
        ...
        Box<
            dyn Future<Output = Result<UpdateJobQueueResponse, RusotoError<UpdateJobQueueError>>>
                + Send
                + 'static,
        >,
    >;
