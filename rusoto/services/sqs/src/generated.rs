...
pub trait Sqs {
    ...
    fn change_message_visibility(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<ChangeMessageVisibilityError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn create_queue(
        ...
        Box<
            dyn Future<Output = Result<CreateQueueResult, RusotoError<CreateQueueError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<DeleteMessageError>>> + Send + 'static>>;
    ...
    fn delete_message_batch(
        ...
        Box<
            dyn Future<
                    Output = Result<DeleteMessageBatchResult, RusotoError<DeleteMessageBatchError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<DeleteQueueError>>> + Send + 'static>>;
    ...
    fn get_queue_attributes(
        ...
        Box<
            dyn Future<
                    Output = Result<GetQueueAttributesResult, RusotoError<GetQueueAttributesError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn get_queue_url(
        ...
        Box<
            dyn Future<Output = Result<GetQueueUrlResult, RusotoError<GetQueueUrlError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_queue_tags(
        ...
        Box<
            dyn Future<Output = Result<ListQueueTagsResult, RusotoError<ListQueueTagsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_queues(
        ...
        Box<
            dyn Future<Output = Result<ListQueuesResult, RusotoError<ListQueuesError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<PurgeQueueError>>> + Send + 'static>>;
    ...
    fn receive_message(
        ...
        Box<
            dyn Future<Output = Result<ReceiveMessageResult, RusotoError<ReceiveMessageError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn send_message(
        ...
        Box<
            dyn Future<Output = Result<SendMessageResult, RusotoError<SendMessageError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn send_message_batch(
        ...
        Box<
            dyn Future<Output = Result<SendMessageBatchResult, RusotoError<SendMessageBatchError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn set_queue_attributes(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<SetQueueAttributesError>>> + Send + 'static>,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<TagQueueError>>> + Send + 'static>>;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<UntagQueueError>>> + Send + 'static>>;
}
    ...
    > {
        ...
        async move {
            ...
            if xml_response.body.is_empty() {
                ...
                start_element(&actual_tag_name, &mut stack)?;
                result =
                    CreateQueueResultDeserializer::deserialize("CreateQueueResult", &mut stack)?;
                skip_tree(&mut stack);
                end_element(&actual_tag_name, &mut stack)?;
            }
            // parse non-payload
    ...
    > {
        ...
        async move {
            ...
            if xml_response.body.is_empty() {
                ...
                start_element(&actual_tag_name, &mut stack)?;
                result =
                    GetQueueUrlResultDeserializer::deserialize("GetQueueUrlResult", &mut stack)?;
                skip_tree(&mut stack);
                end_element(&actual_tag_name, &mut stack)?;
            }
            // parse non-payload
    ...
    > {
        ...
        async move {
            ...
            if xml_response.body.is_empty() {
                ...
                start_element(&actual_tag_name, &mut stack)?;
                result =
                    SendMessageResultDeserializer::deserialize("SendMessageResult", &mut stack)?;
                skip_tree(&mut stack);
                end_element(&actual_tag_name, &mut stack)?;
            }
            // parse non-payload
