...
pub struct ChangeMessageVisibilityBatchRequestEntry {
    /// <p><p>An identifier for this particular receipt handle used to communicate the result.</p> <note> <p>The <code>Id</code>s of a batch request need to be unique within a request.</p> <p>This identifier can have up to 80 characters. The following characters are accepted: alphanumeric characters, hyphens(-), and underscores (_).</p> </note></p>
    pub id: String,
...
pub struct DeleteMessageBatchRequestEntry {
    /// <p><p>An identifier for this particular receipt handle. This is used to communicate the result.</p> <note> <p>The <code>Id</code>s of a batch request need to be unique within a request.</p> <p>This identifier can have up to 80 characters. The following characters are accepted: alphanumeric characters, hyphens(-), and underscores (_).</p> </note></p>
    pub id: String,
    /// <p>A receipt handle.</p>
    pub receipt_handle: String,
}
...
impl ChangeMessageVisibilityError {
    ...
    ) -> RusotoError<ChangeMessageVisibilityError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DeleteMessageError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<DeleteMessageError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DeleteMessageBatchError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<DeleteMessageBatchError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl GetQueueAttributesError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<GetQueueAttributesError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl GetQueueUrlError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<GetQueueUrlError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ListQueueTagsError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<ListQueueTagsError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl PurgeQueueError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<PurgeQueueError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ReceiveMessageError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<ReceiveMessageError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl SendMessageBatchError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<SendMessageBatchError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl SetQueueAttributesError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<SetQueueAttributesError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl TagQueueError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<TagQueueError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl UntagQueueError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<UntagQueueError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl Sqs for SqsClient {
    ...
    async fn add_permission(
        ...
        let response = self
            ...
            .await
            .map_err(AddPermissionError::refine)?;
    ...
    async fn change_message_visibility(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ChangeMessageVisibilityError::refine)?;
    ...
    async fn delete_message(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DeleteMessageError::refine)?;
    ...
    async fn delete_queue(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DeleteQueueError::refine)?;
    ...
    async fn purge_queue(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(PurgeQueueError::refine)?;
    ...
    async fn set_queue_attributes(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(SetQueueAttributesError::refine)?;
    ...
    async fn untag_queue(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(UntagQueueError::refine)?;
