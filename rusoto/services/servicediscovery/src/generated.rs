...
pub struct DiscoverInstancesRequest {
    ...
    /// <p>Filters to scope the results based on custom attributes for the instance. For example, <code>{version=v1, az=1a}</code>. Only instances that match all the specified key-value pairs will be returned.</p>
...
pub struct InstanceSummary {
    /// <p><p>A string map that contains the following information:</p> <ul> <li> <p>The attributes that are associate with the instance. </p> </li> <li> <p>For each attribute, the applicable value.</p> </li> </ul> <p>Supported attribute keys include the following:</p> <ul> <li> <p> <code>AWS<em>ALIAS</em>DNS<em>NAME</code>: For an alias record that routes traffic to an Elastic Load Balancing load balancer, the DNS name that is associated with the load balancer. </p> </li> <li> <p> <code>AWS</em>EC2<em>INSTANCE</em>ID</code>: (HTTP namespaces only) The Amazon EC2 instance ID for the instance. When the <code>AWS<em>EC2</em>INSTANCE<em>ID</code> attribute is specified, then the <code>AWS</em>INSTANCE<em>IPV4</code> attribute contains the primary private IPv4 address.</p> </li> <li> <p> <code>AWS</em>INSTANCE<em>CNAME</code>: For a <code>CNAME</code> record, the domain name that Route 53 returns in response to DNS queries, for example, <code>example.com</code>.</p> </li> <li> <p> <code>AWS</em>INSTANCE<em>IPV4</code>: For an <code>A</code> record, the IPv4 address that Route 53 returns in response to DNS queries, for example, <code>192.0.2.44</code>.</p> </li> <li> <p> <code>AWS</em>INSTANCE<em>IPV6</code>: For an <code>AAAA</code> record, the IPv6 address that Route 53 returns in response to DNS queries, for example, <code>2001:0db8:85a3:0000:0000:abcd:0001:2345</code>.</p> </li> <li> <p> <code>AWS</em>INSTANCE_PORT</code>: For an <code>SRV</code> record, the value that Route 53 returns for the port. In addition, if the service includes <code>HealthCheckConfig</code>, the port on the endpoint that Route 53 sends requests to.</p> </li> </ul></p>
    #[serde(rename = "Attributes")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub attributes: Option<::std::collections::HashMap<String, String>>,
...
pub struct Tag {
    ...
    #[serde(rename = "Key")]
    pub key: String,
    /// <p>The string value associated with the key of the tag. You can set the value of a tag to an empty string, but you can't set the value of a tag to null.</p>
    #[serde(rename = "Value")]
    pub value: String,
}
...
impl CreateHttpNamespaceError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<CreateHttpNamespaceError> {
        match err {
...
impl CreatePrivateDnsNamespaceError {
    ...
    ) -> RusotoError<CreatePrivateDnsNamespaceError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl CreatePublicDnsNamespaceError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<CreatePublicDnsNamespaceError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DiscoverInstancesError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<DiscoverInstancesError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl GetInstanceError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<GetInstanceError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl GetInstancesHealthStatusError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<GetInstancesHealthStatusError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl GetNamespaceError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<GetNamespaceError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl GetOperationError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<GetOperationError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl GetServiceError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<GetServiceError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ListOperationsError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<ListOperationsError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ServiceDiscovery for ServiceDiscoveryClient {
    ...
    async fn create_http_namespace(
        ...
        let response = self
            ...
            .await
            .map_err(CreateHttpNamespaceError::refine)?;
    ...
    ) -> Result<CreatePrivateDnsNamespaceResponse, RusotoError<CreatePrivateDnsNamespaceError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(CreatePrivateDnsNamespaceError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn create_public_dns_namespace(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(CreatePublicDnsNamespaceError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn delete_namespace(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DeleteNamespaceError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn discover_instances(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DiscoverInstancesError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn get_instance(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(GetInstanceError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn get_instances_health_status(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(GetInstancesHealthStatusError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn get_namespace(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(GetNamespaceError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn get_operation(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(GetOperationError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn get_service(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(GetServiceError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn list_namespaces(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListNamespacesError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn list_operations(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListOperationsError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn update_instance_custom_health_status(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(UpdateInstanceCustomHealthStatusError::refine)?;
