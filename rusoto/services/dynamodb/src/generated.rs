...
pub trait DynamoDb {
    ...
    fn get_item(
        ...
        Box<dyn Future<Output = Result<GetItemOutput, RusotoError<GetItemError>>> + Send + 'static>,
    >;
    ...
    fn put_item(
        ...
        Box<dyn Future<Output = Result<PutItemOutput, RusotoError<PutItemError>>> + Send + 'static>,
    >;
    ...
    fn query(
        &self,
        input: QueryInput,
    ) -> Pin<Box<dyn Future<Output = Result<QueryOutput, RusotoError<QueryError>>> + Send + 'static>>;
    ...
    fn scan(
        &self,
        input: ScanInput,
    ) -> Pin<Box<dyn Future<Output = Result<ScanOutput, RusotoError<ScanError>>> + Send + 'static>>;
