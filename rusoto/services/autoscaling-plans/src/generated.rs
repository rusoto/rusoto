...
impl CreateScalingPlanError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<CreateScalingPlanError> {
        match err {
...
impl DeleteScalingPlanError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<DeleteScalingPlanError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DescribeScalingPlansError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DescribeScalingPlansError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl UpdateScalingPlanError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<UpdateScalingPlanError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl AutoscalingPlans for AutoscalingPlansClient {
    ...
    async fn create_scaling_plan(
        ...
        let response = self
            ...
            .await
            .map_err(CreateScalingPlanError::refine)?;
    ...
    async fn delete_scaling_plan(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DeleteScalingPlanError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    ) -> Result<DescribeScalingPlanResourcesResponse, RusotoError<DescribeScalingPlanResourcesError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeScalingPlanResourcesError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn describe_scaling_plans(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeScalingPlansError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    > {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(GetScalingPlanResourceForecastDataError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn update_scaling_plan(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(UpdateScalingPlanError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
