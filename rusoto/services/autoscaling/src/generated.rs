...
impl fmt::Debug for AutoscalingClient {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "AutoscalingClient {{ region: {:?} }}", &self.region)
    }
}
