...
pub trait MachineLearning {
    ...
    fn create_evaluation(
        ...
        Box<
            dyn Future<Output = Result<CreateEvaluationOutput, RusotoError<CreateEvaluationError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn create_ml_model(
        ...
        Box<
            dyn Future<Output = Result<CreateMLModelOutput, RusotoError<CreateMLModelError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_data_source(
        ...
        Box<
            dyn Future<Output = Result<DeleteDataSourceOutput, RusotoError<DeleteDataSourceError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_evaluation(
        ...
        Box<
            dyn Future<Output = Result<DeleteEvaluationOutput, RusotoError<DeleteEvaluationError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_ml_model(
        ...
        Box<
            dyn Future<Output = Result<DeleteMLModelOutput, RusotoError<DeleteMLModelError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<DescribeDataSourcesError>,
                    >,
                > + Send
                + 'static,
        >,
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<DescribeEvaluationsError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn describe_ml_models(
        ...
        Box<
            dyn Future<Output = Result<DescribeMLModelsOutput, RusotoError<DescribeMLModelsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_batch_prediction(
        ...
        Box<
            dyn Future<
                    Output = Result<GetBatchPredictionOutput, RusotoError<GetBatchPredictionError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn get_data_source(
        ...
        Box<
            dyn Future<Output = Result<GetDataSourceOutput, RusotoError<GetDataSourceError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_evaluation(
        ...
        Box<
            dyn Future<Output = Result<GetEvaluationOutput, RusotoError<GetEvaluationError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_ml_model(
        ...
        Box<
            dyn Future<Output = Result<GetMLModelOutput, RusotoError<GetMLModelError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn predict(
        ...
        Box<dyn Future<Output = Result<PredictOutput, RusotoError<PredictError>>> + Send + 'static>,
    >;
    ...
    fn update_data_source(
        ...
        Box<
            dyn Future<Output = Result<UpdateDataSourceOutput, RusotoError<UpdateDataSourceError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn update_evaluation(
        ...
        Box<
            dyn Future<Output = Result<UpdateEvaluationOutput, RusotoError<UpdateEvaluationError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn update_ml_model(
        ...
        Box<
            dyn Future<Output = Result<UpdateMLModelOutput, RusotoError<UpdateMLModelError>>>
                + Send
                + 'static,
        >,
    >;
