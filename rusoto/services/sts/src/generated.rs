...
pub trait Sts {
    ...
    fn assume_role(
        ...
        Box<
            dyn Future<Output = Result<AssumeRoleResponse, RusotoError<AssumeRoleError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_access_key_info(
        ...
        Box<
            dyn Future<
                    Output = Result<GetAccessKeyInfoResponse, RusotoError<GetAccessKeyInfoError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn get_caller_identity(
        ...
        Box<
            dyn Future<
                    Output = Result<GetCallerIdentityResponse, RusotoError<GetCallerIdentityError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn get_session_token(
        ...
        Box<
            dyn Future<Output = Result<GetSessionTokenResponse, RusotoError<GetSessionTokenError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    > {
        ...
        async move {
            ...
            if xml_response.body.is_empty() {
                ...
                result =
                    AssumeRoleResponseDeserializer::deserialize("AssumeRoleResult", &mut stack)?;
                skip_tree(&mut stack);
