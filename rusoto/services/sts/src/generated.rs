...
pub trait Sts {
    ...
    fn assume_role(&self, input: AssumeRoleRequest) -> Request<AssumeRoleRequest>;
    ...
    fn get_caller_identity(&self) -> Request<GetCallerIdentityRequest>;
    ...
    fn get_session_token(&self, input: GetSessionTokenRequest) -> Request<GetSessionTokenRequest>;
}
...
impl ServiceRequest for AssumeRoleRequest {
    type Output = AssumeRoleResponse;
    type Error = AssumeRoleError;
    ...
    fn dispatch(
        ...
        AssumeRoleRequestSerializer::serialize(&mut params, "", &self);
...
impl ServiceRequest for AssumeRoleWithSAMLRequest {
    type Output = AssumeRoleWithSAMLResponse;
    type Error = AssumeRoleWithSAMLError;
    ...
    fn dispatch(
        ...
        params.put("Version", "2011-06-15");
        AssumeRoleWithSAMLRequestSerializer::serialize(&mut params, "", &self);
        request.set_payload(Some(serde_urlencoded::to_string(&params).unwrap()));
        request.set_content_type("application/x-www-form-urlencoded".to_owned());
...
impl ServiceRequest for AssumeRoleWithWebIdentityRequest {
    type Output = AssumeRoleWithWebIdentityResponse;
    type Error = AssumeRoleWithWebIdentityError;
    ...
    fn dispatch(
        ...
        params.put("Version", "2011-06-15");
        AssumeRoleWithWebIdentityRequestSerializer::serialize(&mut params, "", &self);
        request.set_payload(Some(serde_urlencoded::to_string(&params).unwrap()));
        request.set_content_type("application/x-www-form-urlencoded".to_owned());
...
impl ServiceRequest for DecodeAuthorizationMessageRequest {
    type Output = DecodeAuthorizationMessageResponse;
    type Error = DecodeAuthorizationMessageError;
    ...
    fn dispatch(
        ...
        params.put("Version", "2011-06-15");
        DecodeAuthorizationMessageRequestSerializer::serialize(&mut params, "", &self);
        request.set_payload(Some(serde_urlencoded::to_string(&params).unwrap()));
        request.set_content_type("application/x-www-form-urlencoded".to_owned());
...
impl ServiceRequest for GetCallerIdentityRequest {
    type Output = GetCallerIdentityResponse;
    type Error = GetCallerIdentityError;
    ...
    fn dispatch(
        ...
        params.put("Version", "2011-06-15");
        GetCallerIdentityRequestSerializer::serialize(&mut params, "", &self);
        request.set_payload(Some(serde_urlencoded::to_string(&params).unwrap()));
        request.set_content_type("application/x-www-form-urlencoded".to_owned());
...
impl ServiceRequest for GetFederationTokenRequest {
    ...
    fn dispatch(
        ...
        params.put("Version", "2011-06-15");
        GetFederationTokenRequestSerializer::serialize(&mut params, "", &self);
        request.set_payload(Some(serde_urlencoded::to_string(&params).unwrap()));
        request.set_content_type("application/x-www-form-urlencoded".to_owned());
...
impl ServiceRequest for GetSessionTokenRequest {
    type Output = GetSessionTokenResponse;
    type Error = GetSessionTokenError;
    ...
    fn dispatch(
        ...
        params.put("Version", "2011-06-15");
        GetSessionTokenRequestSerializer::serialize(&mut params, "", &self);
        request.set_payload(Some(serde_urlencoded::to_string(&params).unwrap()));
        request.set_content_type("application/x-www-form-urlencoded".to_owned());
