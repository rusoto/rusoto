...
/// A client for the AWS STS API.
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                     result = try!(AssumeRoleResponseDeserializer::deserialize("AssumeRoleResult", &mut stack));
                     skip_tree(&mut stack);
                     try!(end_element(&actual_tag_name, &mut stack));
                        ...
                        _ => {
                            Err(AssumeRoleError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                        }
                    }
                }
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                     ...
                     try!(end_element(&actual_tag_name, &mut stack));
                        ...
                        _ => {
                            Err(AssumeRoleWithSAMLError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                        }
                    }
                }
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                     ...
                     try!(end_element(&actual_tag_name, &mut stack));
                        ...
                        _ => {
                            Err(GetCallerIdentityError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                        }
                    }
                }
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                     ...
                     try!(end_element(&actual_tag_name, &mut stack));
                        ...
                        _ => {
                            Err(GetFederationTokenError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                        }
                    }
                }
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                     ...
                     try!(end_element(&actual_tag_name, &mut stack));
                        ...
                        _ => {
                            Err(GetSessionTokenError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                        }
                    }
                }
