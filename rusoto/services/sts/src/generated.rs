                ...
                Ok(result)
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(AssumeRoleError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
    ...
    fn assume_role_with_saml
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            if body.is_empty() {
                ...
                let actual_tag_name = try!(peek_at_name(&mut stack));
                try!(start_element(&actual_tag_name, &mut stack));
                     result = try!(AssumeRoleWithSAMLResponseDeserializer::deserialize("AssumeRoleWithSAMLResult", &mut stack));
                     skip_tree(&mut stack);
                     try!(end_element(&actual_tag_name, &mut stack));
            }
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(AssumeRoleWithSAMLError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn assume_role_with_web_identity
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(AssumeRoleWithWebIdentityError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn decode_authorization_message
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DecodeAuthorizationMessageError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn get_caller_identity(&self,
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            if body.is_empty() {
                ...
                let actual_tag_name = try!(peek_at_name(&mut stack));
                try!(start_element(&actual_tag_name, &mut stack));
                     result = try!(GetCallerIdentityResponseDeserializer::deserialize("GetCallerIdentityResult", &mut stack));
                     skip_tree(&mut stack);
                     try!(end_element(&actual_tag_name, &mut stack));
            }
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(GetCallerIdentityError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn get_federation_token
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            if body.is_empty() {
                ...
                let actual_tag_name = try!(peek_at_name(&mut stack));
                try!(start_element(&actual_tag_name, &mut stack));
                     result = try!(GetFederationTokenResponseDeserializer::deserialize("GetFederationTokenResult", &mut stack));
                     skip_tree(&mut stack);
                     try!(end_element(&actual_tag_name, &mut stack));
            }
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(GetFederationTokenError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn get_session_token(&self,
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            if body.is_empty() {
                ...
                let actual_tag_name = try!(peek_at_name(&mut stack));
                try!(start_element(&actual_tag_name, &mut stack));
                     result = try!(GetSessionTokenResponseDeserializer::deserialize("GetSessionTokenResult", &mut stack));
                     skip_tree(&mut stack);
                     try!(end_element(&actual_tag_name, &mut stack));
            }
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(GetSessionTokenError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
