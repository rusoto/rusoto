...
pub trait Inspector {
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<CreateResourceGroupError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn delete_assessment_run(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<DeleteAssessmentRunError>>> + Send + 'static,
        >,
    >;
    ...
    fn delete_assessment_target(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<DeleteAssessmentTargetError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_assessment_template(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<DeleteAssessmentTemplateError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<DescribeExclusionsError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn describe_findings(
        ...
        Box<
            dyn Future<
                    Output = Result<DescribeFindingsResponse, RusotoError<DescribeFindingsError>>,
                > + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<GetAssessmentReportError>,
                    >,
                > + Send
                + 'static,
        >,
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<ListAssessmentRunsError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn list_exclusions(
        ...
        Box<
            dyn Future<Output = Result<ListExclusionsResponse, RusotoError<ListExclusionsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_rules_packages(
        ...
        Box<
            dyn Future<
                    Output = Result<ListRulesPackagesResponse, RusotoError<ListRulesPackagesError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn preview_agents(
        ...
        Box<
            dyn Future<Output = Result<PreviewAgentsResponse, RusotoError<PreviewAgentsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn register_cross_account_access_role(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<RegisterCrossAccountAccessRoleError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn set_tags_for_resource(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<SetTagsForResourceError>>> + Send + 'static>,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<StartAssessmentRunError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn stop_assessment_run(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<StopAssessmentRunError>>> + Send + 'static>,
    >;
    ...
    fn subscribe_to_event(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<SubscribeToEventError>>> + Send + 'static>,
    >;
    ...
    fn unsubscribe_from_event(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<UnsubscribeFromEventError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn update_assessment_target(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<UpdateAssessmentTargetError>>>
                + Send
                + 'static,
        >,
    >;
