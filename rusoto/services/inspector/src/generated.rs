...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DeleteAssessmentRunResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DeleteAssessmentTargetResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DeleteAssessmentTemplateResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Serialize)]
pub struct DescribeCrossAccountAccessRoleRequest {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct RegisterCrossAccountAccessRoleResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct SetTagsForResourceResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct StopAssessmentRunResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct SubscribeToEventResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct UnsubscribeFromEventResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct UpdateAssessmentTargetResponse {}
...
pub trait Inspector {
    ...
    fn describe_cross_account_access_role(&self) -> Request<DescribeCrossAccountAccessRoleRequest>;
    ...
    fn describe_findings(&self, input: DescribeFindingsRequest)
    ...
    fn list_exclusions(&self, input: ListExclusionsRequest) -> Request<ListExclusionsRequest>;
    ...
    fn preview_agents(&self, input: PreviewAgentsRequest) -> Request<PreviewAgentsRequest>;
...
impl ServiceRequest for AddAttributesToFindingsRequest {
    type Output = AddAttributesToFindingsResponse;
    type Error = AddAttributesToFindingsError;
    ...
    fn dispatch(
        ...
        let mut request = SignedRequest::new("POST", "inspector", region, "/");
...
impl ServiceRequest for CreateAssessmentTargetRequest {
    type Output = CreateAssessmentTargetResponse;
    type Error = CreateAssessmentTargetError;
...
impl ServiceRequest for CreateAssessmentTemplateRequest {
    type Output = CreateAssessmentTemplateResponse;
    type Error = CreateAssessmentTemplateError;
...
impl ServiceRequest for CreateExclusionsPreviewRequest {
    type Output = CreateExclusionsPreviewResponse;
    type Error = CreateExclusionsPreviewError;
...
impl ServiceRequest for CreateResourceGroupRequest {
    type Output = CreateResourceGroupResponse;
    type Error = CreateResourceGroupError;
...
impl ServiceRequest for DeleteAssessmentRunRequest {
    type Output = DeleteAssessmentRunResponse;
    type Error = DeleteAssessmentRunError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeleteAssessmentRunResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DeleteAssessmentTargetRequest {
    type Output = DeleteAssessmentTargetResponse;
    type Error = DeleteAssessmentTargetError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeleteAssessmentTargetResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DeleteAssessmentTemplateRequest {
    type Output = DeleteAssessmentTemplateResponse;
    type Error = DeleteAssessmentTemplateError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeleteAssessmentTemplateResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DescribeAssessmentRunsRequest {
    type Output = DescribeAssessmentRunsResponse;
    type Error = DescribeAssessmentRunsError;
...
impl ServiceRequest for DescribeAssessmentTargetsRequest {
    type Output = DescribeAssessmentTargetsResponse;
    type Error = DescribeAssessmentTargetsError;
...
impl ServiceRequest for DescribeAssessmentTemplatesRequest {
    type Output = DescribeAssessmentTemplatesResponse;
    type Error = DescribeAssessmentTemplatesError;
...
impl ServiceRequest for DescribeCrossAccountAccessRoleRequest {
    type Output = DescribeCrossAccountAccessRoleResponse;
    type Error = DescribeCrossAccountAccessRoleError;
...
impl ServiceRequest for DescribeExclusionsRequest {
    type Output = DescribeExclusionsResponse;
    type Error = DescribeExclusionsError;
...
impl ServiceRequest for DescribeFindingsRequest {
    type Output = DescribeFindingsResponse;
    type Error = DescribeFindingsError;
...
impl ServiceRequest for DescribeResourceGroupsRequest {
    type Output = DescribeResourceGroupsResponse;
    type Error = DescribeResourceGroupsError;
...
impl ServiceRequest for DescribeRulesPackagesRequest {
    type Output = DescribeRulesPackagesResponse;
    type Error = DescribeRulesPackagesError;
...
impl ServiceRequest for GetAssessmentReportRequest {
    type Output = GetAssessmentReportResponse;
    type Error = GetAssessmentReportError;
...
impl ServiceRequest for GetExclusionsPreviewRequest {
    type Output = GetExclusionsPreviewResponse;
    type Error = GetExclusionsPreviewError;
...
impl ServiceRequest for GetTelemetryMetadataRequest {
    type Output = GetTelemetryMetadataResponse;
    type Error = GetTelemetryMetadataError;
...
impl ServiceRequest for ListAssessmentRunAgentsRequest {
    type Output = ListAssessmentRunAgentsResponse;
    type Error = ListAssessmentRunAgentsError;
...
impl ServiceRequest for ListAssessmentRunsRequest {
    type Output = ListAssessmentRunsResponse;
    type Error = ListAssessmentRunsError;
...
impl ServiceRequest for ListAssessmentTargetsRequest {
    type Output = ListAssessmentTargetsResponse;
    type Error = ListAssessmentTargetsError;
...
impl ServiceRequest for ListAssessmentTemplatesRequest {
    type Output = ListAssessmentTemplatesResponse;
    type Error = ListAssessmentTemplatesError;
...
impl ServiceRequest for ListEventSubscriptionsRequest {
    type Output = ListEventSubscriptionsResponse;
    type Error = ListEventSubscriptionsError;
...
impl ServiceRequest for ListExclusionsRequest {
    type Output = ListExclusionsResponse;
    type Error = ListExclusionsError;
...
impl ServiceRequest for ListRulesPackagesRequest {
    type Output = ListRulesPackagesResponse;
    type Error = ListRulesPackagesError;
...
impl ServiceRequest for PreviewAgentsRequest {
    type Output = PreviewAgentsResponse;
    type Error = PreviewAgentsError;
...
impl ServiceRequest for RegisterCrossAccountAccessRoleRequest {
    type Output = RegisterCrossAccountAccessRoleResponse;
    type Error = RegisterCrossAccountAccessRoleError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<RegisterCrossAccountAccessRoleResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for RemoveAttributesFromFindingsRequest {
    type Output = RemoveAttributesFromFindingsResponse;
    type Error = RemoveAttributesFromFindingsError;
...
impl ServiceRequest for SetTagsForResourceRequest {
    type Output = SetTagsForResourceResponse;
    type Error = SetTagsForResourceError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<SetTagsForResourceResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for StartAssessmentRunRequest {
    type Output = StartAssessmentRunResponse;
    type Error = StartAssessmentRunError;
...
impl ServiceRequest for StopAssessmentRunRequest {
    type Output = StopAssessmentRunResponse;
    type Error = StopAssessmentRunError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<StopAssessmentRunResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for SubscribeToEventRequest {
    type Output = SubscribeToEventResponse;
    type Error = SubscribeToEventError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<SubscribeToEventResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for UnsubscribeFromEventRequest {
    type Output = UnsubscribeFromEventResponse;
    type Error = UnsubscribeFromEventError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<UnsubscribeFromEventResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for UpdateAssessmentTargetRequest {
    type Output = UpdateAssessmentTargetResponse;
    type Error = UpdateAssessmentTargetError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<UpdateAssessmentTargetResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
