...
impl AnalyzeDocumentError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<AnalyzeDocumentError> {
        match err {
...
impl DetectDocumentTextError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<DetectDocumentTextError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl GetDocumentAnalysisError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<GetDocumentAnalysisError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl GetDocumentTextDetectionError {
    ...
    ) -> RusotoError<GetDocumentTextDetectionError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl StartDocumentAnalysisError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<StartDocumentAnalysisError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl Textract for TextractClient {
    ...
    async fn analyze_document(
        ...
        let response = self
            ...
            .await
            .map_err(AnalyzeDocumentError::refine)?;
    ...
    async fn detect_document_text(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DetectDocumentTextError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn get_document_analysis(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(GetDocumentAnalysisError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn get_document_text_detection(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(GetDocumentTextDetectionError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn start_document_analysis(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(StartDocumentAnalysisError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    ) -> Result<StartDocumentTextDetectionResponse, RusotoError<StartDocumentTextDetectionError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(StartDocumentTextDetectionError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
