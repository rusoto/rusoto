...
impl CreateParameterGroupError {
    ...
    ) -> RusotoError<CreateParameterGroupError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl CreateSubnetGroupError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<CreateSubnetGroupError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DecreaseReplicationFactorError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DecreaseReplicationFactorError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DeleteParameterGroupError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DeleteParameterGroupError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DeleteSubnetGroupError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<DeleteSubnetGroupError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DescribeDefaultParametersError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DescribeDefaultParametersError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DescribeParameterGroupsError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DescribeParameterGroupsError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DescribeParametersError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<DescribeParametersError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DescribeSubnetGroupsError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DescribeSubnetGroupsError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl IncreaseReplicationFactorError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<IncreaseReplicationFactorError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl RebootNodeError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<RebootNodeError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl UpdateParameterGroupError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<UpdateParameterGroupError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl UpdateSubnetGroupError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<UpdateSubnetGroupError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DynamodbAccelerator for DynamodbAcceleratorClient {
    ...
    async fn create_parameter_group(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(CreateParameterGroupError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn create_subnet_group(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(CreateSubnetGroupError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    ) -> Result<DecreaseReplicationFactorResponse, RusotoError<DecreaseReplicationFactorError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DecreaseReplicationFactorError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn delete_parameter_group(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DeleteParameterGroupError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn delete_subnet_group(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DeleteSubnetGroupError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    ) -> Result<DescribeDefaultParametersResponse, RusotoError<DescribeDefaultParametersError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeDefaultParametersError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn describe_parameter_groups(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeParameterGroupsError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn describe_parameters(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeParametersError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn describe_subnet_groups(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeSubnetGroupsError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    ) -> Result<IncreaseReplicationFactorResponse, RusotoError<IncreaseReplicationFactorError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(IncreaseReplicationFactorError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn reboot_node(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(RebootNodeError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn update_parameter_group(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(UpdateParameterGroupError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn update_subnet_group(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(UpdateSubnetGroupError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
