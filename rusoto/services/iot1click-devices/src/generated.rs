...
pub trait Iot1ClickDevices {
    ...
    fn describe_device(
        ...
        Box<
            dyn Future<Output = Result<DescribeDeviceResponse, RusotoError<DescribeDeviceError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<FinalizeDeviceClaimError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn get_device_methods(
        ...
        Box<
            dyn Future<
                    Output = Result<GetDeviceMethodsResponse, RusotoError<GetDeviceMethodsError>>,
                > + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<InitiateDeviceClaimError>,
                    >,
                > + Send
                + 'static,
        >,
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<InvokeDeviceMethodError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn list_device_events(
        ...
        Box<
            dyn Future<
                    Output = Result<ListDeviceEventsResponse, RusotoError<ListDeviceEventsError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn list_devices(
        ...
        Box<
            dyn Future<Output = Result<ListDevicesResponse, RusotoError<ListDevicesError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn unclaim_device(
        ...
        Box<
            dyn Future<Output = Result<UnclaimDeviceResponse, RusotoError<UnclaimDeviceError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn update_device_state(
        ...
        Box<
            dyn Future<
                    Output = Result<UpdateDeviceStateResponse, RusotoError<UpdateDeviceStateError>>,
                > + Send
                + 'static,
        >,
    >;
