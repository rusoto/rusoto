...
impl DescribePHIDetectionJobError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DescribePHIDetectionJobError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DetectEntitiesError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<DetectEntitiesError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DetectEntitiesV2Error {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<DetectEntitiesV2Error> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DetectPHIError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<DetectPHIError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl InferICD10CMError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<InferICD10CMError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl InferRxNormError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<InferRxNormError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ListICD10CMInferenceJobsError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<ListICD10CMInferenceJobsError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ListPHIDetectionJobsError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<ListPHIDetectionJobsError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ListRxNormInferenceJobsError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<ListRxNormInferenceJobsError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl StartICD10CMInferenceJobError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<StartICD10CMInferenceJobError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl StartPHIDetectionJobError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<StartPHIDetectionJobError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl StartRxNormInferenceJobError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<StartRxNormInferenceJobError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl StopICD10CMInferenceJobError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<StopICD10CMInferenceJobError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl StopPHIDetectionJobError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<StopPHIDetectionJobError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl StopRxNormInferenceJobError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<StopRxNormInferenceJobError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ComprehendMedical for ComprehendMedicalClient {
    ...
    > {
        ...
        let response = self
            ...
            .await
            .map_err(DescribeEntitiesDetectionV2JobError::refine)?;
    ...
    ) -> Result<DescribeICD10CMInferenceJobResponse, RusotoError<DescribeICD10CMInferenceJobError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeICD10CMInferenceJobError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn describe_phi_detection_job(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribePHIDetectionJobError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    ) -> Result<DescribeRxNormInferenceJobResponse, RusotoError<DescribeRxNormInferenceJobError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeRxNormInferenceJobError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn detect_entities(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DetectEntitiesError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn detect_entities_v2(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DetectEntitiesV2Error::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn infer_icd10cm(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(InferICD10CMError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn infer_rx_norm(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(InferRxNormError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    ) -> Result<ListEntitiesDetectionV2JobsResponse, RusotoError<ListEntitiesDetectionV2JobsError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListEntitiesDetectionV2JobsError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn list_icd10cm_inference_jobs(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListICD10CMInferenceJobsError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn list_phi_detection_jobs(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListPHIDetectionJobsError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn list_rx_norm_inference_jobs(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListRxNormInferenceJobsError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    ) -> Result<StartEntitiesDetectionV2JobResponse, RusotoError<StartEntitiesDetectionV2JobError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(StartEntitiesDetectionV2JobError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn start_icd10cm_inference_job(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(StartICD10CMInferenceJobError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn start_phi_detection_job(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(StartPHIDetectionJobError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn start_rx_norm_inference_job(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(StartRxNormInferenceJobError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    ) -> Result<StopEntitiesDetectionV2JobResponse, RusotoError<StopEntitiesDetectionV2JobError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(StopEntitiesDetectionV2JobError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn stop_icd10cm_inference_job(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(StopICD10CMInferenceJobError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn stop_phi_detection_job(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(StopPHIDetectionJobError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn stop_rx_norm_inference_job(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(StopRxNormInferenceJobError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
