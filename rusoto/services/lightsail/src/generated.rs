...
pub type BlueprintList = Vec<Blueprint>;
pub type BlueprintType = String;
...
pub type BundleList = Vec<Bundle>;
#[derive(Default,Debug,Clone,Serialize)]
...
pub struct CreateInstancesFromSnapshotRequest {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub key_pair_name: Option<ResourceName>,
...
pub struct CreateInstancesRequest {
    ...
    #[serde(rename="blueprintId")]
    pub blueprint_id: NonEmptyString,
    #[doc="<p>The bundle of specification information for your virtual private server (or <i>instance</i>), including the pricing plan (e.g., <code>micro_1_0</code>).</p>"]
    #[serde(rename="bundleId")]
    pub bundle_id: NonEmptyString,
...
pub struct CreateKeyPairRequest {
    ...
    #[serde(rename="keyPairName")]
    pub key_pair_name: ResourceName,
}
...
pub struct CreateKeyPairResult {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub private_key_base_64: Option<Base64>,
    #[doc="<p>A base64-encoded public key of the <code>ssh-rsa</code> type.</p>"]
    #[serde(rename="publicKeyBase64")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub public_key_base_64: Option<Base64>,
}
...
pub struct Disk {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub is_attached: Option<Boolean>,
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub is_system_disk: Option<Boolean>,
...
pub struct Domain {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub domain_entries: Option<DomainEntryList>,
...
pub struct DomainEntry {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub options: Option<DomainEntryOptions>,
    ...
    #[serde(rename="type")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub type_: Option<DomainEntryType>,
}

pub type DomainEntryList = Vec<DomainEntry>;
pub type DomainEntryOptions = ::std::collections::HashMap<DomainEntryOptionsKeys, String>;
pub type DomainEntryOptionsKeys = String;
pub type DomainEntryType = String;
...
pub struct GetActiveNamesResult {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub active_names: Option<StringList>,
...
pub struct GetBlueprintsRequest {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub include_inactive: Option<Boolean>,
...
pub struct GetInstanceMetricDataRequest {
    ...
    pub statistics: MetricStatisticList,
...
pub struct GetInstanceMetricDataResult {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub metric_data: Option<MetricDatapointList>,
...
pub struct GetInstanceSnapshotsResult {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub instance_snapshots: Option<InstanceSnapshotList>,
    #[doc="<p>A token used for advancing to the next page of results from your get instance snapshots request.</p>"]
    #[serde(rename="nextPageToken")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub next_page_token: Option<String>,
...
pub struct GetRegionsRequest {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub include_availability_zones: Option<Boolean>,
}
...
pub struct GetStaticIpsResult {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub static_ips: Option<StaticIpList>,
}
...
pub type InstanceAccessProtocol = String;
...
pub type InstanceMetricName = String;
...
pub struct InstanceNetworking {
    ...
    #[serde(rename="ports")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub ports: Option<InstancePortInfoList>,
}
...
pub type InstancePortInfoList = Vec<InstancePortInfo>;
...
pub type InstancePortStateList = Vec<InstancePortState>;
...
pub struct InstanceSnapshot {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub from_instance_arn: Option<NonEmptyString>,
    #[doc="<p>The instance from which the snapshot was created.</p>"]
    #[serde(rename="fromInstanceName")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub from_instance_name: Option<ResourceName>,
...
pub type InstanceSnapshotList = Vec<InstanceSnapshot>;
pub type InstanceSnapshotState = String;
...
pub type KeyPairList = Vec<KeyPair>;
...
pub type MetricDatapointList = Vec<MetricDatapoint>;
pub type MetricPeriod = i64;
pub type MetricStatistic = String;
pub type MetricStatisticList = Vec<MetricStatistic>;
...
pub struct MonthlyTransfer {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub gb_per_month_allocated: Option<Integer>,
}

pub type NetworkProtocol = String;
...
pub struct Operation {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub is_terminal: Option<Boolean>,
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub status_changed_at: Option<IsoDate>,
}
...
pub type Port = i64;
pub type PortAccessType = String;
...
pub type PortInfoList = Vec<PortInfo>;
pub type PortState = String;
#[derive(Default,Debug,Clone,Serialize)]
...
pub struct StaticIp {
    ...
    #[serde(rename="attachedTo")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub attached_to: Option<ResourceName>,
...
pub type StaticIpList = Vec<StaticIp>;
#[derive(Default,Debug,Clone,Serialize)]
