...
pub trait DynamoDbStreams {
    ...
    fn describe_stream(
        ...
        Box<
            dyn Future<Output = Result<DescribeStreamOutput, RusotoError<DescribeStreamError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_records(
        ...
        Box<
            dyn Future<Output = Result<GetRecordsOutput, RusotoError<GetRecordsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_shard_iterator(
        ...
        Box<
            dyn Future<Output = Result<GetShardIteratorOutput, RusotoError<GetShardIteratorError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_streams(
        ...
        Box<
            dyn Future<Output = Result<ListStreamsOutput, RusotoError<ListStreamsError>>>
                + Send
                + 'static,
        >,
    >;
