...
pub trait Sns {
    ...
    fn get_platform_application_attributes
        (&self,
         ...
         -> RusotoFuture<GetPlatformApplicationAttributesResponse,
    ...
    fn list_endpoints_by_platform_application(&self, input: &ListEndpointsByPlatformApplicationInput) -> RusotoFuture<ListEndpointsByPlatformApplicationResponse, ListEndpointsByPlatformApplicationError>;
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(CheckIfPhoneNumberIsOptedOutError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn confirm_subscription
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(ConfirmSubscriptionError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn create_platform_application
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(CreatePlatformApplicationError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn create_platform_endpoint
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(CreatePlatformEndpointError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
                ...
                Ok(result)
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(CreateTopicError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
            ...
            future::Either::A(future::ok(::std::mem::drop(response_body)))
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(DeletePlatformApplicationError::from_body(String::from_utf8_lossy(body.as_ref())
                                                              .as_ref()))
        }))
                                            }
                                        }))
            ...
            future::Either::A(future::ok(::std::mem::drop(response_body)))
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(DeleteTopicError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
    ...
    fn get_endpoint_attributes
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(GetEndpointAttributesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn get_platform_application_attributes
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(GetPlatformApplicationAttributesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn get_sms_attributes(&self,
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(GetSMSAttributesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn get_subscription_attributes
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(GetSubscriptionAttributesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn get_topic_attributes
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(GetTopicAttributesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
...
fn list_endpoints_by_platform_application(&self, input: &ListEndpointsByPlatformApplicationInput) -> RusotoFuture<ListEndpointsByPlatformApplicationResponse, ListEndpointsByPlatformApplicationError>{
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(ListEndpointsByPlatformApplicationError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn list_phone_numbers_opted_out
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(ListPhoneNumbersOptedOutError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn list_platform_applications
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(ListPlatformApplicationsError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn list_subscriptions(&self,
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(ListSubscriptionsError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn list_subscriptions_by_topic
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(ListSubscriptionsByTopicError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
                ...
                Ok(result)
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(ListTopicsError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
    ...
    fn opt_in_phone_number(&self,
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(OptInPhoneNumberError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
                ...
                Ok(result)
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(PublishError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
    ...
    fn set_platform_application_attributes
        ...
        RusotoFuture::new(self.dispatcher.dispatch(request).from_err().and_then(|response| {
                        match response.status {
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(SetPlatformApplicationAttributesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn set_sms_attributes(&self,
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(SetSMSAttributesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
            ...
            future::Either::A(future::ok(::std::mem::drop(response_body)))
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(SetSubscriptionAttributesError::from_body(String::from_utf8_lossy(body.as_ref())
                                                              .as_ref()))
        }))
                                            }
                                        }))
            ...
            future::Either::A(future::ok(::std::mem::drop(response_body)))
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(SetTopicAttributesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
                ...
                Ok(result)
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(SubscribeError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
            ...
            future::Either::A(future::ok(::std::mem::drop(response_body)))
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(UnsubscribeError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
