...
pub struct CloudSearchDomainClient<P = CredentialsProvider, D = RequestDispatcher>
where
...
impl CloudSearchDomainClient {
    ...
    pub fn simple(region: region::Region) -> CloudSearchDomainClient {
        CloudSearchDomainClient::new(
