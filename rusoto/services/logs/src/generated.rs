...
pub trait CloudWatchLogs {
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<AssociateKmsKeyError>>> + Send + 'static>>;
    ...
    fn cancel_export_task(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<CancelExportTaskError>>> + Send + 'static>,
    >;
    ...
    fn create_export_task(
        ...
        Box<
            dyn Future<
                    Output = Result<CreateExportTaskResponse, RusotoError<CreateExportTaskError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<CreateLogGroupError>>> + Send + 'static>>;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<CreateLogStreamError>>> + Send + 'static>>;
    ...
    fn delete_destination(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<DeleteDestinationError>>> + Send + 'static>,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<DeleteLogGroupError>>> + Send + 'static>>;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<DeleteLogStreamError>>> + Send + 'static>>;
    ...
    fn delete_metric_filter(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<DeleteMetricFilterError>>> + Send + 'static>,
    >;
    ...
    fn delete_resource_policy(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<DeleteResourcePolicyError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_retention_policy(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<DeleteRetentionPolicyError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_subscription_filter(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<DeleteSubscriptionFilterError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<DescribeExportTasksError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn describe_log_groups(
        ...
        Box<
            dyn Future<
                    Output = Result<DescribeLogGroupsResponse, RusotoError<DescribeLogGroupsError>>,
                > + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<DescribeLogStreamsError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn describe_queries(
        ...
        Box<
            dyn Future<Output = Result<DescribeQueriesResponse, RusotoError<DescribeQueriesError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn disassociate_kms_key(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<DisassociateKmsKeyError>>> + Send + 'static>,
    >;
    ...
    fn filter_log_events(
        ...
        Box<
            dyn Future<Output = Result<FilterLogEventsResponse, RusotoError<FilterLogEventsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_log_events(
        ...
        Box<
            dyn Future<Output = Result<GetLogEventsResponse, RusotoError<GetLogEventsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_log_group_fields(
        ...
        Box<
            dyn Future<
                    Output = Result<GetLogGroupFieldsResponse, RusotoError<GetLogGroupFieldsError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn get_log_record(
        ...
        Box<
            dyn Future<Output = Result<GetLogRecordResponse, RusotoError<GetLogRecordError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_query_results(
        ...
        Box<
            dyn Future<Output = Result<GetQueryResultsResponse, RusotoError<GetQueryResultsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_tags_log_group(
        ...
        Box<
            dyn Future<
                    Output = Result<ListTagsLogGroupResponse, RusotoError<ListTagsLogGroupError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn put_destination(
        ...
        Box<
            dyn Future<Output = Result<PutDestinationResponse, RusotoError<PutDestinationError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn put_destination_policy(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<PutDestinationPolicyError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn put_log_events(
        ...
        Box<
            dyn Future<Output = Result<PutLogEventsResponse, RusotoError<PutLogEventsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<PutMetricFilterError>>> + Send + 'static>>;
    ...
    fn put_retention_policy(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<PutRetentionPolicyError>>> + Send + 'static>,
    >;
    ...
    fn put_subscription_filter(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<PutSubscriptionFilterError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn start_query(
        ...
        Box<
            dyn Future<Output = Result<StartQueryResponse, RusotoError<StartQueryError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn stop_query(
        ...
        Box<
            dyn Future<Output = Result<StopQueryResponse, RusotoError<StopQueryError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<TagLogGroupError>>> + Send + 'static>>;
    ...
    fn test_metric_filter(
        ...
        Box<
            dyn Future<
                    Output = Result<TestMetricFilterResponse, RusotoError<TestMetricFilterError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<UntagLogGroupError>>> + Send + 'static>>;
}
