...
pub trait SimpleDb {
    ...
    fn batch_delete_attributes(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<BatchDeleteAttributesError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn batch_put_attributes(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<BatchPutAttributesError>>> + Send + 'static>,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<CreateDomainError>>> + Send + 'static>>;
    ...
    fn delete_attributes(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<DeleteAttributesError>>> + Send + 'static>,
    >;
    ...
    fn domain_metadata(
        ...
        Box<
            dyn Future<Output = Result<DomainMetadataResult, RusotoError<DomainMetadataError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_attributes(
        ...
        Box<
            dyn Future<Output = Result<GetAttributesResult, RusotoError<GetAttributesError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_domains(
        ...
        Box<
            dyn Future<Output = Result<ListDomainsResult, RusotoError<ListDomainsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<PutAttributesError>>> + Send + 'static>>;
    ...
    fn select(
        ...
        Box<dyn Future<Output = Result<SelectResult, RusotoError<SelectError>>> + Send + 'static>,
    >;
}
    ...
    > {
        ...
        async move {
            ...
            if xml_response.body.is_empty() {
                ...
                start_element(&actual_tag_name, &mut stack)?;
                result =
                    ListDomainsResultDeserializer::deserialize("ListDomainsResult", &mut stack)?;
                skip_tree(&mut stack);
                end_element(&actual_tag_name, &mut stack)?;
            }
            // parse non-payload
