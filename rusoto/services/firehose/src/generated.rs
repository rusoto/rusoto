...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DeleteDeliveryStreamResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Serialize)]
pub struct StartDeliveryStreamEncryptionRequest {
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct StartDeliveryStreamEncryptionResponse {}

#[derive(Default, Debug, Clone, PartialEq, Serialize)]
pub struct StopDeliveryStreamEncryptionRequest {
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct StopDeliveryStreamEncryptionResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct TagDeliveryStreamResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct UntagDeliveryStreamResponse {}
...
pub trait KinesisFirehose {
    ...
    fn create_delivery_stream(
        &self,
        input: CreateDeliveryStreamRequest,
    ...
    fn delete_delivery_stream(
        &self,
        input: DeleteDeliveryStreamRequest,
    ...
    fn describe_delivery_stream(
        &self,
        input: DescribeDeliveryStreamRequest,
    ...
    fn list_delivery_streams(
        &self,
        input: ListDeliveryStreamsRequest,
    ...
    fn list_tags_for_delivery_stream(
        &self,
        input: ListTagsForDeliveryStreamRequest,
    ...
    fn put_record_batch(&self, input: PutRecordBatchRequest) -> Request<PutRecordBatchRequest>;
    ...
    fn start_delivery_stream_encryption(
        &self,
        input: StartDeliveryStreamEncryptionRequest,
    ...
    fn stop_delivery_stream_encryption(
        &self,
        input: StopDeliveryStreamEncryptionRequest,
    ...
    fn tag_delivery_stream(
        &self,
        input: TagDeliveryStreamRequest,
    ...
    fn untag_delivery_stream(
        &self,
        input: UntagDeliveryStreamRequest,
...
impl ServiceRequest for CreateDeliveryStreamRequest {
    type Output = CreateDeliveryStreamResponse;
    type Error = CreateDeliveryStreamError;
    ...
    fn dispatch(
        ...
        let mut request = SignedRequest::new("POST", "firehose", region, "/");
            ...
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<CreateDeliveryStreamResponse, _>()
                }))
            } else {
                Box::new(
...
impl ServiceRequest for DeleteDeliveryStreamRequest {
    type Output = DeleteDeliveryStreamResponse;
    type Error = DeleteDeliveryStreamError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeleteDeliveryStreamResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DescribeDeliveryStreamRequest {
    type Output = DescribeDeliveryStreamResponse;
    type Error = DescribeDeliveryStreamError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DescribeDeliveryStreamResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for ListDeliveryStreamsRequest {
    type Output = ListDeliveryStreamsResponse;
    type Error = ListDeliveryStreamsError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<ListDeliveryStreamsResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for ListTagsForDeliveryStreamRequest {
    type Output = ListTagsForDeliveryStreamResponse;
    type Error = ListTagsForDeliveryStreamError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<ListTagsForDeliveryStreamResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for PutRecordBatchRequest {
    type Output = PutRecordBatchResponse;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<PutRecordBatchResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for StartDeliveryStreamEncryptionRequest {
    type Output = StartDeliveryStreamEncryptionResponse;
    type Error = StartDeliveryStreamEncryptionError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<StartDeliveryStreamEncryptionResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for StopDeliveryStreamEncryptionRequest {
    type Output = StopDeliveryStreamEncryptionResponse;
    type Error = StopDeliveryStreamEncryptionError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<StopDeliveryStreamEncryptionResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for TagDeliveryStreamRequest {
    type Output = TagDeliveryStreamResponse;
    type Error = TagDeliveryStreamError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<TagDeliveryStreamResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for UntagDeliveryStreamRequest {
    type Output = UntagDeliveryStreamResponse;
    type Error = UntagDeliveryStreamError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<UntagDeliveryStreamResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for UpdateDestinationRequest {
    type Output = UpdateDestinationResponse;
    type Error = UpdateDestinationError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<UpdateDestinationResponse, _>()
                }))
            } else {
                Box::new(
                    response
