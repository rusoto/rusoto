...
pub trait KinesisFirehose {
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<ListDeliveryStreamsError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn put_record_batch(
        ...
        Box<
            dyn Future<Output = Result<PutRecordBatchOutput, RusotoError<PutRecordBatchError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn tag_delivery_stream(
        ...
        Box<
            dyn Future<
                    Output = Result<TagDeliveryStreamOutput, RusotoError<TagDeliveryStreamError>>,
                > + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<UntagDeliveryStreamError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn update_destination(
        ...
        Box<
            dyn Future<
                    Output = Result<UpdateDestinationOutput, RusotoError<UpdateDestinationError>>,
                > + Send
                + 'static,
        >,
    >;
