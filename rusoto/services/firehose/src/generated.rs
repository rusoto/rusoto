...
impl CreateDeliveryStreamError {
    ...
    ) -> RusotoError<CreateDeliveryStreamError> {
        match err {
...
impl DeleteDeliveryStreamError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DeleteDeliveryStreamError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DescribeDeliveryStreamError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DescribeDeliveryStreamError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ListDeliveryStreamsError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<ListDeliveryStreamsError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ListTagsForDeliveryStreamError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<ListTagsForDeliveryStreamError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl PutRecordBatchError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<PutRecordBatchError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl TagDeliveryStreamError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<TagDeliveryStreamError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl UntagDeliveryStreamError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<UntagDeliveryStreamError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl UpdateDestinationError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<UpdateDestinationError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl KinesisFirehose for KinesisFirehoseClient {
    ...
    async fn create_delivery_stream(
        ...
        let response = self
            ...
            .await
            .map_err(CreateDeliveryStreamError::refine)?;
    ...
    async fn delete_delivery_stream(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DeleteDeliveryStreamError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn describe_delivery_stream(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeDeliveryStreamError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn list_delivery_streams(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListDeliveryStreamsError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn list_tags_for_delivery_stream(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListTagsForDeliveryStreamError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn put_record_batch(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(PutRecordBatchError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    ) -> Result<StartDeliveryStreamEncryptionOutput, RusotoError<StartDeliveryStreamEncryptionError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(StartDeliveryStreamEncryptionError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    ) -> Result<StopDeliveryStreamEncryptionOutput, RusotoError<StopDeliveryStreamEncryptionError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(StopDeliveryStreamEncryptionError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn tag_delivery_stream(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(TagDeliveryStreamError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn untag_delivery_stream(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(UntagDeliveryStreamError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn update_destination(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(UpdateDestinationError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
