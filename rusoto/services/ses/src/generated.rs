...
pub trait Ses {
    ...
    fn create_configuration_set_event_destination(&self, input: &CreateConfigurationSetEventDestinationRequest) -> RusotoFuture<CreateConfigurationSetEventDestinationResponse, CreateConfigurationSetEventDestinationError>;
    ...
    fn delete_configuration_set_event_destination(&self, input: &DeleteConfigurationSetEventDestinationRequest) -> RusotoFuture<DeleteConfigurationSetEventDestinationResponse, DeleteConfigurationSetEventDestinationError>;
    ...
    fn get_identity_mail_from_domain_attributes(&self, input: &GetIdentityMailFromDomainAttributesRequest) -> RusotoFuture<GetIdentityMailFromDomainAttributesResponse, GetIdentityMailFromDomainAttributesError>;
    ...
    fn get_identity_notification_attributes(&self, input: &GetIdentityNotificationAttributesRequest) -> RusotoFuture<GetIdentityNotificationAttributesResponse, GetIdentityNotificationAttributesError>;
    ...
    fn get_identity_verification_attributes(&self, input: &GetIdentityVerificationAttributesRequest) -> RusotoFuture<GetIdentityVerificationAttributesResponse, GetIdentityVerificationAttributesError>;
    ...
    fn set_identity_feedback_forwarding_enabled(&self, input: &SetIdentityFeedbackForwardingEnabledRequest) -> RusotoFuture<SetIdentityFeedbackForwardingEnabledResponse, SetIdentityFeedbackForwardingEnabledError>;
    ...
    fn set_identity_headers_in_notifications_enabled(&self, input: &SetIdentityHeadersInNotificationsEnabledRequest) -> RusotoFuture<SetIdentityHeadersInNotificationsEnabledResponse, SetIdentityHeadersInNotificationsEnabledError>;
    ...
    fn update_configuration_set_event_destination(&self, input: &UpdateConfigurationSetEventDestinationRequest) -> RusotoFuture<UpdateConfigurationSetEventDestinationResponse, UpdateConfigurationSetEventDestinationError>;
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(CloneReceiptRuleSetError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn create_configuration_set
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(CreateConfigurationSetError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
...
fn create_configuration_set_event_destination(&self, input: &CreateConfigurationSetEventDestinationRequest) -> RusotoFuture<CreateConfigurationSetEventDestinationResponse, CreateConfigurationSetEventDestinationError>{
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(CreateConfigurationSetEventDestinationError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn create_receipt_filter
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(CreateReceiptFilterError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn create_receipt_rule(&self,
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(CreateReceiptRuleError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn create_receipt_rule_set
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(CreateReceiptRuleSetError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn delete_configuration_set
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DeleteConfigurationSetError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
...
fn delete_configuration_set_event_destination(&self, input: &DeleteConfigurationSetEventDestinationRequest) -> RusotoFuture<DeleteConfigurationSetEventDestinationResponse, DeleteConfigurationSetEventDestinationError>{
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DeleteConfigurationSetEventDestinationError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn delete_identity(&self,
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DeleteIdentityError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn delete_identity_policy
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DeleteIdentityPolicyError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn delete_receipt_filter
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DeleteReceiptFilterError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn delete_receipt_rule(&self,
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DeleteReceiptRuleError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn delete_receipt_rule_set
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DeleteReceiptRuleSetError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
            ...
            future::Either::A(future::ok(::std::mem::drop(response_body)))
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(DeleteVerifiedEmailAddressError::from_body(String::from_utf8_lossy(body.as_ref())
                                                               .as_ref()))
        }))
                                            }
                                        }))
    ...
    fn describe_active_receipt_rule_set
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DescribeActiveReceiptRuleSetError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn describe_configuration_set
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DescribeConfigurationSetError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn describe_receipt_rule
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DescribeReceiptRuleError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn describe_receipt_rule_set
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DescribeReceiptRuleSetError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn get_identity_dkim_attributes
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(GetIdentityDkimAttributesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
...
fn get_identity_mail_from_domain_attributes(&self, input: &GetIdentityMailFromDomainAttributesRequest) -> RusotoFuture<GetIdentityMailFromDomainAttributesResponse, GetIdentityMailFromDomainAttributesError>{
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(GetIdentityMailFromDomainAttributesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
...
fn get_identity_notification_attributes(&self, input: &GetIdentityNotificationAttributesRequest) -> RusotoFuture<GetIdentityNotificationAttributesResponse, GetIdentityNotificationAttributesError>{
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(GetIdentityNotificationAttributesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn get_identity_policies
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(GetIdentityPoliciesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
...
fn get_identity_verification_attributes(&self, input: &GetIdentityVerificationAttributesRequest) -> RusotoFuture<GetIdentityVerificationAttributesResponse, GetIdentityVerificationAttributesError>{
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(GetIdentityVerificationAttributesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn get_send_quota(&self) -> RusotoFuture<GetSendQuotaResponse, GetSendQuotaError> {
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(GetSendQuotaError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn get_send_statistics(&self)
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(GetSendStatisticsError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn list_configuration_sets
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(ListConfigurationSetsError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn list_identities(&self,
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(ListIdentitiesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn list_identity_policies
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(ListIdentityPoliciesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn list_receipt_filters
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(ListReceiptFiltersError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn list_receipt_rule_sets
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(ListReceiptRuleSetsError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn list_verified_email_addresses
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(ListVerifiedEmailAddressesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn put_identity_policy(&self,
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(PutIdentityPolicyError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn reorder_receipt_rule_set
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(ReorderReceiptRuleSetError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
                ...
                Ok(result)
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(SendBounceError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
                ...
                Ok(result)
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(SendEmailError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
    ...
    fn send_raw_email(&self,
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(SendRawEmailError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn set_active_receipt_rule_set
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(SetActiveReceiptRuleSetError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn set_identity_dkim_enabled
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(SetIdentityDkimEnabledError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
...
fn set_identity_feedback_forwarding_enabled(&self, input: &SetIdentityFeedbackForwardingEnabledRequest) -> RusotoFuture<SetIdentityFeedbackForwardingEnabledResponse, SetIdentityFeedbackForwardingEnabledError>{
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(SetIdentityFeedbackForwardingEnabledError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
...
fn set_identity_headers_in_notifications_enabled(&self, input: &SetIdentityHeadersInNotificationsEnabledRequest) -> RusotoFuture<SetIdentityHeadersInNotificationsEnabledResponse, SetIdentityHeadersInNotificationsEnabledError>{
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(SetIdentityHeadersInNotificationsEnabledError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn set_identity_mail_from_domain
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(SetIdentityMailFromDomainError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn set_identity_notification_topic
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(SetIdentityNotificationTopicError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn set_receipt_rule_position
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(SetReceiptRulePositionError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
...
fn update_configuration_set_event_destination(&self, input: &UpdateConfigurationSetEventDestinationRequest) -> RusotoFuture<UpdateConfigurationSetEventDestinationResponse, UpdateConfigurationSetEventDestinationError>{
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(UpdateConfigurationSetEventDestinationError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn update_receipt_rule(&self,
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(UpdateReceiptRuleError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn verify_domain_dkim(&self,
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(VerifyDomainDkimError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn verify_domain_identity
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(VerifyDomainIdentityError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
            ...
            future::Either::A(future::ok(::std::mem::drop(response_body)))
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(VerifyEmailAddressError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
    ...
    fn verify_email_identity
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(VerifyEmailIdentityError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
