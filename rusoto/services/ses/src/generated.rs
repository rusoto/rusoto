...
pub type MailFromDomainAttributes = ::std::collections::HashMap<Identity,
...
pub type NotificationAttributes = ::std::collections::HashMap<Identity,
...
pub type VerificationAttributes = ::std::collections::HashMap<Identity,
