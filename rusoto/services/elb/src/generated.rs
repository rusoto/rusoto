...
pub trait Elb {
    ...
    fn apply_security_groups_to_load_balancer
        (&self,
         ...
         -> RusotoFuture<ApplySecurityGroupsToLoadBalancerOutput,
    ...
    fn create_app_cookie_stickiness_policy
        (&self,
         ...
         -> RusotoFuture<CreateAppCookieStickinessPolicyOutput,
    ...
    fn describe_load_balancer_policy_types
        (&self,
         ...
         -> RusotoFuture<DescribeLoadBalancerPolicyTypesOutput,
    ...
    fn disable_availability_zones_for_load_balancer
        (&self,
         ...
         -> RusotoFuture<RemoveAvailabilityZonesOutput,
    ...
    fn set_load_balancer_listener_ssl_certificate(&self, input: &SetLoadBalancerListenerSSLCertificateInput) -> RusotoFuture<SetLoadBalancerListenerSSLCertificateOutput, SetLoadBalancerListenerSSLCertificateError>;
    ...
    fn set_load_balancer_policies_for_backend_server(&self, input: &SetLoadBalancerPoliciesForBackendServerInput) -> RusotoFuture<SetLoadBalancerPoliciesForBackendServerOutput, SetLoadBalancerPoliciesForBackendServerError>;
    ...
    fn set_load_balancer_policies_of_listener
        (&self,
         ...
         -> RusotoFuture<SetLoadBalancerPoliciesOfListenerOutput,
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(ApplySecurityGroupsToLoadBalancerError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn attach_load_balancer_to_subnets
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(AttachLoadBalancerToSubnetsError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn configure_health_check
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(ConfigureHealthCheckError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn create_app_cookie_stickiness_policy
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(CreateAppCookieStickinessPolicyError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn create_lb_cookie_stickiness_policy
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(CreateLBCookieStickinessPolicyError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn create_load_balancer_listeners
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(CreateLoadBalancerListenersError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn create_load_balancer_policy
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(CreateLoadBalancerPolicyError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn delete_load_balancer_listeners
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DeleteLoadBalancerListenersError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn delete_load_balancer_policy
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DeleteLoadBalancerPolicyError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn deregister_instances_from_load_balancer
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DeregisterInstancesFromLoadBalancerError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn describe_instance_health
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DescribeInstanceHealthError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn describe_load_balancer_policies
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DescribeLoadBalancerPoliciesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn describe_load_balancer_policy_types
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DescribeLoadBalancerPolicyTypesError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn detach_load_balancer_from_subnets
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DetachLoadBalancerFromSubnetsError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn disable_availability_zones_for_load_balancer
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(DisableAvailabilityZonesForLoadBalancerError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn enable_availability_zones_for_load_balancer
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(EnableAvailabilityZonesForLoadBalancerError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn register_instances_with_load_balancer
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(RegisterInstancesWithLoadBalancerError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
...
fn set_load_balancer_listener_ssl_certificate(&self, input: &SetLoadBalancerListenerSSLCertificateInput) -> RusotoFuture<SetLoadBalancerListenerSSLCertificateOutput, SetLoadBalancerListenerSSLCertificateError>{
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(SetLoadBalancerListenerSSLCertificateError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
...
fn set_load_balancer_policies_for_backend_server(&self, input: &SetLoadBalancerPoliciesForBackendServerInput) -> RusotoFuture<SetLoadBalancerPoliciesForBackendServerOutput, SetLoadBalancerPoliciesForBackendServerError>{
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(SetLoadBalancerPoliciesForBackendServerError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
    ...
    fn set_load_balancer_policies_of_listener
        ...
        future::Either::A(response_body.from_err().concat2().and_then(move |body| {
            ...
            Ok(result)
                            ...
                            _ => {
                                future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                    Err(SetLoadBalancerPoliciesOfListenerError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                }))
                            }
                        }
                    }))
