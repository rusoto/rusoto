...
pub trait OpsWorksCM {
    ...
    fn associate_node(
        ...
        Box<
            dyn Future<Output = Result<AssociateNodeResponse, RusotoError<AssociateNodeError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_server(
        ...
        Box<
            dyn Future<Output = Result<DeleteServerResponse, RusotoError<DeleteServerError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn describe_servers(
        ...
        Box<
            dyn Future<Output = Result<DescribeServersResponse, RusotoError<DescribeServersError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn disassociate_node(
        ...
        Box<
            dyn Future<
                    Output = Result<DisassociateNodeResponse, RusotoError<DisassociateNodeError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn restore_server(
        ...
        Box<
            dyn Future<Output = Result<RestoreServerResponse, RusotoError<RestoreServerError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn start_maintenance(
        ...
        Box<
            dyn Future<
                    Output = Result<StartMaintenanceResponse, RusotoError<StartMaintenanceError>>,
                > + Send
                + 'static,
        >,
    >;
