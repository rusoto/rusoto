...
impl CancelDataRepositoryTaskError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<CancelDataRepositoryTaskError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl CreateDataRepositoryTaskError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<CreateDataRepositoryTaskError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DescribeBackupsError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<DescribeBackupsError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DescribeFileSystemAliasesError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DescribeFileSystemAliasesError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl Fsx for FsxClient {
    ...
    ) -> Result<AssociateFileSystemAliasesResponse, RusotoError<AssociateFileSystemAliasesError>>
    {
        ...
        let response = self
            ...
            .await
            .map_err(AssociateFileSystemAliasesError::refine)?;
    ...
    async fn cancel_data_repository_task(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(CancelDataRepositoryTaskError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn create_data_repository_task(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(CreateDataRepositoryTaskError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn create_file_system(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(CreateFileSystemError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    ) -> Result<CreateFileSystemFromBackupResponse, RusotoError<CreateFileSystemFromBackupError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(CreateFileSystemFromBackupError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn delete_file_system(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DeleteFileSystemError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn describe_backups(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeBackupsError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    ) -> Result<DescribeDataRepositoryTasksResponse, RusotoError<DescribeDataRepositoryTasksError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeDataRepositoryTasksError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    ) -> Result<DescribeFileSystemAliasesResponse, RusotoError<DescribeFileSystemAliasesError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeFileSystemAliasesError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn describe_file_systems(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeFileSystemsError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    > {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DisassociateFileSystemAliasesError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn update_file_system(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(UpdateFileSystemError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
