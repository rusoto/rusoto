...
impl ServiceRequest for CreateBackupRequest {
    ...
    fn dispatch(
        ...
        let mut request = SignedRequest::new("POST", "fsx", region, "/");
...
impl ServiceRequest for CreateFileSystemFromBackupRequest {
    type Output = CreateFileSystemFromBackupResponse;
    type Error = CreateFileSystemFromBackupError;
