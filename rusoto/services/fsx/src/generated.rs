...
pub trait Fsx {
    ...
    fn cancel_data_repository_task(
        &self,
    ...
    fn create_backup(
        ...
        Box<
            dyn Future<Output = Result<CreateBackupResponse, RusotoError<CreateBackupError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn create_data_repository_task(
        &self,
    ...
    fn create_file_system(
        ...
        Box<
            dyn Future<
                    Output = Result<CreateFileSystemResponse, RusotoError<CreateFileSystemError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn delete_file_system(
        ...
        Box<
            dyn Future<
                    Output = Result<DeleteFileSystemResponse, RusotoError<DeleteFileSystemError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn describe_data_repository_tasks(
        &self,
    ...
    fn update_file_system(
        ...
        Box<
            dyn Future<
                    Output = Result<UpdateFileSystemResponse, RusotoError<UpdateFileSystemError>>,
                > + Send
                + 'static,
        >,
    >;
