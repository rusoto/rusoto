...
//!
//! If you're using the service, you're probably looking for [KinesisAnalyticsV2Client](struct.KinesisAnalyticsV2Client.html) and [KinesisAnalyticsV2](trait.KinesisAnalyticsV2.html).
