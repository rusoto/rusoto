...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DeleteAggregationAuthorizationResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DeleteConfigRuleResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DeleteConfigurationAggregatorResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DeleteConfigurationRecorderResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DeleteDeliveryChannelResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DeletePendingAggregationRequestResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DeleteRetentionConfigurationResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Serialize)]
pub struct GetComplianceSummaryByConfigRuleRequest {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct PutConfigRuleResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct PutConfigurationRecorderResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct PutDeliveryChannelResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct StartConfigurationRecorderResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct StopConfigurationRecorderResponse {}
...
pub trait ConfigService {
    ...
    fn put_config_rule(&self, input: PutConfigRuleRequest) -> Request<PutConfigRuleRequest>;
    ...
    fn put_evaluations(&self, input: PutEvaluationsRequest) -> Request<PutEvaluationsRequest>;
...
impl ServiceRequest for BatchGetAggregateResourceConfigRequest {
    type Output = BatchGetAggregateResourceConfigResponse;
    type Error = BatchGetAggregateResourceConfigError;
    ...
    fn dispatch(
        ...
        let mut request = SignedRequest::new("POST", "config", region, "/");
...
impl ServiceRequest for BatchGetResourceConfigRequest {
    type Output = BatchGetResourceConfigResponse;
    type Error = BatchGetResourceConfigError;
...
impl ServiceRequest for DeleteAggregationAuthorizationRequest {
    type Output = DeleteAggregationAuthorizationResponse;
    type Error = DeleteAggregationAuthorizationError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeleteAggregationAuthorizationResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DeleteConfigRuleRequest {
    type Output = DeleteConfigRuleResponse;
    type Error = DeleteConfigRuleError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeleteConfigRuleResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for DeleteConfigurationAggregatorRequest {
    type Output = DeleteConfigurationAggregatorResponse;
    type Error = DeleteConfigurationAggregatorError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeleteConfigurationAggregatorResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DeleteConfigurationRecorderRequest {
    type Output = DeleteConfigurationRecorderResponse;
    type Error = DeleteConfigurationRecorderError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeleteConfigurationRecorderResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DeleteDeliveryChannelRequest {
    type Output = DeleteDeliveryChannelResponse;
    type Error = DeleteDeliveryChannelError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeleteDeliveryChannelResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DeleteEvaluationResultsRequest {
    type Output = DeleteEvaluationResultsResponse;
    type Error = DeleteEvaluationResultsError;
...
impl ServiceRequest for DeletePendingAggregationRequestRequest {
    type Output = DeletePendingAggregationRequestResponse;
    type Error = DeletePendingAggregationRequestError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeletePendingAggregationRequestResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DeleteRemediationConfigurationRequest {
    type Output = DeleteRemediationConfigurationResponse;
    type Error = DeleteRemediationConfigurationError;
...
impl ServiceRequest for DeleteRetentionConfigurationRequest {
    type Output = DeleteRetentionConfigurationResponse;
    type Error = DeleteRetentionConfigurationError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeleteRetentionConfigurationResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DeliverConfigSnapshotRequest {
    type Output = DeliverConfigSnapshotResponse;
    type Error = DeliverConfigSnapshotError;
...
impl ServiceRequest for DescribeAggregateComplianceByConfigRulesRequest {
    type Output = DescribeAggregateComplianceByConfigRulesResponse;
    type Error = DescribeAggregateComplianceByConfigRulesError;
...
impl ServiceRequest for DescribeAggregationAuthorizationsRequest {
    type Output = DescribeAggregationAuthorizationsResponse;
    type Error = DescribeAggregationAuthorizationsError;
...
impl ServiceRequest for DescribeComplianceByConfigRuleRequest {
    type Output = DescribeComplianceByConfigRuleResponse;
    type Error = DescribeComplianceByConfigRuleError;
...
impl ServiceRequest for DescribeComplianceByResourceRequest {
    type Output = DescribeComplianceByResourceResponse;
    type Error = DescribeComplianceByResourceError;
...
impl ServiceRequest for DescribeConfigRuleEvaluationStatusRequest {
    type Output = DescribeConfigRuleEvaluationStatusResponse;
    type Error = DescribeConfigRuleEvaluationStatusError;
...
impl ServiceRequest for DescribeConfigRulesRequest {
    type Output = DescribeConfigRulesResponse;
    type Error = DescribeConfigRulesError;
...
impl ServiceRequest for DescribeConfigurationAggregatorSourcesStatusRequest {
    type Output = DescribeConfigurationAggregatorSourcesStatusResponse;
    type Error = DescribeConfigurationAggregatorSourcesStatusError;
...
impl ServiceRequest for DescribeConfigurationAggregatorsRequest {
    type Output = DescribeConfigurationAggregatorsResponse;
    type Error = DescribeConfigurationAggregatorsError;
...
impl ServiceRequest for DescribeConfigurationRecorderStatusRequest {
    type Output = DescribeConfigurationRecorderStatusResponse;
    type Error = DescribeConfigurationRecorderStatusError;
...
impl ServiceRequest for DescribeConfigurationRecordersRequest {
    type Output = DescribeConfigurationRecordersResponse;
    type Error = DescribeConfigurationRecordersError;
...
impl ServiceRequest for DescribeDeliveryChannelStatusRequest {
    type Output = DescribeDeliveryChannelStatusResponse;
    type Error = DescribeDeliveryChannelStatusError;
...
impl ServiceRequest for DescribeDeliveryChannelsRequest {
    type Output = DescribeDeliveryChannelsResponse;
    type Error = DescribeDeliveryChannelsError;
...
impl ServiceRequest for DescribePendingAggregationRequestsRequest {
    type Output = DescribePendingAggregationRequestsResponse;
    type Error = DescribePendingAggregationRequestsError;
...
impl ServiceRequest for DescribeRemediationConfigurationsRequest {
    type Output = DescribeRemediationConfigurationsResponse;
    type Error = DescribeRemediationConfigurationsError;
...
impl ServiceRequest for DescribeRemediationExecutionStatusRequest {
    type Output = DescribeRemediationExecutionStatusResponse;
    type Error = DescribeRemediationExecutionStatusError;
...
impl ServiceRequest for DescribeRetentionConfigurationsRequest {
    type Output = DescribeRetentionConfigurationsResponse;
    type Error = DescribeRetentionConfigurationsError;
...
impl ServiceRequest for GetAggregateComplianceDetailsByConfigRuleRequest {
    type Output = GetAggregateComplianceDetailsByConfigRuleResponse;
    type Error = GetAggregateComplianceDetailsByConfigRuleError;
...
impl ServiceRequest for GetAggregateConfigRuleComplianceSummaryRequest {
    type Output = GetAggregateConfigRuleComplianceSummaryResponse;
    type Error = GetAggregateConfigRuleComplianceSummaryError;
...
impl ServiceRequest for GetAggregateDiscoveredResourceCountsRequest {
    type Output = GetAggregateDiscoveredResourceCountsResponse;
    type Error = GetAggregateDiscoveredResourceCountsError;
...
impl ServiceRequest for GetAggregateResourceConfigRequest {
    type Output = GetAggregateResourceConfigResponse;
    type Error = GetAggregateResourceConfigError;
...
impl ServiceRequest for GetComplianceDetailsByConfigRuleRequest {
    type Output = GetComplianceDetailsByConfigRuleResponse;
    type Error = GetComplianceDetailsByConfigRuleError;
...
impl ServiceRequest for GetComplianceDetailsByResourceRequest {
    type Output = GetComplianceDetailsByResourceResponse;
    type Error = GetComplianceDetailsByResourceError;
...
impl ServiceRequest for GetComplianceSummaryByConfigRuleRequest {
    type Output = GetComplianceSummaryByConfigRuleResponse;
    type Error = GetComplianceSummaryByConfigRuleError;
...
impl ServiceRequest for GetComplianceSummaryByResourceTypeRequest {
    type Output = GetComplianceSummaryByResourceTypeResponse;
    type Error = GetComplianceSummaryByResourceTypeError;
...
impl ServiceRequest for GetDiscoveredResourceCountsRequest {
    type Output = GetDiscoveredResourceCountsResponse;
    type Error = GetDiscoveredResourceCountsError;
...
impl ServiceRequest for GetResourceConfigHistoryRequest {
    type Output = GetResourceConfigHistoryResponse;
    type Error = GetResourceConfigHistoryError;
...
impl ServiceRequest for ListAggregateDiscoveredResourcesRequest {
    type Output = ListAggregateDiscoveredResourcesResponse;
    type Error = ListAggregateDiscoveredResourcesError;
...
impl ServiceRequest for ListDiscoveredResourcesRequest {
    type Output = ListDiscoveredResourcesResponse;
    type Error = ListDiscoveredResourcesError;
...
impl ServiceRequest for PutAggregationAuthorizationRequest {
    type Output = PutAggregationAuthorizationResponse;
    type Error = PutAggregationAuthorizationError;
...
impl ServiceRequest for PutConfigRuleRequest {
    type Output = PutConfigRuleResponse;
    type Error = PutConfigRuleError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<PutConfigRuleResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for PutConfigurationAggregatorRequest {
    type Output = PutConfigurationAggregatorResponse;
    type Error = PutConfigurationAggregatorError;
...
impl ServiceRequest for PutConfigurationRecorderRequest {
    type Output = PutConfigurationRecorderResponse;
    type Error = PutConfigurationRecorderError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<PutConfigurationRecorderResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for PutDeliveryChannelRequest {
    type Output = PutDeliveryChannelResponse;
    type Error = PutDeliveryChannelError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<PutDeliveryChannelResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for PutEvaluationsRequest {
    type Output = PutEvaluationsResponse;
    type Error = PutEvaluationsError;
...
impl ServiceRequest for PutRemediationConfigurationsRequest {
    type Output = PutRemediationConfigurationsResponse;
    type Error = PutRemediationConfigurationsError;
...
impl ServiceRequest for PutRetentionConfigurationRequest {
    type Output = PutRetentionConfigurationResponse;
    type Error = PutRetentionConfigurationError;
...
impl ServiceRequest for SelectResourceConfigRequest {
    type Output = SelectResourceConfigResponse;
    type Error = SelectResourceConfigError;
...
impl ServiceRequest for StartConfigRulesEvaluationRequest {
    type Output = StartConfigRulesEvaluationResponse;
    type Error = StartConfigRulesEvaluationError;
...
impl ServiceRequest for StartConfigurationRecorderRequest {
    type Output = StartConfigurationRecorderResponse;
    type Error = StartConfigurationRecorderError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<StartConfigurationRecorderResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for StartRemediationExecutionRequest {
    type Output = StartRemediationExecutionResponse;
    type Error = StartRemediationExecutionError;
...
impl ServiceRequest for StopConfigurationRecorderRequest {
    type Output = StopConfigurationRecorderResponse;
    type Error = StopConfigurationRecorderError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<StopConfigurationRecorderResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
