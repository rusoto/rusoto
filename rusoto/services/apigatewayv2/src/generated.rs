                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(CreateApiError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(CreateApiMappingError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(CreateIntegrationError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(CreateRouteResponseError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(DeleteApiError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(DeleteApiMappingError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(DeleteRouteResponseError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(GetApiError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(GetApiMappingError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(GetApiMappingsError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(GetApisError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(GetIntegrationsError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(GetRouteError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(GetRouteResponseError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(GetRouteResponsesError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(GetRoutesError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(UpdateApiError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(UpdateApiMappingError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(UpdateRouteError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| Err(e),
                                |response| Err(UpdateRouteResponseError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
