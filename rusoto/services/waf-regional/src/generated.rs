...
pub trait WAFRegional {
    ...
    fn associate_web_acl(
        ...
        Box<
            dyn Future<Output = Result<AssociateWebACLResponse, RusotoError<AssociateWebACLError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<CreateByteMatchSetError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn create_geo_match_set(
        ...
        Box<
            dyn Future<
                    Output = Result<CreateGeoMatchSetResponse, RusotoError<CreateGeoMatchSetError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn create_ip_set(
        ...
        Box<
            dyn Future<Output = Result<CreateIPSetResponse, RusotoError<CreateIPSetError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<CreateRateBasedRuleError>,
                    >,
                > + Send
                + 'static,
        >,
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<CreateRegexMatchSetError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn create_rule(
        ...
        Box<
            dyn Future<Output = Result<CreateRuleResponse, RusotoError<CreateRuleError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn create_rule_group(
        ...
        Box<
            dyn Future<Output = Result<CreateRuleGroupResponse, RusotoError<CreateRuleGroupError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn create_web_acl(
        ...
        Box<
            dyn Future<Output = Result<CreateWebACLResponse, RusotoError<CreateWebACLError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn create_xss_match_set(
        ...
        Box<
            dyn Future<
                    Output = Result<CreateXssMatchSetResponse, RusotoError<CreateXssMatchSetError>>,
                > + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<DeleteByteMatchSetError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn delete_geo_match_set(
        ...
        Box<
            dyn Future<
                    Output = Result<DeleteGeoMatchSetResponse, RusotoError<DeleteGeoMatchSetError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn delete_ip_set(
        ...
        Box<
            dyn Future<Output = Result<DeleteIPSetResponse, RusotoError<DeleteIPSetError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<DeleteRateBasedRuleError>,
                    >,
                > + Send
                + 'static,
        >,
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<DeleteRegexMatchSetError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn delete_rule(
        ...
        Box<
            dyn Future<Output = Result<DeleteRuleResponse, RusotoError<DeleteRuleError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_rule_group(
        ...
        Box<
            dyn Future<Output = Result<DeleteRuleGroupResponse, RusotoError<DeleteRuleGroupError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_web_acl(
        ...
        Box<
            dyn Future<Output = Result<DeleteWebACLResponse, RusotoError<DeleteWebACLError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_xss_match_set(
        ...
        Box<
            dyn Future<
                    Output = Result<DeleteXssMatchSetResponse, RusotoError<DeleteXssMatchSetError>>,
                > + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<DisassociateWebACLError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn get_byte_match_set(
        ...
        Box<
            dyn Future<Output = Result<GetByteMatchSetResponse, RusotoError<GetByteMatchSetError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_change_token(
        ...
        Box<
            dyn Future<Output = Result<GetChangeTokenResponse, RusotoError<GetChangeTokenError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_geo_match_set(
        ...
        Box<
            dyn Future<Output = Result<GetGeoMatchSetResponse, RusotoError<GetGeoMatchSetError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_ip_set(
        ...
        Box<
            dyn Future<Output = Result<GetIPSetResponse, RusotoError<GetIPSetError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<GetPermissionPolicyError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn get_rate_based_rule(
        ...
        Box<
            dyn Future<
                    Output = Result<GetRateBasedRuleResponse, RusotoError<GetRateBasedRuleError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn get_regex_match_set(
        ...
        Box<
            dyn Future<
                    Output = Result<GetRegexMatchSetResponse, RusotoError<GetRegexMatchSetError>>,
                > + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<GetRegexPatternSetError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn get_rule(
        ...
        Box<
            dyn Future<Output = Result<GetRuleResponse, RusotoError<GetRuleError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_rule_group(
        ...
        Box<
            dyn Future<Output = Result<GetRuleGroupResponse, RusotoError<GetRuleGroupError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<GetSampledRequestsError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn get_web_acl(
        ...
        Box<
            dyn Future<Output = Result<GetWebACLResponse, RusotoError<GetWebACLError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_xss_match_set(
        ...
        Box<
            dyn Future<Output = Result<GetXssMatchSetResponse, RusotoError<GetXssMatchSetError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_byte_match_sets(
        ...
        Box<
            dyn Future<
                    Output = Result<ListByteMatchSetsResponse, RusotoError<ListByteMatchSetsError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn list_geo_match_sets(
        ...
        Box<
            dyn Future<
                    Output = Result<ListGeoMatchSetsResponse, RusotoError<ListGeoMatchSetsError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn list_ip_sets(
        ...
        Box<
            dyn Future<Output = Result<ListIPSetsResponse, RusotoError<ListIPSetsError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<ListRateBasedRulesError>,
                    >,
                > + Send
                + 'static,
        >,
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<ListRegexMatchSetsError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn list_rule_groups(
        ...
        Box<
            dyn Future<Output = Result<ListRuleGroupsResponse, RusotoError<ListRuleGroupsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_rules(
        ...
        Box<
            dyn Future<Output = Result<ListRulesResponse, RusotoError<ListRulesError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_web_ac_ls(
        ...
        Box<
            dyn Future<Output = Result<ListWebACLsResponse, RusotoError<ListWebACLsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_xss_match_sets(
        ...
        Box<
            dyn Future<
                    Output = Result<ListXssMatchSetsResponse, RusotoError<ListXssMatchSetsError>>,
                > + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<PutPermissionPolicyError>,
                    >,
                > + Send
                + 'static,
        >,
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<UpdateByteMatchSetError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn update_geo_match_set(
        ...
        Box<
            dyn Future<
                    Output = Result<UpdateGeoMatchSetResponse, RusotoError<UpdateGeoMatchSetError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn update_ip_set(
        ...
        Box<
            dyn Future<Output = Result<UpdateIPSetResponse, RusotoError<UpdateIPSetError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<UpdateRateBasedRuleError>,
                    >,
                > + Send
                + 'static,
        >,
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<UpdateRegexMatchSetError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn update_rule(
        ...
        Box<
            dyn Future<Output = Result<UpdateRuleResponse, RusotoError<UpdateRuleError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn update_rule_group(
        ...
        Box<
            dyn Future<Output = Result<UpdateRuleGroupResponse, RusotoError<UpdateRuleGroupError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn update_web_acl(
        ...
        Box<
            dyn Future<Output = Result<UpdateWebACLResponse, RusotoError<UpdateWebACLError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn update_xss_match_set(
        ...
        Box<
            dyn Future<
                    Output = Result<UpdateXssMatchSetResponse, RusotoError<UpdateXssMatchSetError>>,
                > + Send
                + 'static,
        >,
    >;
