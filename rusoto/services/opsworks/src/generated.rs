                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(AssignInstanceError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(AssignVolumeError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(AssociateElasticIpError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(CloneStackError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(CreateInstanceError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(CreateLayerError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DeleteLayerError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DeregisterEcsClusterError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DeregisterElasticIpError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DeregisterVolumeError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DescribeAgentVersionsError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DescribeAppsError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DescribeCommandsError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DescribeDeploymentsError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DescribeEcsClustersError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DescribeElasticIpsError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DescribeLayersError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DescribeMyUserProfileError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DescribePermissionsError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DescribeRaidArraysError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DescribeServiceErrorsError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DescribeStackSummaryError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DescribeUserProfilesError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(DisassociateElasticIpError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(GetHostnameSuggestionError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(GrantAccessError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(RegisterEcsClusterError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(RegisterElasticIpError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(RegisterRdsDbInstanceError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(RegisterVolumeError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(SetPermissionError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(StartStackError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(StopStackError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(UnassignInstanceError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(UnassignVolumeError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(UpdateElasticIpError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(UpdateInstanceError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(UpdateLayerError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(UpdateMyUserProfileError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(UpdateRdsDbInstanceError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
                ...
                response
                    ...
                    .map(|try_response| {
                        try_response
                            .map_or_else(
                                |e| e,
                                |response| Err(UpdateVolumeError::from_response(response)),
                            )
                            .boxed()
                    })
                    .boxed()
