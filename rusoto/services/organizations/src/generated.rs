...
pub struct CreatePolicyRequest {
    ...
    #[serde(rename = "Name")]
    pub name: String,
    /// <p><p>The type of policy to create. You can specify one of the following values:</p> <ul> <li> <p> <a href="http://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_ai-opt-out.html">AISERVICES<em>OPT</em>OUT<em>POLICY</a> </p> </li> <li> <p> &lt;a href=&quot;http://docs.aws.amazon.com/organizations/latest/userguide/orgs</em>manage<em>policies</em>backup.html&quot;&gt;BACKUP<em>POLICY</a> </p> </li> <li> <p> &lt;a href=&quot;http://docs.aws.amazon.com/organizations/latest/userguide/orgs</em>manage<em>policies</em>scp.html&quot;&gt;SERVICE<em>CONTROL</em>POLICY</a> </p> </li> <li> <p> <a href="http://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_tag-policies.html">TAG_POLICY</a> </p> </li> </ul></p>
    #[serde(rename = "Type")]
    pub type_: String,
}
...
pub trait Organizations {
    ...
    /// <p><p>Lists the root or organizational units (OUs) that serve as the immediate parent of the specified child OU or account. This operation, along with <a>ListChildren</a> enables you to traverse the tree structure that makes up this root.</p> <note> <p>Always check the <code>NextToken</code> response parameter for a <code>null</code> value when calling a <code>List*</code> operation. These operations can occasionally return an empty set of results even when there are more results available. The <code>NextToken</code> response parameter value is <code>null</code> <i>only</i> when there are no more results to display.</p> </note> <p>This operation can be called only from the organization&#39;s master account or by a member account that is a delegated administrator for an AWS service.</p> <note> <p>In the current release, a child can have only a single parent. </p> </note></p>
...
impl Organizations for OrganizationsClient {
    ...
    async fn deregister_delegated_administrator(
        ...
        if response.status.is_success() {
            ...
            let try_response = response.buffer().await;
            let response = try_response.map_err(RusotoError::HttpDispatch)?;
            Err(DeregisterDelegatedAdministratorError::from_response(
                response,
            ))
        }
    }
    ...
    ) -> Result<ListDelegatedAdministratorsResponse, RusotoError<ListDelegatedAdministratorsError>>
    {
        ...
        if response.status.is_success() {
            ...
            let try_response = response.buffer().await;
            let response = try_response.map_err(RusotoError::HttpDispatch)?;
            Err(ListDelegatedAdministratorsError::from_response(response))
        }
    }
    ...
    > {
        ...
        if response.status.is_success() {
            ...
            let try_response = response.buffer().await;
            let response = try_response.map_err(RusotoError::HttpDispatch)?;
            Err(ListDelegatedServicesForAccountError::from_response(
                response,
            ))
        }
    }
    ...
    async fn register_delegated_administrator(
        ...
        if response.status.is_success() {
            ...
            let try_response = response.buffer().await;
            let response = try_response.map_err(RusotoError::HttpDispatch)?;
            Err(RegisterDelegatedAdministratorError::from_response(response))
        }
    }
