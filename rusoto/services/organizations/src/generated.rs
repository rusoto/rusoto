...
pub trait Organizations {
    ...
    ) -> Result<(), DisableAWSServiceAccessError>;
    ...
    ) -> Result<(), EnableAWSServiceAccessError>;
    ...
    ) -> Result<ListAWSServiceAccessForOrganizationResponse, ListAWSServiceAccessForOrganizationError>;
