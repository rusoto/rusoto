...
impl GetServiceQuotaError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<GetServiceQuotaError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ListServiceQuotasError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<ListServiceQuotasError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ServiceQuotas for ServiceQuotasClient {
    ...
    > {
        ...
        let response = self
            ...
            .await
            .map_err(AssociateServiceQuotaTemplateError::refine)?;
    ...
    > {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DeleteServiceQuotaIncreaseRequestFromTemplateError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    > {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DisassociateServiceQuotaTemplateError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    ) -> Result<GetAWSDefaultServiceQuotaResponse, RusotoError<GetAWSDefaultServiceQuotaError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(GetAWSDefaultServiceQuotaError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    > {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(GetAssociationForServiceQuotaTemplateError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    > {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(GetRequestedServiceQuotaChangeError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn get_service_quota(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(GetServiceQuotaError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    > {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(GetServiceQuotaIncreaseRequestFromTemplateError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    ) -> Result<ListAWSDefaultServiceQuotasResponse, RusotoError<ListAWSDefaultServiceQuotasError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListAWSDefaultServiceQuotasError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    > {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListRequestedServiceQuotaChangeHistoryError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    > {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListRequestedServiceQuotaChangeHistoryByQuotaError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    > {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListServiceQuotaIncreaseRequestsInTemplateError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn list_service_quotas(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListServiceQuotasError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    > {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(PutServiceQuotaIncreaseRequestIntoTemplateError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    ) -> Result<RequestServiceQuotaIncreaseResponse, RusotoError<RequestServiceQuotaIncreaseError>>
    {
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(RequestServiceQuotaIncreaseError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
