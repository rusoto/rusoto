...
pub trait Acm {
    ...
    fn add_tags_to_certificate(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<AddTagsToCertificateError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_certificate(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<DeleteCertificateError>>> + Send + 'static>,
    >;
    ...
    fn export_certificate(
        ...
        Box<
            dyn Future<
                    Output = Result<ExportCertificateResponse, RusotoError<ExportCertificateError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn list_certificates(
        ...
        Box<
            dyn Future<
                    Output = Result<ListCertificatesResponse, RusotoError<ListCertificatesError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn remove_tags_from_certificate(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<RemoveTagsFromCertificateError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn renew_certificate(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<RenewCertificateError>>> + Send + 'static>,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<RequestCertificateError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn resend_validation_email(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<ResendValidationEmailError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn update_certificate_options(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<UpdateCertificateOptionsError>>>
                + Send
                + 'static,
        >,
    >;
