...
pub trait Kinesis {
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<AddTagsToStreamError>>> + Send + 'static>>;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<CreateStreamError>>> + Send + 'static>>;
    ...
    fn decrease_stream_retention_period(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<DecreaseStreamRetentionPeriodError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<DeleteStreamError>>> + Send + 'static>>;
    ...
    fn deregister_stream_consumer(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<DeregisterStreamConsumerError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn increase_stream_retention_period(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<IncreaseStreamRetentionPeriodError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_shards(
        ...
        Box<
            dyn Future<Output = Result<ListShardsOutput, RusotoError<ListShardsError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<ListStreamConsumersError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn list_tags_for_stream(
        ...
        Box<
            dyn Future<
                    Output = Result<ListTagsForStreamOutput, RusotoError<ListTagsForStreamError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<MergeShardsError>>> + Send + 'static>>;
    ...
    fn put_record(
        ...
        Box<
            dyn Future<Output = Result<PutRecordOutput, RusotoError<PutRecordError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn put_records(
        ...
        Box<
            dyn Future<Output = Result<PutRecordsOutput, RusotoError<PutRecordsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn remove_tags_from_stream(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<RemoveTagsFromStreamError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<SplitShardError>>> + Send + 'static>>;
    ...
    fn start_stream_encryption(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<StartStreamEncryptionError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn stop_stream_encryption(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<StopStreamEncryptionError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn subscribe_to_shard(
        ...
        Box<
            dyn Future<Output = Result<SubscribeToShardOutput, RusotoError<SubscribeToShardError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn update_shard_count(
        ...
        Box<
            dyn Future<Output = Result<UpdateShardCountOutput, RusotoError<UpdateShardCountError>>>
                + Send
                + 'static,
        >,
    >;
