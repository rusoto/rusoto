        ...
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                ...
                match *error_type {
                    ...
                    "ResourceInUseException" => {
                        DeleteStreamError::ResourceInUse(String::from(error_message))
                    }
                    "ResourceNotFoundException" => {
...
impl DeregisterStreamConsumerError {
    pub fn from_body(body: &str) -> DeregisterStreamConsumerError {
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                let raw_error_type = json
                    .get("__type")
                ...
                match *error_type {
                    "InvalidArgumentException" => {
                        DeregisterStreamConsumerError::InvalidArgument(String::from(error_message))
                    }
                    "LimitExceededException" => {
                        DeregisterStreamConsumerError::LimitExceeded(String::from(error_message))
                    }
                    "ResourceNotFoundException" => {
                        DeregisterStreamConsumerError::ResourceNotFound(String::from(error_message))
                    }
                    "ValidationException" => {
                        DeregisterStreamConsumerError::Validation(error_message.to_string())
                    }
                    _ => DeregisterStreamConsumerError::Unknown(String::from(body)),
                }
            }
            Err(_) => DeregisterStreamConsumerError::Unknown(String::from(body)),
        }
    }
}
...
impl From<serde_json::error::Error> for DeregisterStreamConsumerError {
    fn from(err: serde_json::error::Error) -> DeregisterStreamConsumerError {
        DeregisterStreamConsumerError::Unknown(err.description().to_string())
    }
}
...
impl Error for DeregisterStreamConsumerError {
    fn description(&self) -> &str {
        match *self {
            ...
            DeregisterStreamConsumerError::Unknown(ref cause) => cause,
        }
    }
}
...
impl DescribeStreamConsumerError {
    pub fn from_body(body: &str) -> DescribeStreamConsumerError {
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                let raw_error_type = json
                    .get("__type")
                ...
                match *error_type {
                    "InvalidArgumentException" => {
                        DescribeStreamConsumerError::InvalidArgument(String::from(error_message))
                    }
                    "LimitExceededException" => {
                        DescribeStreamConsumerError::LimitExceeded(String::from(error_message))
                    }
                    "ResourceNotFoundException" => {
                        DescribeStreamConsumerError::ResourceNotFound(String::from(error_message))
                    }
                    "ValidationException" => {
                        DescribeStreamConsumerError::Validation(error_message.to_string())
                    }
                    _ => DescribeStreamConsumerError::Unknown(String::from(body)),
                }
            }
            Err(_) => DescribeStreamConsumerError::Unknown(String::from(body)),
        }
    }
}
...
impl From<serde_json::error::Error> for DescribeStreamConsumerError {
    fn from(err: serde_json::error::Error) -> DescribeStreamConsumerError {
        DescribeStreamConsumerError::Unknown(err.description().to_string())
    }
}
...
impl Error for DescribeStreamConsumerError {
    fn description(&self) -> &str {
        match *self {
            ...
            DescribeStreamConsumerError::Unknown(ref cause) => cause,
        }
    }
}
...
impl ListStreamConsumersError {
    pub fn from_body(body: &str) -> ListStreamConsumersError {
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                let raw_error_type = json
                    .get("__type")
                ...
                match *error_type {
                    "ExpiredNextTokenException" => {
                        ListStreamConsumersError::ExpiredNextToken(String::from(error_message))
                    }
                    "InvalidArgumentException" => {
                        ListStreamConsumersError::InvalidArgument(String::from(error_message))
                    }
                    "LimitExceededException" => {
                        ListStreamConsumersError::LimitExceeded(String::from(error_message))
                    }
                    "ResourceInUseException" => {
                        ListStreamConsumersError::ResourceInUse(String::from(error_message))
                    }
                    "ResourceNotFoundException" => {
                        ListStreamConsumersError::ResourceNotFound(String::from(error_message))
                    }
                    "ValidationException" => {
                        ListStreamConsumersError::Validation(error_message.to_string())
                    }
                    _ => ListStreamConsumersError::Unknown(String::from(body)),
                }
            }
            Err(_) => ListStreamConsumersError::Unknown(String::from(body)),
        }
    }
}
...
impl From<serde_json::error::Error> for ListStreamConsumersError {
    fn from(err: serde_json::error::Error) -> ListStreamConsumersError {
        ListStreamConsumersError::Unknown(err.description().to_string())
    }
}
...
impl Error for ListStreamConsumersError {
    fn description(&self) -> &str {
        match *self {
            ...
            ListStreamConsumersError::Unknown(ref cause) => cause,
        }
    }
}
...
impl RegisterStreamConsumerError {
    pub fn from_body(body: &str) -> RegisterStreamConsumerError {
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                let raw_error_type = json
                    .get("__type")
                ...
                match *error_type {
                    "InvalidArgumentException" => {
                        RegisterStreamConsumerError::InvalidArgument(String::from(error_message))
                    }
                    "LimitExceededException" => {
                        RegisterStreamConsumerError::LimitExceeded(String::from(error_message))
                    }
                    "ResourceInUseException" => {
                        RegisterStreamConsumerError::ResourceInUse(String::from(error_message))
                    }
                    "ResourceNotFoundException" => {
                        RegisterStreamConsumerError::ResourceNotFound(String::from(error_message))
                    }
                    "ValidationException" => {
                        RegisterStreamConsumerError::Validation(error_message.to_string())
                    }
                    _ => RegisterStreamConsumerError::Unknown(String::from(body)),
                }
            }
            Err(_) => RegisterStreamConsumerError::Unknown(String::from(body)),
        }
    }
}
...
impl From<serde_json::error::Error> for RegisterStreamConsumerError {
    fn from(err: serde_json::error::Error) -> RegisterStreamConsumerError {
        RegisterStreamConsumerError::Unknown(err.description().to_string())
    }
}
...
impl Error for RegisterStreamConsumerError {
    fn description(&self) -> &str {
        match *self {
            ...
            RegisterStreamConsumerError::Unknown(ref cause) => cause,
        }
    }
}
...
impl SubscribeToShardError {
    pub fn from_body(body: &str) -> SubscribeToShardError {
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                let raw_error_type = json
                    .get("__type")
                ...
                match *error_type {
                    "InvalidArgumentException" => {
                        SubscribeToShardError::InvalidArgument(String::from(error_message))
                    }
                    "LimitExceededException" => {
                        SubscribeToShardError::LimitExceeded(String::from(error_message))
                    }
                    "ResourceInUseException" => {
                        SubscribeToShardError::ResourceInUse(String::from(error_message))
                    }
                    "ResourceNotFoundException" => {
                        SubscribeToShardError::ResourceNotFound(String::from(error_message))
                    }
                    "ValidationException" => {
                        SubscribeToShardError::Validation(error_message.to_string())
                    }
                    _ => SubscribeToShardError::Unknown(String::from(body)),
                }
            }
            Err(_) => SubscribeToShardError::Unknown(String::from(body)),
        }
    }
}
...
impl From<serde_json::error::Error> for SubscribeToShardError {
    fn from(err: serde_json::error::Error) -> SubscribeToShardError {
        SubscribeToShardError::Unknown(err.description().to_string())
    }
}
...
impl Error for SubscribeToShardError {
    fn description(&self) -> &str {
        match *self {
            ...
            SubscribeToShardError::Unknown(ref cause) => cause,
        }
    }
}
    ...
    fn deregister_stream_consumer(
        ...
        self.client.sign_and_dispatch(request, |response| {
            if response.status.is_success() {
                ...
                Box::new(response.buffer().from_err().and_then(|response| {
                    Err(DeregisterStreamConsumerError::from_body(
                        String::from_utf8_lossy(response.body.as_ref()).as_ref(),
                    ))
                }))
            }
    ...
    fn describe_stream_consumer(
        ...
        self.client.sign_and_dispatch(request, |response| {
            if response.status.is_success() {
                ...
                Box::new(response.buffer().from_err().and_then(|response| {
                    Err(DescribeStreamConsumerError::from_body(
                        String::from_utf8_lossy(response.body.as_ref()).as_ref(),
                    ))
                }))
            }
    ...
    fn list_stream_consumers(
        ...
        self.client.sign_and_dispatch(request, |response| {
            if response.status.is_success() {
                ...
                Box::new(response.buffer().from_err().and_then(|response| {
                    Err(ListStreamConsumersError::from_body(
                        String::from_utf8_lossy(response.body.as_ref()).as_ref(),
                    ))
                }))
            }
    ...
    fn register_stream_consumer(
        ...
        self.client.sign_and_dispatch(request, |response| {
            if response.status.is_success() {
                ...
                Box::new(response.buffer().from_err().and_then(|response| {
                    Err(RegisterStreamConsumerError::from_body(
                        String::from_utf8_lossy(response.body.as_ref()).as_ref(),
                    ))
                }))
            }
    ...
    fn subscribe_to_shard(
        ...
        self.client.sign_and_dispatch(request, |response| {
            if response.status.is_success() {
                ...
                Box::new(response.buffer().from_err().and_then(|response| {
                    Err(SubscribeToShardError::from_body(
                        String::from_utf8_lossy(response.body.as_ref()).as_ref(),
                    ))
                }))
            }
