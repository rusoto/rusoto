...
pub struct StartStreamEncryptionInput {
    /// <p><p>The encryption type to use. This parameter can be one of the following values:</p> <ul> <li> <p> <code>NONE</code>: Not valid for this operation. An <code>InvalidOperationException</code> will be thrown.</p> </li> <li> <p> <code>KMS</code>: Use server-side encryption on the records in the stream using a customer-managed KMS key.</p> </li> </ul></p>
    #[serde(rename = "EncryptionType")]
    pub encryption_type: String,
    /// <p>The GUID for the customer-managed KMS key to use for encryption. You can also use a Kinesis-owned master key by specifying the alias <code>aws/kinesis</code>.</p>
    #[serde(rename = "KeyId")]
    pub key_id: String,
...
pub struct StopStreamEncryptionInput {
    /// <p><p>The encryption type. This parameter can be one of the following values:</p> <ul> <li> <p> <code>NONE</code>: Not valid for this operation. An <code>InvalidOperationException</code> will be thrown.</p> </li> <li> <p> <code>KMS</code>: Use server-side encryption on the records in the stream using a customer-managed KMS key.</p> </li> </ul></p>
    #[serde(rename = "EncryptionType")]
    pub encryption_type: String,
...
pub struct StreamDescription {
    ...
    /// <p>The GUID for the customer-managed KMS key used for encryption on the stream.</p>
    #[serde(rename = "KeyId")]
    #[serde(skip_serializing_if = "Option::is_none")]
