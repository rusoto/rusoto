...
/// Trait representing the capabilities of the Kinesis API. Kinesis clients implement this trait.
        pub trait Kinesis {
                ...
                fn decrease_stream_retention_period(&self, input: &DecreaseStreamRetentionPeriodInput)  -> Result<(), DecreaseStreamRetentionPeriodError>;
                ...
                fn disable_enhanced_monitoring(&self, input: &DisableEnhancedMonitoringInput)  -> Result<EnhancedMonitoringOutput, DisableEnhancedMonitoringError>;
                

                #[doc="<p>Enables enhanced Amazon Kinesis stream monitoring for shard-level metrics.</p>"]
                fn enable_enhanced_monitoring(&self, input: &EnableEnhancedMonitoringInput)  -> Result<EnhancedMonitoringOutput, EnableEnhancedMonitoringError>;
                ...
                fn increase_stream_retention_period(&self, input: &IncreaseStreamRetentionPeriodInput)  -> Result<(), IncreaseStreamRetentionPeriodError>;
                ...
                fn list_tags_for_stream(&self, input: &ListTagsForStreamInput)  -> Result<ListTagsForStreamOutput, ListTagsForStreamError>;
                ...
                fn remove_tags_from_stream(&self, input: &RemoveTagsFromStreamInput)  -> Result<(), RemoveTagsFromStreamError>;
                ...
                fn update_shard_count(&self, input: &UpdateShardCountInput)  -> Result<UpdateShardCountOutput, UpdateShardCountError>;
        ...
        impl<P, D> Kinesis for KinesisClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        ...
                        _ => Err(AddTagsToStreamError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        ...
                        _ => Err(CreateStreamError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        ...
                        _ => Err(DeleteStreamError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        ...
                        _ => Err(ListTagsForStreamError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        ...
                        _ => Err(RemoveTagsFromStreamError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        ...
                        _ => Err(UpdateShardCountError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
