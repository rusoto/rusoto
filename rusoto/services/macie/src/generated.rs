...
impl AssociateMemberAccountError {
    ...
    ) -> RusotoError<AssociateMemberAccountError> {
        match err {
...
impl AssociateS3ResourcesError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<AssociateS3ResourcesError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DisassociateMemberAccountError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DisassociateMemberAccountError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DisassociateS3ResourcesError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DisassociateS3ResourcesError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ListMemberAccountsError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<ListMemberAccountsError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ListS3ResourcesError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<ListS3ResourcesError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl UpdateS3ResourcesError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<UpdateS3ResourcesError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl Macie for MacieClient {
    ...
    async fn associate_member_account(
        ...
        let response = self
            ...
            .await
            .map_err(AssociateMemberAccountError::refine)?;
    ...
    async fn associate_s3_resources(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(AssociateS3ResourcesError::refine)?;
    ...
    async fn disassociate_member_account(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DisassociateMemberAccountError::refine)?;
        std::mem::drop(response);
        Ok(())
    }
    ...
    async fn disassociate_s3_resources(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DisassociateS3ResourcesError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn list_member_accounts(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListMemberAccountsError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn list_s3_resources(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ListS3ResourcesError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn update_s3_resources(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(UpdateS3ResourcesError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
