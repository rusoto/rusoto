...
#[derive(Default, Debug, Clone, PartialEq, Serialize)]
pub struct GetHLSStreamingSessionURLRequest {
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct GetHLSStreamingSessionURLResponse {
...
#[derive(Default, Debug, Clone, PartialEq, Serialize)]
pub struct GetMediaForFragmentListRequest {
...
pub struct GetMediaForFragmentListResponse {
...
pub trait KinesisVideoArchivedMedia {
    ...
    fn get_hls_streaming_session_url(
        &self,
        input: GetHLSStreamingSessionURLRequest,
    ...
    fn get_media_for_fragment_list(
        &self,
        input: GetMediaForFragmentListRequest,
    ...
    fn list_fragments(&self, input: ListFragmentsRequest) -> Request<ListFragmentsRequest>;
}
...
impl ServiceRequest for GetHLSStreamingSessionURLRequest {
    type Output = GetHLSStreamingSessionURLResponse;
    type Error = GetHLSStreamingSessionURLError;
            ...
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    let result = proto::json::ResponsePayload::new(&response)
                        .deserialize::<GetHLSStreamingSessionURLResponse, _>()?;
...
impl ServiceRequest for GetMediaForFragmentListRequest {
    type Output = GetMediaForFragmentListResponse;
    type Error = GetMediaForFragmentListError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    let mut result = GetMediaForFragmentListResponse::default();
...
impl ServiceRequest for ListFragmentsRequest {
    type Output = ListFragmentsResponse;
    type Error = ListFragmentsError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    let result = proto::json::ResponsePayload::new(&response)
                        .deserialize::<ListFragmentsResponse, _>()?;
