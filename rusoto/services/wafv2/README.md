...
## Installation
To use `rusoto_wafv2` in your application, add it as a dependency in your `Cargo.toml`:
```toml
[dependencies]
rusoto_wafv2 = "0.43.0-beta1"
```
## Crate Features
...
[api-documentation]: https://docs.rs/rusoto_wafv2 "API documentation"
