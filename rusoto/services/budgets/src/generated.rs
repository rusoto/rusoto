...
impl Into<String> for ActionStatus {
    fn into(self) -> String {
        match self {
            ActionStatus::ExecutionFailure => "EXECUTION_FAILURE".to_string(),
            ActionStatus::ExecutionInProgress => "EXECUTION_IN_PROGRESS".to_string(),
            ActionStatus::ExecutionSuccess => "EXECUTION_SUCCESS".to_string(),
            ActionStatus::Pending => "PENDING".to_string(),
            ActionStatus::ResetFailure => "RESET_FAILURE".to_string(),
            ActionStatus::ResetInProgress => "RESET_IN_PROGRESS".to_string(),
            ActionStatus::ReverseFailure => "REVERSE_FAILURE".to_string(),
            ActionStatus::ReverseInProgress => "REVERSE_IN_PROGRESS".to_string(),
            ActionStatus::ReverseSuccess => "REVERSE_SUCCESS".to_string(),
            ActionStatus::Standby => "STANDBY".to_string(),
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownActionSubType {
    name: String,
}
...
pub enum ActionSubType {
    ...
    StopRdsInstances,
    #[doc(hidden)]
    UnknownVariant(UnknownActionSubType),
}

impl Default for ActionSubType {
    fn default() -> Self {
        "".into()
    }
}

impl fmt::Display for ActionSubType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.into())
    }
}

impl rusoto_core::param::ToParam for ActionSubType {
    fn to_param(&self) -> String {
        self.to_string()
    }
}

impl Into<String> for ActionSubType {
    fn into(self) -> String {
        match self {
            ActionSubType::StopEc2Instances => "STOP_EC2_INSTANCES".to_string(),
            ActionSubType::StopRdsInstances => "STOP_RDS_INSTANCES".to_string(),
            ActionSubType::UnknownVariant(UnknownActionSubType { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a ActionSubType {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for ActionSubType {
    fn from(name: &str) -> Self {
        match name {
            "STOP_EC2_INSTANCES" => ActionSubType::StopEc2Instances,
            "STOP_RDS_INSTANCES" => ActionSubType::StopRdsInstances,
            _ => ActionSubType::UnknownVariant(UnknownActionSubType {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for ActionSubType {
    fn from(name: String) -> Self {
        match &*name {
            "STOP_EC2_INSTANCES" => ActionSubType::StopEc2Instances,
            "STOP_RDS_INSTANCES" => ActionSubType::StopRdsInstances,
            _ => ActionSubType::UnknownVariant(UnknownActionSubType { name }),
        }
    }
}
...
impl Serialize for ActionSubType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> Deserialize<'de> for ActionSubType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
pub struct ActionThreshold {
    ...
    pub action_threshold_type: ThresholdType,
...
impl Into<String> for ActionType {
    fn into(self) -> String {
        match self {
            ActionType::ApplyIamPolicy => "APPLY_IAM_POLICY".to_string(),
            ActionType::ApplyScpPolicy => "APPLY_SCP_POLICY".to_string(),
            ActionType::RunSsmDocuments => "RUN_SSM_DOCUMENTS".to_string(),
...
impl From<&str> for ActionType {
    fn from(name: &str) -> Self {
        match name {
            "APPLY_IAM_POLICY" => ActionType::ApplyIamPolicy,
            "APPLY_SCP_POLICY" => ActionType::ApplyScpPolicy,
            "RUN_SSM_DOCUMENTS" => ActionType::RunSsmDocuments,
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownApprovalModel {
    name: String,
}
...
pub enum ApprovalModel {
    ...
    Manual,
    #[doc(hidden)]
    UnknownVariant(UnknownApprovalModel),
}
...
impl fmt::Display for ApprovalModel {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.into())
    }
}

impl rusoto_core::param::ToParam for ApprovalModel {
    fn to_param(&self) -> String {
        self.to_string()
    }
}

impl Into<String> for ApprovalModel {
    fn into(self) -> String {
        match self {
            ApprovalModel::Automatic => "AUTOMATIC".to_string(),
            ApprovalModel::Manual => "MANUAL".to_string(),
            ApprovalModel::UnknownVariant(UnknownApprovalModel { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a ApprovalModel {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for ApprovalModel {
    fn from(name: &str) -> Self {
        match name {
            "AUTOMATIC" => ApprovalModel::Automatic,
            "MANUAL" => ApprovalModel::Manual,
            _ => ApprovalModel::UnknownVariant(UnknownApprovalModel {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for ApprovalModel {
    fn from(name: String) -> Self {
        match &*name {
            "AUTOMATIC" => ApprovalModel::Automatic,
            "MANUAL" => ApprovalModel::Manual,
            _ => ApprovalModel::UnknownVariant(UnknownApprovalModel { name }),
        }
    }
}
...
impl Serialize for ApprovalModel {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> Deserialize<'de> for ApprovalModel {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
pub enum BudgetType {
    ...
    Usage,
    #[doc(hidden)]
    UnknownVariant(UnknownBudgetType),
}
...
impl rusoto_core::param::ToParam for BudgetType {
    fn to_param(&self) -> String {
        self.to_string()
    }
}
...
impl Into<String> for BudgetType {
    fn into(self) -> String {
        match self {
            BudgetType::Cost => "COST".to_string(),
            BudgetType::RiCoverage => "RI_COVERAGE".to_string(),
            BudgetType::RiUtilization => "RI_UTILIZATION".to_string(),
            BudgetType::SavingsPlansCoverage => "SAVINGS_PLANS_COVERAGE".to_string(),
            BudgetType::SavingsPlansUtilization => "SAVINGS_PLANS_UTILIZATION".to_string(),
            BudgetType::Usage => "USAGE".to_string(),
            BudgetType::UnknownVariant(UnknownBudgetType { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a BudgetType {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for BudgetType {
    fn from(name: &str) -> Self {
        match name {
            "COST" => BudgetType::Cost,
            "RI_COVERAGE" => BudgetType::RiCoverage,
            "RI_UTILIZATION" => BudgetType::RiUtilization,
            "SAVINGS_PLANS_COVERAGE" => BudgetType::SavingsPlansCoverage,
            "SAVINGS_PLANS_UTILIZATION" => BudgetType::SavingsPlansUtilization,
            "USAGE" => BudgetType::Usage,
            _ => BudgetType::UnknownVariant(UnknownBudgetType {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for BudgetType {
    fn from(name: String) -> Self {
        match &*name {
            ...
            "SAVINGS_PLANS_UTILIZATION" => BudgetType::SavingsPlansUtilization,
            "USAGE" => BudgetType::Usage,
            _ => BudgetType::UnknownVariant(UnknownBudgetType { name }),
        }
    }
}
...
impl Into<String> for ComparisonOperator {
    fn into(self) -> String {
        match self {
            ComparisonOperator::EqualTo => "EQUAL_TO".to_string(),
...
impl Into<String> for EventType {
    fn into(self) -> String {
        match self {
            EventType::CreateAction => "CREATE_ACTION".to_string(),
            EventType::DeleteAction => "DELETE_ACTION".to_string(),
            EventType::ExecuteAction => "EXECUTE_ACTION".to_string(),
            EventType::System => "SYSTEM".to_string(),
            EventType::UpdateAction => "UPDATE_ACTION".to_string(),
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownExecutionType {
    name: String,
}
...
pub enum ExecutionType {
    ...
    ReverseBudgetAction,
    #[doc(hidden)]
    UnknownVariant(UnknownExecutionType),
}
...
impl rusoto_core::param::ToParam for ExecutionType {
    fn to_param(&self) -> String {
        self.to_string()
    }
}

impl Into<String> for ExecutionType {
    fn into(self) -> String {
        match self {
            ExecutionType::ApproveBudgetAction => "APPROVE_BUDGET_ACTION".to_string(),
            ExecutionType::ResetBudgetAction => "RESET_BUDGET_ACTION".to_string(),
            ExecutionType::RetryBudgetAction => "RETRY_BUDGET_ACTION".to_string(),
            ExecutionType::ReverseBudgetAction => "REVERSE_BUDGET_ACTION".to_string(),
            ExecutionType::UnknownVariant(UnknownExecutionType { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a ExecutionType {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for ExecutionType {
    fn from(name: &str) -> Self {
        match name {
            ...
            _ => ExecutionType::UnknownVariant(UnknownExecutionType {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for ExecutionType {
    fn from(name: String) -> Self {
        match &*name {
            ...
            "RETRY_BUDGET_ACTION" => ExecutionType::RetryBudgetAction,
            "REVERSE_BUDGET_ACTION" => ExecutionType::ReverseBudgetAction,
            _ => ExecutionType::UnknownVariant(UnknownExecutionType { name }),
        }
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownNotificationState {
    name: String,
}
...
pub enum NotificationState {
    ...
    Ok,
    #[doc(hidden)]
    UnknownVariant(UnknownNotificationState),
}
...
impl rusoto_core::param::ToParam for NotificationState {
    fn to_param(&self) -> String {
        self.to_string()
    }
}

impl Into<String> for NotificationState {
    fn into(self) -> String {
        match self {
            NotificationState::Alarm => "ALARM".to_string(),
            NotificationState::Ok => "OK".to_string(),
            NotificationState::UnknownVariant(UnknownNotificationState { name: original }) => {
                original
            }
        }
    }
...
impl<'a> Into<&'a str> for &'a NotificationState {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for NotificationState {
    fn from(name: &str) -> Self {
        match name {
            "ALARM" => NotificationState::Alarm,
            "OK" => NotificationState::Ok,
            _ => NotificationState::UnknownVariant(UnknownNotificationState {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for NotificationState {
    fn from(name: String) -> Self {
        match &*name {
            "ALARM" => NotificationState::Alarm,
            "OK" => NotificationState::Ok,
            _ => NotificationState::UnknownVariant(UnknownNotificationState { name }),
        }
    }
}
...
impl Serialize for NotificationState {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> Deserialize<'de> for NotificationState {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
impl Into<String> for NotificationType {
    fn into(self) -> String {
        match self {
            NotificationType::Actual => "ACTUAL".to_string(),
            NotificationType::Forecasted => "FORECASTED".to_string(),
...
pub struct SsmActionDefinition {
    ...
    pub action_sub_type: ActionSubType,
...
impl Into<String> for SubscriptionType {
    fn into(self) -> String {
        match self {
            SubscriptionType::Email => "EMAIL".to_string(),
            SubscriptionType::Sns => "SNS".to_string(),
...
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
pub struct UnknownThresholdType {
    name: String,
}
...
pub enum ThresholdType {
    ...
    Percentage,
    #[doc(hidden)]
    UnknownVariant(UnknownThresholdType),
}
...
impl rusoto_core::param::ToParam for ThresholdType {
    fn to_param(&self) -> String {
        self.to_string()
    }
}

impl Into<String> for ThresholdType {
    fn into(self) -> String {
        match self {
            ThresholdType::AbsoluteValue => "ABSOLUTE_VALUE".to_string(),
            ThresholdType::Percentage => "PERCENTAGE".to_string(),
            ThresholdType::UnknownVariant(UnknownThresholdType { name: original }) => original,
        }
    }
}

impl<'a> Into<&'a str> for &'a ThresholdType {
    fn into(self) -> &'a str {
        match self {
...
impl From<&str> for ThresholdType {
    fn from(name: &str) -> Self {
        match name {
            "ABSOLUTE_VALUE" => ThresholdType::AbsoluteValue,
            "PERCENTAGE" => ThresholdType::Percentage,
            _ => ThresholdType::UnknownVariant(UnknownThresholdType {
                name: name.to_owned(),
            }),
        }
    }
...
impl From<String> for ThresholdType {
    fn from(name: String) -> Self {
        match &*name {
            "ABSOLUTE_VALUE" => ThresholdType::AbsoluteValue,
            "PERCENTAGE" => ThresholdType::Percentage,
            _ => ThresholdType::UnknownVariant(UnknownThresholdType { name }),
        }
    }
}
...
impl Into<String> for TimeUnit {
    fn into(self) -> String {
        match self {
            TimeUnit::Annually => "ANNUALLY".to_string(),
            TimeUnit::Daily => "DAILY".to_string(),
            TimeUnit::Monthly => "MONTHLY".to_string(),
            TimeUnit::Quarterly => "QUARTERLY".to_string(),
...
pub struct UpdateBudgetActionRequest {
    ...
    #[serde(rename = "ApprovalModel")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub approval_model: Option<ApprovalModel>,
    #[serde(rename = "BudgetName")]
    pub budget_name: String,
    #[serde(rename = "Definition")]
    #[serde(skip_serializing_if = "Option::is_none")]
