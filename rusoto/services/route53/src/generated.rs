...
pub trait Route53 {
    ...
    fn get_account_limit(&self, input: GetAccountLimitRequest) -> Request<GetAccountLimitRequest>;
    ...
    fn get_change(&self, input: GetChangeRequest) -> Request<GetChangeRequest>;
    ...
    fn get_checker_ip_ranges(&self) -> Request<GetCheckerIpRangesRequest>;
    ...
    fn get_geo_location(&self, input: GetGeoLocationRequest) -> Request<GetGeoLocationRequest>;

    /// <p>Gets information about a specified health check.</p>
    fn get_health_check(&self, input: GetHealthCheckRequest) -> Request<GetHealthCheckRequest>;

    /// <p>Retrieves the number of health checks that are associated with the current AWS account.</p>
    fn get_health_check_count(&self) -> Request<GetHealthCheckCountRequest>;
    ...
    fn get_hosted_zone(&self, input: GetHostedZoneRequest) -> Request<GetHostedZoneRequest>;

    /// <p>Retrieves the number of hosted zones that are associated with the current AWS account.</p>
    fn get_hosted_zone_count(&self) -> Request<GetHostedZoneCountRequest>;
    ...
    fn get_traffic_policy_instance_count(&self) -> Request<GetTrafficPolicyInstanceCountRequest>;
    ...
    fn list_hosted_zones(&self, input: ListHostedZonesRequest) -> Request<ListHostedZonesRequest>;
    ...
    /// <p>Gets the value that Amazon Route 53 returns in response to a DNS request for a specified record name and type. You can optionally specify the IP address of a DNS resolver, an EDNS0 client subnet IP address, and a subnet mask. </p>
    fn test_dns_answer(&self, input: TestDNSAnswerRequest) -> Request<TestDNSAnswerRequest>;
...
impl ServiceRequest for AssociateVPCWithHostedZoneRequest {
    type Output = AssociateVPCWithHostedZoneResponse;
    type Error = AssociateVPCWithHostedZoneError;
    ...
    fn dispatch(
        ...
        let mut request = SignedRequest::new("POST", "route53", region, &request_uri);
...
impl ServiceRequest for ChangeResourceRecordSetsRequest {
    type Output = ChangeResourceRecordSetsResponse;
    type Error = ChangeResourceRecordSetsError;
...
impl ServiceRequest for ChangeTagsForResourceRequest {
    type Output = ChangeTagsForResourceResponse;
    type Error = ChangeTagsForResourceError;
...
impl ServiceRequest for CreateHealthCheckRequest {
    type Output = CreateHealthCheckResponse;
    type Error = CreateHealthCheckError;
...
impl ServiceRequest for CreateHostedZoneRequest {
    type Output = CreateHostedZoneResponse;
    type Error = CreateHostedZoneError;
...
impl ServiceRequest for CreateQueryLoggingConfigRequest {
    type Output = CreateQueryLoggingConfigResponse;
    type Error = CreateQueryLoggingConfigError;
...
impl ServiceRequest for CreateReusableDelegationSetRequest {
    type Output = CreateReusableDelegationSetResponse;
    type Error = CreateReusableDelegationSetError;
...
impl ServiceRequest for CreateTrafficPolicyRequest {
    type Output = CreateTrafficPolicyResponse;
    type Error = CreateTrafficPolicyError;
...
impl ServiceRequest for CreateTrafficPolicyInstanceRequest {
    type Output = CreateTrafficPolicyInstanceResponse;
    type Error = CreateTrafficPolicyInstanceError;
...
impl ServiceRequest for CreateTrafficPolicyVersionRequest {
    type Output = CreateTrafficPolicyVersionResponse;
    type Error = CreateTrafficPolicyVersionError;
    ...
    fn dispatch(
        ...
        let request_uri = format!("/2013-04-01/trafficpolicy/{id}", id = self.id)
            .replace("/hostedzone/hostedzone/", "/hostedzone/")
            .replace("/change/change/", "/change/");
...
impl ServiceRequest for CreateVPCAssociationAuthorizationRequest {
    type Output = CreateVPCAssociationAuthorizationResponse;
    type Error = CreateVPCAssociationAuthorizationError;
...
impl ServiceRequest for DeleteHealthCheckRequest {
    type Output = DeleteHealthCheckResponse;
    type Error = DeleteHealthCheckError;
    ...
    fn dispatch(
        ...
        let mut request = SignedRequest::new("DELETE", "route53", region, &request_uri);
...
impl ServiceRequest for DeleteHostedZoneRequest {
    type Output = DeleteHostedZoneResponse;
    type Error = DeleteHostedZoneError;
    ...
    fn dispatch(
        ...
        let request_uri = format!("/2013-04-01/hostedzone/{id}", id = self.id)
            .replace("/hostedzone/hostedzone/", "/hostedzone/")
            .replace("/change/change/", "/change/");
...
impl ServiceRequest for DeleteQueryLoggingConfigRequest {
    type Output = DeleteQueryLoggingConfigResponse;
    type Error = DeleteQueryLoggingConfigError;
    ...
    fn dispatch(
        ...
        let request_uri = format!("/2013-04-01/queryloggingconfig/{id}", id = self.id)
            .replace("/hostedzone/hostedzone/", "/hostedzone/")
            .replace("/change/change/", "/change/");
...
impl ServiceRequest for DeleteReusableDelegationSetRequest {
    type Output = DeleteReusableDelegationSetResponse;
    type Error = DeleteReusableDelegationSetError;
    ...
    fn dispatch(
        ...
        let request_uri = format!("/2013-04-01/delegationset/{id}", id = self.id)
            .replace("/hostedzone/hostedzone/", "/hostedzone/")
            .replace("/change/change/", "/change/");
...
impl ServiceRequest for DeleteTrafficPolicyRequest {
    type Output = DeleteTrafficPolicyResponse;
    type Error = DeleteTrafficPolicyError;
...
impl ServiceRequest for DeleteTrafficPolicyInstanceRequest {
    type Output = DeleteTrafficPolicyInstanceResponse;
    type Error = DeleteTrafficPolicyInstanceError;
    ...
    fn dispatch(
        ...
        let request_uri = format!("/2013-04-01/trafficpolicyinstance/{id}", id = self.id)
            .replace("/hostedzone/hostedzone/", "/hostedzone/")
            .replace("/change/change/", "/change/");
...
impl ServiceRequest for DeleteVPCAssociationAuthorizationRequest {
    type Output = DeleteVPCAssociationAuthorizationResponse;
    type Error = DeleteVPCAssociationAuthorizationError;
...
impl ServiceRequest for DisassociateVPCFromHostedZoneRequest {
    type Output = DisassociateVPCFromHostedZoneResponse;
    type Error = DisassociateVPCFromHostedZoneError;
...
impl ServiceRequest for GetAccountLimitRequest {
    type Output = GetAccountLimitResponse;
    type Error = GetAccountLimitError;
    ...
    fn dispatch(
        ...
        let request_uri = format!("/2013-04-01/accountlimit/{type}", type = self.type_)
            .replace("/hostedzone/hostedzone/", "/hostedzone/")
            .replace("/change/change/", "/change/");

        let mut request = SignedRequest::new("GET", "route53", region, &request_uri);
...
impl ServiceRequest for GetChangeRequest {
    type Output = GetChangeResponse;
    type Error = GetChangeError;
    ...
    fn dispatch(
        ...
        let request_uri = format!("/2013-04-01/change/{id}", id = self.id)
            .replace("/hostedzone/hostedzone/", "/hostedzone/")
            .replace("/change/change/", "/change/");
...
impl ServiceRequest for GetCheckerIpRangesRequest {
    type Output = GetCheckerIpRangesResponse;
    type Error = GetCheckerIpRangesError;
...
impl ServiceRequest for GetGeoLocationRequest {
    type Output = GetGeoLocationResponse;
    type Error = GetGeoLocationError;
    ...
    fn dispatch(
        ...
        if let Some(ref x) = self.continent_code {
            params.put("continentcode", x);
        }
        if let Some(ref x) = self.country_code {
            params.put("countrycode", x);
        }
        if let Some(ref x) = self.subdivision_code {
...
impl ServiceRequest for GetHealthCheckRequest {
    type Output = GetHealthCheckResponse;
    type Error = GetHealthCheckError;
...
impl ServiceRequest for GetHealthCheckCountRequest {
    type Output = GetHealthCheckCountResponse;
    type Error = GetHealthCheckCountError;
...
impl ServiceRequest for GetHealthCheckLastFailureReasonRequest {
    type Output = GetHealthCheckLastFailureReasonResponse;
    type Error = GetHealthCheckLastFailureReasonError;
...
impl ServiceRequest for GetHealthCheckStatusRequest {
    type Output = GetHealthCheckStatusResponse;
    type Error = GetHealthCheckStatusError;
...
impl ServiceRequest for GetHostedZoneRequest {
    type Output = GetHostedZoneResponse;
    type Error = GetHostedZoneError;
...
impl ServiceRequest for GetHostedZoneCountRequest {
    type Output = GetHostedZoneCountResponse;
    type Error = GetHostedZoneCountError;
...
impl ServiceRequest for GetHostedZoneLimitRequest {
    type Output = GetHostedZoneLimitResponse;
    type Error = GetHostedZoneLimitError;
    ...
    fn dispatch(
        ...
        let request_uri = format!("/2013-04-01/hostedzonelimit/{id}/{type}", id = self.hosted_zone_id, type = self.type_).replace("/hostedzone/hostedzone/", "/hostedzone/").replace("/change/change/", "/change/");
...
impl ServiceRequest for GetQueryLoggingConfigRequest {
    type Output = GetQueryLoggingConfigResponse;
    type Error = GetQueryLoggingConfigError;
...
impl ServiceRequest for GetReusableDelegationSetRequest {
    type Output = GetReusableDelegationSetResponse;
    type Error = GetReusableDelegationSetError;
...
impl ServiceRequest for GetReusableDelegationSetLimitRequest {
    type Output = GetReusableDelegationSetLimitResponse;
    type Error = GetReusableDelegationSetLimitError;
    ...
    fn dispatch(
        ...
        let request_uri = format!("/2013-04-01/reusabledelegationsetlimit/{id}/{type}", id = self.delegation_set_id, type = self.type_).replace("/hostedzone/hostedzone/", "/hostedzone/").replace("/change/change/", "/change/");
...
impl ServiceRequest for GetTrafficPolicyRequest {
    type Output = GetTrafficPolicyResponse;
    type Error = GetTrafficPolicyError;
...
impl ServiceRequest for GetTrafficPolicyInstanceRequest {
    type Output = GetTrafficPolicyInstanceResponse;
    type Error = GetTrafficPolicyInstanceError;
...
impl ServiceRequest for GetTrafficPolicyInstanceCountRequest {
    type Output = GetTrafficPolicyInstanceCountResponse;
    type Error = GetTrafficPolicyInstanceCountError;
...
impl ServiceRequest for ListGeoLocationsRequest {
    type Output = ListGeoLocationsResponse;
    type Error = ListGeoLocationsError;
    ...
    fn dispatch(
        ...
        if let Some(ref x) = self.start_continent_code {
            params.put("startcontinentcode", x);
        }
        if let Some(ref x) = self.start_country_code {
            params.put("startcountrycode", x);
        }
        if let Some(ref x) = self.start_subdivision_code {
...
impl ServiceRequest for ListHealthChecksRequest {
    type Output = ListHealthChecksResponse;
    type Error = ListHealthChecksError;
...
impl ServiceRequest for ListHostedZonesRequest {
    type Output = ListHostedZonesResponse;
    type Error = ListHostedZonesError;
    ...
    fn dispatch(
        ...
        let mut params = Params::new();
        if let Some(ref x) = self.delegation_set_id {
...
impl ServiceRequest for ListHostedZonesByNameRequest {
    type Output = ListHostedZonesByNameResponse;
    type Error = ListHostedZonesByNameError;
    ...
    fn dispatch(
        ...
        let mut params = Params::new();
        if let Some(ref x) = self.dns_name {
            params.put("dnsname", x);
        }
        if let Some(ref x) = self.hosted_zone_id {
...
impl ServiceRequest for ListQueryLoggingConfigsRequest {
    type Output = ListQueryLoggingConfigsResponse;
    type Error = ListQueryLoggingConfigsError;
...
impl ServiceRequest for ListResourceRecordSetsRequest {
    type Output = ListResourceRecordSetsResponse;
    type Error = ListResourceRecordSetsError;
    ...
    fn dispatch(
        ...
        if let Some(ref x) = self.start_record_identifier {
            params.put("identifier", x);
        }
        if let Some(ref x) = self.start_record_name {
            params.put("name", x);
        }
        if let Some(ref x) = self.start_record_type {
            params.put("type", x);
        }
        request.set_params(params);
...
impl ServiceRequest for ListReusableDelegationSetsRequest {
    type Output = ListReusableDelegationSetsResponse;
    type Error = ListReusableDelegationSetsError;
...
impl ServiceRequest for ListTagsForResourcesRequest {
    type Output = ListTagsForResourcesResponse;
    type Error = ListTagsForResourcesError;
...
impl ServiceRequest for ListTrafficPoliciesRequest {
    type Output = ListTrafficPoliciesResponse;
    type Error = ListTrafficPoliciesError;
    ...
    fn dispatch(
        ...
        if let Some(ref x) = self.traffic_policy_id_marker {
...
impl ServiceRequest for ListTrafficPolicyInstancesRequest {
    type Output = ListTrafficPolicyInstancesResponse;
    type Error = ListTrafficPolicyInstancesError;
    ...
    fn dispatch(
        ...
        let mut params = Params::new();
        if let Some(ref x) = self.hosted_zone_id_marker {
            params.put("hostedzoneid", x);
        }
        if let Some(ref x) = self.max_items {
            params.put("maxitems", x);
        }
        if let Some(ref x) = self.traffic_policy_instance_name_marker {
            params.put("trafficpolicyinstancename", x);
        }
        if let Some(ref x) = self.traffic_policy_instance_type_marker {
...
impl ServiceRequest for ListTrafficPolicyInstancesByHostedZoneRequest {
    type Output = ListTrafficPolicyInstancesByHostedZoneResponse;
    type Error = ListTrafficPolicyInstancesByHostedZoneError;
    ...
    fn dispatch(
        ...
        let mut params = Params::new();
        params.put("id", &self.hosted_zone_id);
        if let Some(ref x) = self.max_items {
            params.put("maxitems", x);
        }
        if let Some(ref x) = self.traffic_policy_instance_name_marker {
...
impl ServiceRequest for ListTrafficPolicyInstancesByPolicyRequest {
    type Output = ListTrafficPolicyInstancesByPolicyResponse;
    type Error = ListTrafficPolicyInstancesByPolicyError;
    ...
    fn dispatch(
        ...
        params.put("id", &self.traffic_policy_id);
        if let Some(ref x) = self.traffic_policy_instance_name_marker {
            params.put("trafficpolicyinstancename", x);
        }
        if let Some(ref x) = self.traffic_policy_instance_type_marker {
        ...
        params.put("version", &self.traffic_policy_version);
        request.set_params(params);
...
impl ServiceRequest for ListTrafficPolicyVersionsRequest {
    type Output = ListTrafficPolicyVersionsResponse;
    type Error = ListTrafficPolicyVersionsError;
    ...
    fn dispatch(
        ...
        let request_uri = format!("/2013-04-01/trafficpolicies/{id}/versions", id = self.id)
            .replace("/hostedzone/hostedzone/", "/hostedzone/")
            .replace("/change/change/", "/change/");
        ...
        if let Some(ref x) = self.traffic_policy_version_marker {
...
impl ServiceRequest for ListVPCAssociationAuthorizationsRequest {
    type Output = ListVPCAssociationAuthorizationsResponse;
    type Error = ListVPCAssociationAuthorizationsError;
...
impl ServiceRequest for TestDNSAnswerRequest {
    type Output = TestDNSAnswerResponse;
    type Error = TestDNSAnswerError;
    ...
    fn dispatch(
        ...
        let mut params = Params::new();
        if let Some(ref x) = self.edns0_client_subnet_ip {
            params.put("edns0clientsubnetip", x);
        }
        if let Some(ref x) = self.edns0_client_subnet_mask {
            params.put("edns0clientsubnetmask", x);
        }
        params.put("hostedzoneid", &self.hosted_zone_id);
        params.put("recordname", &self.record_name);
        params.put("recordtype", &self.record_type);
        if let Some(ref x) = self.resolver_ip {
...
impl ServiceRequest for UpdateHealthCheckRequest {
    type Output = UpdateHealthCheckResponse;
    type Error = UpdateHealthCheckError;
...
impl ServiceRequest for UpdateHostedZoneCommentRequest {
    type Output = UpdateHostedZoneCommentResponse;
    type Error = UpdateHostedZoneCommentError;
...
impl ServiceRequest for UpdateTrafficPolicyCommentRequest {
    type Output = UpdateTrafficPolicyCommentResponse;
    type Error = UpdateTrafficPolicyCommentError;
...
impl ServiceRequest for UpdateTrafficPolicyInstanceRequest {
    type Output = UpdateTrafficPolicyInstanceResponse;
    type Error = UpdateTrafficPolicyInstanceError;
