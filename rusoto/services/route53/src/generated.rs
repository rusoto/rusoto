            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(AssociateVPCWithHostedZoneResponse::default());
                    } else {
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ChangeResourceRecordSetsResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ChangeTagsForResourceResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(CreateHealthCheckResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(CreateHostedZoneResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(CreateQueryLoggingConfigResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(CreateReusableDelegationSetResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(CreateTrafficPolicyResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(CreateTrafficPolicyInstanceResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(CreateTrafficPolicyVersionResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(CreateVPCAssociationAuthorizationResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(DeleteHealthCheckResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(DeleteHostedZoneResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(DeleteQueryLoggingConfigResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(DeleteReusableDelegationSetResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(DeleteTrafficPolicyResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(DeleteTrafficPolicyInstanceResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(DeleteVPCAssociationAuthorizationResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(DisassociateVPCFromHostedZoneResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetAccountLimitResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetChangeResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetCheckerIpRangesResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetGeoLocationResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetHealthCheckResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetHealthCheckCountResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetHealthCheckLastFailureReasonResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetHealthCheckStatusResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetHostedZoneResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetHostedZoneCountResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetHostedZoneLimitResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetQueryLoggingConfigResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetReusableDelegationSetResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetReusableDelegationSetLimitResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetTrafficPolicyResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetTrafficPolicyInstanceResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(GetTrafficPolicyInstanceCountResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ListGeoLocationsResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ListHealthChecksResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ListHostedZonesResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ListHostedZonesByNameResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ListQueryLoggingConfigsResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ListResourceRecordSetsResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ListReusableDelegationSetsResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ListTagsForResourcesResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ListTrafficPoliciesResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ListTrafficPolicyInstancesResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ListTrafficPolicyInstancesByHostedZoneResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ListTrafficPolicyInstancesByPolicyResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ListTrafficPolicyVersionsResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(ListVPCAssociationAuthorizationsResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(TestDNSAnswerResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(UpdateHealthCheckResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(UpdateHostedZoneCommentResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(UpdateTrafficPolicyCommentResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
        ...
        self.client.sign_and_dispatch(request, |response| {
            ...
            response
                ...
                .and_then(move |xml_response| {
                    ...
                    if xml_response.body.is_empty() {
                        result = Ok(UpdateTrafficPolicyInstanceResponse::default());
                    } else {
                        let reader = EventReader::new_with_config(
                            xml_response.body.as_ref(),
                            ParserConfig::new().trim_whitespace(true),
