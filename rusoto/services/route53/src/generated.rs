...
pub trait Route53 {
    ...
    fn create_health_check(
        ...
        Box<
            dyn Future<
                    Output = Result<CreateHealthCheckResponse, RusotoError<CreateHealthCheckError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn create_hosted_zone(
        ...
        Box<
            dyn Future<
                    Output = Result<CreateHostedZoneResponse, RusotoError<CreateHostedZoneError>>,
                > + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<CreateTrafficPolicyError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn delete_health_check(
        ...
        Box<
            dyn Future<
                    Output = Result<DeleteHealthCheckResponse, RusotoError<DeleteHealthCheckError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn delete_hosted_zone(
        ...
        Box<
            dyn Future<
                    Output = Result<DeleteHostedZoneResponse, RusotoError<DeleteHostedZoneError>>,
                > + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<DeleteTrafficPolicyError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn get_account_limit(
        ...
        Box<
            dyn Future<Output = Result<GetAccountLimitResponse, RusotoError<GetAccountLimitError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_change(
        ...
        Box<
            dyn Future<Output = Result<GetChangeResponse, RusotoError<GetChangeError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<GetCheckerIpRangesError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn get_geo_location(
        ...
        Box<
            dyn Future<Output = Result<GetGeoLocationResponse, RusotoError<GetGeoLocationError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_health_check(
        ...
        Box<
            dyn Future<Output = Result<GetHealthCheckResponse, RusotoError<GetHealthCheckError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<GetHealthCheckCountError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn get_hosted_zone(
        ...
        Box<
            dyn Future<Output = Result<GetHostedZoneResponse, RusotoError<GetHostedZoneError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<GetHostedZoneCountError>,
                    >,
                > + Send
                + 'static,
        >,
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<GetHostedZoneLimitError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn get_traffic_policy(
        ...
        Box<
            dyn Future<
                    Output = Result<GetTrafficPolicyResponse, RusotoError<GetTrafficPolicyError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn list_geo_locations(
        ...
        Box<
            dyn Future<
                    Output = Result<ListGeoLocationsResponse, RusotoError<ListGeoLocationsError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn list_health_checks(
        ...
        Box<
            dyn Future<
                    Output = Result<ListHealthChecksResponse, RusotoError<ListHealthChecksError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn list_hosted_zones(
        ...
        Box<
            dyn Future<Output = Result<ListHostedZonesResponse, RusotoError<ListHostedZonesError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<ListTrafficPoliciesError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn test_dns_answer(
        ...
        Box<
            dyn Future<Output = Result<TestDNSAnswerResponse, RusotoError<TestDNSAnswerError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn update_health_check(
        ...
        Box<
            dyn Future<
                    Output = Result<UpdateHealthCheckResponse, RusotoError<UpdateHealthCheckError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    > {
        ...
        async move {
            ...
            if xml_response.body.is_empty() {
                ...
                let actual_tag_name = peek_at_name(&mut stack)?;
                result =
                    GetGeoLocationResponseDeserializer::deserialize(&actual_tag_name, &mut stack)?;
            }
            // parse non-payload
            Ok(result)
        }
    ...
    > {
        ...
        async move {
            ...
            if xml_response.body.is_empty() {
                ...
                let actual_tag_name = peek_at_name(&mut stack)?;
                result =
                    GetHealthCheckResponseDeserializer::deserialize(&actual_tag_name, &mut stack)?;
            }
            // parse non-payload
            Ok(result)
        }
    ...
    > {
        ...
        async move {
            ...
            if xml_response.body.is_empty() {
                ...
                let actual_tag_name = peek_at_name(&mut stack)?;
                result =
                    GetHostedZoneResponseDeserializer::deserialize(&actual_tag_name, &mut stack)?;
            }
            // parse non-payload
            Ok(result)
        }
    ...
    > {
        ...
        async move {
            ...
            if xml_response.body.is_empty() {
                ...
                let actual_tag_name = peek_at_name(&mut stack)?;
                result =
                    TestDNSAnswerResponseDeserializer::deserialize(&actual_tag_name, &mut stack)?;
            }
            // parse non-payload
            Ok(result)
        }
