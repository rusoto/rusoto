...
<a href="https://docs.rs/rusoto_signer/0.45.0" title="API Docs"><img src="https://img.shields.io/badge/API-docs-blue.svg" alt="api-docs-badge"></img></a>
<a href="https://crates.io/crates/rusoto_signer/0.45.0" title="Crates.io"><img src="https://img.shields.io/crates/v/rusoto_core.svg" alt="crates-io"></img></a>
...
To use `rusoto_signer` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
rusoto_signer = "0.45.0"
```
...
[api-documentation]: https://docs.rs/rusoto_signer "API documentation"
