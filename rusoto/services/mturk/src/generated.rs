...
pub trait MechanicalTurk {
    ...
    fn approve_assignment(
        ...
        Box<
            dyn Future<
                    Output = Result<ApproveAssignmentResponse, RusotoError<ApproveAssignmentError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn create_hit(
        ...
        Box<
            dyn Future<Output = Result<CreateHITResponse, RusotoError<CreateHITError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn create_hit_type(
        ...
        Box<
            dyn Future<Output = Result<CreateHITTypeResponse, RusotoError<CreateHITTypeError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn create_worker_block(
        ...
        Box<
            dyn Future<
                    Output = Result<CreateWorkerBlockResponse, RusotoError<CreateWorkerBlockError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn delete_hit(
        ...
        Box<
            dyn Future<Output = Result<DeleteHITResponse, RusotoError<DeleteHITError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_worker_block(
        ...
        Box<
            dyn Future<
                    Output = Result<DeleteWorkerBlockResponse, RusotoError<DeleteWorkerBlockError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn get_account_balance(
        ...
        Box<
            dyn Future<
                    Output = Result<GetAccountBalanceResponse, RusotoError<GetAccountBalanceError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn get_assignment(
        ...
        Box<
            dyn Future<Output = Result<GetAssignmentResponse, RusotoError<GetAssignmentError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_file_upload_url(
        ...
        Box<
            dyn Future<
                    Output = Result<GetFileUploadURLResponse, RusotoError<GetFileUploadURLError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn get_hit(
        ...
        Box<dyn Future<Output = Result<GetHITResponse, RusotoError<GetHITError>>> + Send + 'static>,
    >;
    ...
    fn list_bonus_payments(
        ...
        Box<
            dyn Future<
                    Output = Result<ListBonusPaymentsResponse, RusotoError<ListBonusPaymentsError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn list_hi_ts(
        ...
        Box<
            dyn Future<Output = Result<ListHITsResponse, RusotoError<ListHITsError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<ListReviewableHITsError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn list_worker_blocks(
        ...
        Box<
            dyn Future<
                    Output = Result<ListWorkerBlocksResponse, RusotoError<ListWorkerBlocksError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn notify_workers(
        ...
        Box<
            dyn Future<Output = Result<NotifyWorkersResponse, RusotoError<NotifyWorkersError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn reject_assignment(
        ...
        Box<
            dyn Future<
                    Output = Result<RejectAssignmentResponse, RusotoError<RejectAssignmentError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn send_bonus(
        ...
        Box<
            dyn Future<Output = Result<SendBonusResponse, RusotoError<SendBonusError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<UpdateHITTypeOfHITError>,
                    >,
                > + Send
                + 'static,
        >,
