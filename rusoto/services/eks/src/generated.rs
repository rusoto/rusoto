...
pub trait Eks {
    ...
    fn create_nodegroup(
        ...
        Box<
            dyn Future<Output = Result<CreateNodegroupResponse, RusotoError<CreateNodegroupError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_nodegroup(
        ...
        Box<
            dyn Future<Output = Result<DeleteNodegroupResponse, RusotoError<DeleteNodegroupError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn describe_cluster(
        ...
        Box<
            dyn Future<Output = Result<DescribeClusterResponse, RusotoError<DescribeClusterError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn describe_nodegroup(
        ...
        Box<
            dyn Future<
                    Output = Result<DescribeNodegroupResponse, RusotoError<DescribeNodegroupError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn describe_update(
        ...
        Box<
            dyn Future<Output = Result<DescribeUpdateResponse, RusotoError<DescribeUpdateError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<ListFargateProfilesError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn list_nodegroups(
        ...
        Box<
            dyn Future<Output = Result<ListNodegroupsResponse, RusotoError<ListNodegroupsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_updates(
        ...
        Box<
            dyn Future<Output = Result<ListUpdatesResponse, RusotoError<ListUpdatesError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<UpdateClusterConfigError>,
                    >,
                > + Send
                + 'static,
        >,
