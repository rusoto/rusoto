          ...
          D: DispatchSignedRequest
{
                                  ...
                                  .and_then(|response| match response.status {
                                                StatusCode::Ok => {
                                                    future::Either::A(response
                                                                          ...
                                                                          .map(|body| {
                serde_json::from_str::<AddTagsResponse>(String::from_utf8_lossy(body.as_ref())
                                                            .as_ref())
                        .unwrap()
            }))
                                                }
                                  ...
                                  .and_then(|response| match response.status {
                                                StatusCode::Ok => {
                                                    future::Either::A(response
                                                                          ...
                                                                          .map(|body| {
                serde_json::from_str::<CreateTrailResponse>(String::from_utf8_lossy(body.as_ref())
                                                                .as_ref())
                        .unwrap()
            }))
                                                }
                                                _ => {
                                                    future::Either::B(response
                                                                          ...
                                                                          .from_err()
                                                                          .and_then(|body| {
                Err(CreateTrailError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
            }))
                                                }
                                            })
                          })
                                  ...
                                  .and_then(|response| match response.status {
                                                StatusCode::Ok => {
                                                    future::Either::A(response
                                                                          ...
                                                                          .map(|body| {
                serde_json::from_str::<DeleteTrailResponse>(String::from_utf8_lossy(body.as_ref())
                                                                .as_ref())
                        .unwrap()
            }))
                                                }
                                                _ => {
                                                    future::Either::B(response
                                                                          ...
                                                                          .from_err()
                                                                          .and_then(|body| {
                Err(DeleteTrailError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
            }))
                                                }
                                            })
                          })
        ...
        RusotoFuture::new({
                                ...
                                StatusCode::Ok => 
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<DescribeTrailsResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(DescribeTrailsError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn get_event_selectors(&self,
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<GetEventSelectorsResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(GetEventSelectorsError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn get_trail_status(&self,
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<GetTrailStatusResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(GetTrailStatusError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn list_public_keys(&self,
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<ListPublicKeysResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(ListPublicKeysError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
                                  ...
                                  .and_then(|response| match response.status {
                                                StatusCode::Ok => {
                                                    future::Either::A(response
                                                                          ...
                                                                          .map(|body| {
                serde_json::from_str::<ListTagsResponse>(String::from_utf8_lossy(body.as_ref())
                                                             .as_ref())
                        .unwrap()
            }))
                                                }
                                  ...
                                  .and_then(|response| match response.status {
                                                StatusCode::Ok => {
                                                    future::Either::A(response
                                                                          ...
                                                                          .map(|body| {
                serde_json::from_str::<LookupEventsResponse>(String::from_utf8_lossy(body.as_ref())
                                                                 .as_ref())
                        .unwrap()
            }))
                                                }
                                                _ => {
                                                    future::Either::B(response
                                                                          ...
                                                                          .from_err()
                                                                          .and_then(|body| {
                Err(LookupEventsError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
            }))
                                                }
                                            })
                          })
    ...
    fn put_event_selectors(&self,
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<PutEventSelectorsResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(PutEventSelectorsError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
                                  ...
                                  .and_then(|response| match response.status {
                                                StatusCode::Ok => {
                                                    future::Either::A(response
                                                                          ...
                                                                          .map(|body| {
                serde_json::from_str::<RemoveTagsResponse>(String::from_utf8_lossy(body.as_ref())
                                                               .as_ref())
                        .unwrap()
            }))
                                                }
                                  ...
                                  .and_then(|response| match response.status {
                                                StatusCode::Ok => {
                                                    future::Either::A(response
                                                                          ...
                                                                          .map(|body| {
                serde_json::from_str::<StartLoggingResponse>(String::from_utf8_lossy(body.as_ref())
                                                                 .as_ref())
                        .unwrap()
            }))
                                                }
                                                _ => {
                                                    future::Either::B(response
                                                                          ...
                                                                          .from_err()
                                                                          .and_then(|body| {
                Err(StartLoggingError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
            }))
                                                }
                                            })
                          })
                                  ...
                                  .and_then(|response| match response.status {
                                                StatusCode::Ok => {
                                                    future::Either::A(response
                                                                          ...
                                                                          .map(|body| {
                serde_json::from_str::<StopLoggingResponse>(String::from_utf8_lossy(body.as_ref())
                                                                .as_ref())
                        .unwrap()
            }))
                                                }
                                                _ => {
                                                    future::Either::B(response
                                                                          ...
                                                                          .from_err()
                                                                          .and_then(|body| {
                Err(StopLoggingError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
            }))
                                                }
                                            })
                          })
                                  ...
                                  .and_then(|response| match response.status {
                                                StatusCode::Ok => {
                                                    future::Either::A(response
                                                                          ...
                                                                          .map(|body| {
                serde_json::from_str::<UpdateTrailResponse>(String::from_utf8_lossy(body.as_ref())
                                                                .as_ref())
                        .unwrap()
            }))
                                                }
                                                _ => {
                                                    future::Either::B(response
                                                                          ...
                                                                          .from_err()
                                                                          .and_then(|body| {
                Err(UpdateTrailError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
            }))
                                                }
                                            })
                          })
