...
pub trait AcmPca {
    ...
    fn create_permission(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<CreatePermissionError>>> + Send + 'static>,
    >;
    ...
    fn delete_certificate_authority(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<DeleteCertificateAuthorityError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_permission(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<DeletePermissionError>>> + Send + 'static>,
    >;
    ...
    fn get_certificate(
        ...
        Box<
            dyn Future<Output = Result<GetCertificateResponse, RusotoError<GetCertificateError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn import_certificate_authority_certificate(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<ImportCertificateAuthorityCertificateError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn issue_certificate(
        ...
        Box<
            dyn Future<
                    Output = Result<IssueCertificateResponse, RusotoError<IssueCertificateError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn list_permissions(
        ...
        Box<
            dyn Future<Output = Result<ListPermissionsResponse, RusotoError<ListPermissionsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn restore_certificate_authority(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<RestoreCertificateAuthorityError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn revoke_certificate(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<RevokeCertificateError>>> + Send + 'static>,
    >;
    ...
    fn tag_certificate_authority(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<TagCertificateAuthorityError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn untag_certificate_authority(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<UntagCertificateAuthorityError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn update_certificate_authority(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<UpdateCertificateAuthorityError>>>
                + Send
                + 'static,
        >,
    >;
