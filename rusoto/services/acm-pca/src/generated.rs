...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DeleteCertificateAuthorityResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct ImportCertificateAuthorityCertificateResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct RestoreCertificateAuthorityResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct TagCertificateAuthorityResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct UntagCertificateAuthorityResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct UpdateCertificateAuthorityResponse {}
...
pub trait AcmPca {
    ...
    fn create_permission(&self, input: CreatePermissionRequest)
    ...
    fn delete_permission(&self, input: DeletePermissionRequest)
    ...
    fn get_certificate(&self, input: GetCertificateRequest) -> Request<GetCertificateRequest>;
    ...
    fn issue_certificate(&self, input: IssueCertificateRequest)
    ...
    fn list_permissions(&self, input: ListPermissionsRequest) -> Request<ListPermissionsRequest>;
...
impl ServiceRequest for CreateCertificateAuthorityRequest {
    type Output = CreateCertificateAuthorityResponse;
    type Error = CreateCertificateAuthorityError;
    ...
    fn dispatch(
        ...
        let mut request = SignedRequest::new("POST", "acm-pca", region, "/");
...
impl ServiceRequest for CreateCertificateAuthorityAuditReportRequest {
    type Output = CreateCertificateAuthorityAuditReportResponse;
    type Error = CreateCertificateAuthorityAuditReportError;
...
impl ServiceRequest for CreatePermissionRequest {
    type Output = CreatePermissionResponse;
    type Error = CreatePermissionError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<CreatePermissionResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for DeleteCertificateAuthorityRequest {
    type Output = DeleteCertificateAuthorityResponse;
    type Error = DeleteCertificateAuthorityError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeleteCertificateAuthorityResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DeletePermissionRequest {
    type Output = DeletePermissionResponse;
    type Error = DeletePermissionError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeletePermissionResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for DescribeCertificateAuthorityRequest {
    type Output = DescribeCertificateAuthorityResponse;
    type Error = DescribeCertificateAuthorityError;
...
impl ServiceRequest for DescribeCertificateAuthorityAuditReportRequest {
    type Output = DescribeCertificateAuthorityAuditReportResponse;
    type Error = DescribeCertificateAuthorityAuditReportError;
...
impl ServiceRequest for GetCertificateRequest {
    type Output = GetCertificateResponse;
    type Error = GetCertificateError;
...
impl ServiceRequest for GetCertificateAuthorityCertificateRequest {
    type Output = GetCertificateAuthorityCertificateResponse;
    type Error = GetCertificateAuthorityCertificateError;
...
impl ServiceRequest for GetCertificateAuthorityCsrRequest {
    type Output = GetCertificateAuthorityCsrResponse;
    type Error = GetCertificateAuthorityCsrError;
...
impl ServiceRequest for ImportCertificateAuthorityCertificateRequest {
    type Output = ImportCertificateAuthorityCertificateResponse;
    type Error = ImportCertificateAuthorityCertificateError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<ImportCertificateAuthorityCertificateResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for IssueCertificateRequest {
    type Output = IssueCertificateResponse;
    type Error = IssueCertificateError;
...
impl ServiceRequest for ListCertificateAuthoritiesRequest {
    type Output = ListCertificateAuthoritiesResponse;
    type Error = ListCertificateAuthoritiesError;
...
impl ServiceRequest for ListPermissionsRequest {
    type Output = ListPermissionsResponse;
    type Error = ListPermissionsError;
...
impl ServiceRequest for RestoreCertificateAuthorityRequest {
    type Output = RestoreCertificateAuthorityResponse;
    type Error = RestoreCertificateAuthorityError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<RestoreCertificateAuthorityResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for RevokeCertificateRequest {
    type Output = RevokeCertificateResponse;
    type Error = RevokeCertificateError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<RevokeCertificateResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for TagCertificateAuthorityRequest {
    type Output = TagCertificateAuthorityResponse;
    type Error = TagCertificateAuthorityError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<TagCertificateAuthorityResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for UntagCertificateAuthorityRequest {
    type Output = UntagCertificateAuthorityResponse;
    type Error = UntagCertificateAuthorityError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<UntagCertificateAuthorityResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for UpdateCertificateAuthorityRequest {
    type Output = UpdateCertificateAuthorityResponse;
    type Error = UpdateCertificateAuthorityError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<UpdateCertificateAuthorityResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
