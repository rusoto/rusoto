...
impl DeleteSessionError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<DeleteSessionError> {
        match err {
...
impl GetSessionError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<GetSessionError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl PostContentError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<PostContentError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl PostTextError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<PostTextError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl PutSessionError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<PutSessionError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl LexRuntime for LexRuntimeClient {
    ...
    async fn post_content(
        ...
        if response.status.is_success() {
            ...
            result.slots = response.headers.remove("x-amz-lex-slots");
