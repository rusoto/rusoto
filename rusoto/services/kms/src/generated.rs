...
pub trait Kms {
    ...
    fn cancel_key_deletion(
        ...
        Box<
            dyn Future<
                    Output = Result<CancelKeyDeletionResponse, RusotoError<CancelKeyDeletionError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<CreateAliasError>>> + Send + 'static>>;
    ...
    fn create_grant(
        ...
        Box<
            dyn Future<Output = Result<CreateGrantResponse, RusotoError<CreateGrantError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn create_key(
        ...
        Box<
            dyn Future<Output = Result<CreateKeyResponse, RusotoError<CreateKeyError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn decrypt(
        ...
        Box<
            dyn Future<Output = Result<DecryptResponse, RusotoError<DecryptError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_imported_key_material(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<DeleteImportedKeyMaterialError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn describe_key(
        ...
        Box<
            dyn Future<Output = Result<DescribeKeyResponse, RusotoError<DescribeKeyError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<DisableKeyError>>> + Send + 'static>>;
    ...
    fn disable_key_rotation(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<DisableKeyRotationError>>> + Send + 'static>,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<EnableKeyError>>> + Send + 'static>>;
    ...
    fn enable_key_rotation(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<EnableKeyRotationError>>> + Send + 'static>,
    >;
    ...
    fn encrypt(
        ...
        Box<
            dyn Future<Output = Result<EncryptResponse, RusotoError<EncryptError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn generate_data_key(
        ...
        Box<
            dyn Future<Output = Result<GenerateDataKeyResponse, RusotoError<GenerateDataKeyError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<GenerateDataKeyPairError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn generate_random(
        ...
        Box<
            dyn Future<Output = Result<GenerateRandomResponse, RusotoError<GenerateRandomError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_key_policy(
        ...
        Box<
            dyn Future<Output = Result<GetKeyPolicyResponse, RusotoError<GetKeyPolicyError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_public_key(
        ...
        Box<
            dyn Future<Output = Result<GetPublicKeyResponse, RusotoError<GetPublicKeyError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn import_key_material(
        ...
        Box<
            dyn Future<
                    Output = Result<ImportKeyMaterialResponse, RusotoError<ImportKeyMaterialError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn list_grants(
        ...
        Box<
            dyn Future<Output = Result<ListGrantsResponse, RusotoError<ListGrantsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_key_policies(
        ...
        Box<
            dyn Future<Output = Result<ListKeyPoliciesResponse, RusotoError<ListKeyPoliciesError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_keys(
        ...
        Box<
            dyn Future<Output = Result<ListKeysResponse, RusotoError<ListKeysError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_resource_tags(
        ...
        Box<
            dyn Future<
                    Output = Result<ListResourceTagsResponse, RusotoError<ListResourceTagsError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn list_retirable_grants(
        ...
        Box<
            dyn Future<Output = Result<ListGrantsResponse, RusotoError<ListRetirableGrantsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<PutKeyPolicyError>>> + Send + 'static>>;
    ...
    fn re_encrypt(
        ...
        Box<
            dyn Future<Output = Result<ReEncryptResponse, RusotoError<ReEncryptError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<RetireGrantError>>> + Send + 'static>>;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<RevokeGrantError>>> + Send + 'static>>;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<ScheduleKeyDeletionError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn sign(
        &self,
        input: SignRequest,
    ) -> Pin<Box<dyn Future<Output = Result<SignResponse, RusotoError<SignError>>> + Send + 'static>>;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<UpdateAliasError>>> + Send + 'static>>;
    ...
    fn update_key_description(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<UpdateKeyDescriptionError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn verify(
        ...
        Box<dyn Future<Output = Result<VerifyResponse, RusotoError<VerifyError>>> + Send + 'static>,
    >;
}
    ...
    > {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(CreateGrantError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    > {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(CreateKeyError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    > {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(DecryptError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    > {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(DescribeKeyError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<DisableKeyError>>> + Send + 'static>>
    {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(DisableKeyError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<EnableKeyError>>> + Send + 'static>>
    {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(EnableKeyError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    > {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(EncryptError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    > {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(GenerateDataKeyError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    > {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(GenerateRandomError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    > {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(GetKeyPolicyError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    > {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(GetPublicKeyError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    > {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(ListGrantsError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    > {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(ListKeyPoliciesError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    > {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(ListKeysError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<PutKeyPolicyError>>> + Send + 'static>>
    {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(PutKeyPolicyError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    > {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(ReEncryptError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<RetireGrantError>>> + Send + 'static>>
    {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(RetireGrantError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<RevokeGrantError>>> + Send + 'static>>
    {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(RevokeGrantError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    ) -> Pin<Box<dyn Future<Output = Result<SignResponse, RusotoError<SignError>>> + Send + 'static>>
    {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(SignError::from_response(response))
            }
        }
        .boxed()
    }
    ...
    > {
        ...
        async move {
            ...
            if response.status.is_success() {
                ...
                let try_response = response.buffer().await;
                let response = try_response.map_err(RusotoError::HttpDispatch)?;
                Err(VerifyError::from_response(response))
            }
        }
        .boxed()
    }
