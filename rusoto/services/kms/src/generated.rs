...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DisableKeyRotationResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct EnableKeyRotationResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct ListRetirableGrantsResponse {
    /// <p>A list of grants.</p>
    #[serde(rename = "Grants")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub grants: Option<Vec<GrantListEntry>>,
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct PutKeyPolicyResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct RetireGrantResponse {}
...
pub trait Kms {
    ...
    fn create_grant(&self, input: CreateGrantRequest) -> Request<CreateGrantRequest>;
    ...
    fn create_key(&self, input: CreateKeyRequest) -> Request<CreateKeyRequest>;
    ...
    fn decrypt(&self, input: DecryptRequest) -> Request<DecryptRequest>;
    ...
    fn describe_key(&self, input: DescribeKeyRequest) -> Request<DescribeKeyRequest>;
    ...
    fn disable_key(&self, input: DisableKeyRequest) -> Request<DisableKeyRequest>;
    ...
    fn enable_key(&self, input: EnableKeyRequest) -> Request<EnableKeyRequest>;
    ...
    fn encrypt(&self, input: EncryptRequest) -> Request<EncryptRequest>;
    ...
    fn generate_data_key(&self, input: GenerateDataKeyRequest) -> Request<GenerateDataKeyRequest>;
    ...
    fn generate_random(&self, input: GenerateRandomRequest) -> Request<GenerateRandomRequest>;
    ...
    fn get_key_policy(&self, input: GetKeyPolicyRequest) -> Request<GetKeyPolicyRequest>;
    ...
    fn list_grants(&self, input: ListGrantsRequest) -> Request<ListGrantsRequest>;
    ...
    fn list_key_policies(&self, input: ListKeyPoliciesRequest) -> Request<ListKeyPoliciesRequest>;

    /// <p>Gets a list of all customer master keys (CMKs) in the caller's AWS account and region.</p>
    fn list_keys(&self, input: ListKeysRequest) -> Request<ListKeysRequest>;
    ...
    fn put_key_policy(&self, input: PutKeyPolicyRequest) -> Request<PutKeyPolicyRequest>;
    ...
    fn re_encrypt(&self, input: ReEncryptRequest) -> Request<ReEncryptRequest>;
    ...
    fn retire_grant(&self, input: RetireGrantRequest) -> Request<RetireGrantRequest>;
    ...
    fn revoke_grant(&self, input: RevokeGrantRequest) -> Request<RevokeGrantRequest>;
...
impl ServiceRequest for CancelKeyDeletionRequest {
    type Output = CancelKeyDeletionResponse;
    type Error = CancelKeyDeletionError;
    ...
    fn dispatch(
        ...
        let mut request = SignedRequest::new("POST", "kms", region, "/");
...
impl ServiceRequest for ConnectCustomKeyStoreRequest {
    type Output = ConnectCustomKeyStoreResponse;
    type Error = ConnectCustomKeyStoreError;
...
impl ServiceRequest for CreateCustomKeyStoreRequest {
    type Output = CreateCustomKeyStoreResponse;
    type Error = CreateCustomKeyStoreError;
...
impl ServiceRequest for CreateGrantRequest {
    type Output = CreateGrantResponse;
    type Error = CreateGrantError;
...
impl ServiceRequest for CreateKeyRequest {
    type Output = CreateKeyResponse;
...
impl ServiceRequest for DecryptRequest {
...
impl ServiceRequest for DeleteCustomKeyStoreRequest {
    type Output = DeleteCustomKeyStoreResponse;
    type Error = DeleteCustomKeyStoreError;
...
impl ServiceRequest for DeleteImportedKeyMaterialRequest {
    type Output = DeleteImportedKeyMaterialResponse;
    type Error = DeleteImportedKeyMaterialError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeleteImportedKeyMaterialResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DescribeCustomKeyStoresRequest {
    type Output = DescribeCustomKeyStoresResponse;
    type Error = DescribeCustomKeyStoresError;
...
impl ServiceRequest for DescribeKeyRequest {
    type Output = DescribeKeyResponse;
    type Error = DescribeKeyError;
...
impl ServiceRequest for DisableKeyRequest {
    type Output = DisableKeyResponse;
    type Error = DisableKeyError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DisableKeyResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for DisableKeyRotationRequest {
    type Output = DisableKeyRotationResponse;
    type Error = DisableKeyRotationError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DisableKeyRotationResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for DisconnectCustomKeyStoreRequest {
    type Output = DisconnectCustomKeyStoreResponse;
    type Error = DisconnectCustomKeyStoreError;
...
impl ServiceRequest for EnableKeyRequest {
    type Output = EnableKeyResponse;
    type Error = EnableKeyError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<EnableKeyResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for EnableKeyRotationRequest {
    type Output = EnableKeyRotationResponse;
    type Error = EnableKeyRotationError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<EnableKeyRotationResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for EncryptRequest {
...
impl ServiceRequest for GenerateDataKeyRequest {
    type Output = GenerateDataKeyResponse;
    type Error = GenerateDataKeyError;
...
impl ServiceRequest for GenerateDataKeyWithoutPlaintextRequest {
    type Output = GenerateDataKeyWithoutPlaintextResponse;
    type Error = GenerateDataKeyWithoutPlaintextError;
...
impl ServiceRequest for GenerateRandomRequest {
    type Output = GenerateRandomResponse;
    type Error = GenerateRandomError;
...
impl ServiceRequest for GetKeyPolicyRequest {
    type Output = GetKeyPolicyResponse;
    type Error = GetKeyPolicyError;
...
impl ServiceRequest for GetKeyRotationStatusRequest {
    type Output = GetKeyRotationStatusResponse;
    type Error = GetKeyRotationStatusError;
...
impl ServiceRequest for GetParametersForImportRequest {
    type Output = GetParametersForImportResponse;
    type Error = GetParametersForImportError;
...
impl ServiceRequest for ImportKeyMaterialRequest {
    type Output = ImportKeyMaterialResponse;
    type Error = ImportKeyMaterialError;
...
impl ServiceRequest for ListGrantsRequest {
    type Output = ListGrantsResponse;
    type Error = ListGrantsError;
...
impl ServiceRequest for ListKeyPoliciesRequest {
    type Output = ListKeyPoliciesResponse;
    type Error = ListKeyPoliciesError;
...
impl ServiceRequest for ListKeysRequest {
    type Output = ListKeysResponse;
    type Error = ListKeysError;
...
impl ServiceRequest for ListResourceTagsRequest {
    type Output = ListResourceTagsResponse;
    type Error = ListResourceTagsError;
...
impl ServiceRequest for ListRetirableGrantsRequest {
    type Output = ListRetirableGrantsResponse;
    type Error = ListRetirableGrantsError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<ListRetirableGrantsResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for PutKeyPolicyRequest {
    type Output = PutKeyPolicyResponse;
    type Error = PutKeyPolicyError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<PutKeyPolicyResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for ReEncryptRequest {
    type Output = ReEncryptResponse;
    type Error = ReEncryptError;
...
impl ServiceRequest for RetireGrantRequest {
    type Output = RetireGrantResponse;
    type Error = RetireGrantError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<RetireGrantResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for RevokeGrantRequest {
    type Output = RevokeGrantResponse;
    type Error = RevokeGrantError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<RevokeGrantResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for ScheduleKeyDeletionRequest {
    type Output = ScheduleKeyDeletionResponse;
    type Error = ScheduleKeyDeletionError;
...
impl ServiceRequest for UpdateCustomKeyStoreRequest {
    type Output = UpdateCustomKeyStoreResponse;
    type Error = UpdateCustomKeyStoreError;
...
impl ServiceRequest for UpdateKeyDescriptionRequest {
    type Output = UpdateKeyDescriptionResponse;
    type Error = UpdateKeyDescriptionError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<UpdateKeyDescriptionResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
