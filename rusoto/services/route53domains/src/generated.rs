...
pub trait Route53Domains {
    ...
    fn resend_contact_reachability_email
        (&self,
         ...
         -> RusotoFuture<ResendContactReachabilityEmailResponse,
          ...
          D: DispatchSignedRequest
{
        ...
        RusotoFuture::new({
                                ...
                                StatusCode::Ok => 
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<CheckDomainAvailabilityResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(CheckDomainAvailabilityError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn delete_tags_for_domain
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<DeleteTagsForDomainResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(DeleteTagsForDomainError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn disable_domain_auto_renew
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<DisableDomainAutoRenewResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(DisableDomainAutoRenewError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn disable_domain_transfer_lock
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<DisableDomainTransferLockResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(DisableDomainTransferLockError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn enable_domain_auto_renew
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<EnableDomainAutoRenewResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(EnableDomainAutoRenewError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn enable_domain_transfer_lock
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<EnableDomainTransferLockResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(EnableDomainTransferLockError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn get_contact_reachability_status
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<GetContactReachabilityStatusResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(GetContactReachabilityStatusError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn get_domain_detail(&self,
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<GetDomainDetailResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(GetDomainDetailError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn get_domain_suggestions
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<GetDomainSuggestionsResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(GetDomainSuggestionsError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn get_operation_detail
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<GetOperationDetailResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(GetOperationDetailError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
                                  ...
                                  .and_then(|response| match response.status {
                                                StatusCode::Ok => {
                                                    future::Either::A(response
                                                                          ...
                                                                          .map(|body| {
                serde_json::from_str::<ListDomainsResponse>(String::from_utf8_lossy(body.as_ref())
                                                                .as_ref())
                        .unwrap()
            }))
                                                }
    ...
    fn list_operations(&self,
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<ListOperationsResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(ListOperationsError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn list_tags_for_domain(&self,
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<ListTagsForDomainResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(ListTagsForDomainError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn register_domain(&self,
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<RegisterDomainResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                  ...
                                  .and_then(|response| match response.status {
                                                StatusCode::Ok => {
                                                    future::Either::A(response
                                                                          ...
                                                                          .map(|body| {
                serde_json::from_str::<RenewDomainResponse>(String::from_utf8_lossy(body.as_ref())
                                                                .as_ref())
                        .unwrap()
            }))
                                                }
                                                _ => {
                                                    future::Either::B(response
                                                                          ...
                                                                          .from_err()
                                                                          .and_then(|body| {
                Err(RenewDomainError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
            }))
                                                }
                                            })
                          })
    ...
    fn resend_contact_reachability_email
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<ResendContactReachabilityEmailResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(ResendContactReachabilityEmailError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn retrieve_domain_auth_code
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<RetrieveDomainAuthCodeResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(RetrieveDomainAuthCodeError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn transfer_domain(&self,
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<TransferDomainResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(TransferDomainError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn update_domain_contact
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<UpdateDomainContactResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(UpdateDomainContactError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn update_domain_contact_privacy
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<UpdateDomainContactPrivacyResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(UpdateDomainContactPrivacyError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn update_domain_nameservers
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<UpdateDomainNameserversResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(UpdateDomainNameserversError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
    ...
    fn update_tags_for_domain
        ...
        RusotoFuture::new({
            ...
            {
                future::Either::A(response.body.concat2().map_err(|err| err.into()).map(|body| {
                    serde_json::from_str::<UpdateTagsForDomainResponse>(String::from_utf8_lossy(body.as_ref()).as_ref()).unwrap()
                }))
            },
                                _ => {
                                    future::Either::B(response.body.concat2().from_err().and_then(|body| {
                                        Err(UpdateTagsForDomainError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
                                    }))
                                }
                            }
                        })
                                  ...
                                  .and_then(|response| match response.status {
                                                StatusCode::Ok => {
                                                    future::Either::A(response
                                                                          ...
                                                                          .map(|body| {
                serde_json::from_str::<ViewBillingResponse>(String::from_utf8_lossy(body.as_ref())
                                                                .as_ref())
                        .unwrap()
            }))
                                                }
                                                _ => {
                                                    future::Either::B(response
                                                                          ...
                                                                          .from_err()
                                                                          .and_then(|body| {
                Err(ViewBillingError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
            }))
                                                }
                                            })
                          })
