...
pub trait Glacier {
    ...
    fn abort_multipart_upload(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<AbortMultipartUploadError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<AbortVaultLockError>>> + Send + 'static>>;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<AddTagsToVaultError>>> + Send + 'static>>;
    ...
    fn complete_vault_lock(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<CompleteVaultLockError>>> + Send + 'static>,
    >;
    ...
    fn create_vault(
        ...
        Box<
            dyn Future<Output = Result<CreateVaultOutput, RusotoError<CreateVaultError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<DeleteArchiveError>>> + Send + 'static>>;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<DeleteVaultError>>> + Send + 'static>>;
    ...
    fn delete_vault_access_policy(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<DeleteVaultAccessPolicyError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_vault_notifications(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<DeleteVaultNotificationsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn describe_job(
        ...
        Box<
            dyn Future<Output = Result<GlacierJobDescription, RusotoError<DescribeJobError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn describe_vault(
        ...
        Box<
            dyn Future<Output = Result<DescribeVaultOutput, RusotoError<DescribeVaultError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<GetDataRetrievalPolicyError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn get_job_output(
        ...
        Box<
            dyn Future<Output = Result<GetJobOutputOutput, RusotoError<GetJobOutputError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<GetVaultAccessPolicyError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn get_vault_lock(
        ...
        Box<
            dyn Future<Output = Result<GetVaultLockOutput, RusotoError<GetVaultLockError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<GetVaultNotificationsError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn initiate_job(
        ...
        Box<
            dyn Future<Output = Result<InitiateJobOutput, RusotoError<InitiateJobError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<InitiateMultipartUploadError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn initiate_vault_lock(
        ...
        Box<
            dyn Future<
                    Output = Result<InitiateVaultLockOutput, RusotoError<InitiateVaultLockError>>,
                > + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<ListProvisionedCapacityError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn list_tags_for_vault(
        ...
        Box<
            dyn Future<Output = Result<ListTagsForVaultOutput, RusotoError<ListTagsForVaultError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_vaults(
        ...
        Box<
            dyn Future<Output = Result<ListVaultsOutput, RusotoError<ListVaultsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn remove_tags_from_vault(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<RemoveTagsFromVaultError>>> + Send + 'static,
        >,
    >;
    ...
    fn set_data_retrieval_policy(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<SetDataRetrievalPolicyError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn set_vault_access_policy(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<SetVaultAccessPolicyError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn set_vault_notifications(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<SetVaultNotificationsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn upload_archive(
        ...
        Box<
            dyn Future<Output = Result<ArchiveCreationOutput, RusotoError<UploadArchiveError>>>
                + Send
                + 'static,
        >,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<UploadMultipartPartError>,
                    >,
                > + Send
                + 'static,
        >,
