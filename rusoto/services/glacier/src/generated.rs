          ...
          D: DispatchSignedRequest
{
                              ...
                              .and_then(|response| match response.status {
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(AbortVaultLockError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
                              ...
                              .and_then(|response| match response.status {
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(AddTagsToVaultError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
    ...
    fn complete_multipart_upload
        ...
        RusotoFuture::new(self.dispatcher
                ...
                if let Some(archive_id) = response_headers.get("x-amz-archive-id") {
                    let value = archive_id.to_owned();
                    result.archive_id = Some(value)
                };
                if let Some(checksum) = response_headers.get("x-amz-sha256-tree-hash") {
                ...
                result
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(CompleteMultipartUploadError::from_body(String::from_utf8_lossy(body.as_ref())
                                                            .as_ref()))
        }))
                                            }
                                        }))
                              ...
                              .and_then(|response| match response.status {
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(CompleteVaultLockError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
                ...
                result
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(CreateVaultError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
                              ...
                              .and_then(|response| match response.status {
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(DeleteArchiveError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
                              ...
                              .and_then(|response| match response.status {
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(DeleteVaultError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
                              ...
                              .and_then(|response| match response.status {
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(DeleteVaultAccessPolicyError::from_body(String::from_utf8_lossy(body.as_ref())
                                                            .as_ref()))
        }))
                                            }
                                        }))
                              ...
                              .and_then(|response| match response.status {
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(DeleteVaultNotificationsError::from_body(String::from_utf8_lossy(body.as_ref())
                                                             .as_ref()))
        }))
                                            }
                                        }))
                ...
                result
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(DescribeVaultError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
    ...
    fn get_job_output(&self,
        ...
        RusotoFuture::new(self.dispatcher
                ...
                if let Some(archive_description) =
                    response_headers.get("x-amz-archive-description") {
                ...
                if let Some(content_range) = response_headers.get("Content-Range") {
                ...
                result
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(GetJobOutputError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
                ...
                result
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(GetVaultLockError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
    ...
    fn initiate_job(&self,
        ...
        RusotoFuture::new(self.dispatcher
                ...
                if let Some(job_id) = response_headers.get("x-amz-job-id") {
                ...
                result
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(InitiateJobError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
    ...
    fn initiate_multipart_upload
        ...
        RusotoFuture::new(self.dispatcher
                ...
                if let Some(upload_id) = response_headers.get("x-amz-multipart-upload-id") {
                ...
                result
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(InitiateMultipartUploadError::from_body(String::from_utf8_lossy(body.as_ref())
                                                            .as_ref()))
        }))
                                            }
                                        }))
    ...
    fn initiate_vault_lock(&self,
        ...
        RusotoFuture::new(self.dispatcher
                ...
                if let Some(lock_id) = response_headers.get("x-amz-lock-id") {
                ...
                result
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(InitiateVaultLockError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
                ...
                result
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(ListProvisionedCapacityError::from_body(String::from_utf8_lossy(body.as_ref())
                                                            .as_ref()))
        }))
                                            }
                                        }))
                ...
                result
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(ListTagsForVaultError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
                ...
                result
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(ListVaultsError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
    ...
    fn purchase_provisioned_capacity
        ...
        RusotoFuture::new(self.dispatcher
                ...
                if let Some(capacity_id) = response_headers.get("x-amz-capacity-id") {
                ...
                result
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(PurchaseProvisionedCapacityError::from_body(String::from_utf8_lossy(body.as_ref())
                                                                .as_ref()))
        }))
                                            }
                                        }))
                ...
                result
                                            ...
                                            _ => {
                                                future::Either::B(response
                                                                      ...
                                                                      .from_err()
                                                                      .and_then(|body| {
            Err(UploadArchiveError::from_body(String::from_utf8_lossy(body.as_ref()).as_ref()))
        }))
                                            }
                                        }))
    }
