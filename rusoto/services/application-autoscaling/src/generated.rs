...
impl DeleteScalingPolicyError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<DeleteScalingPolicyError> {
        match err {
...
impl DeregisterScalableTargetError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DeregisterScalableTargetError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DescribeScalableTargetsError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DescribeScalableTargetsError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl DescribeScalingPoliciesError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<DescribeScalingPoliciesError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl PutScheduledActionError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<PutScheduledActionError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl RegisterScalableTargetError {
    ...
    fn refine(
        err: RusotoError<std::convert::Infallible>,
    ) -> RusotoError<RegisterScalableTargetError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ApplicationAutoScaling for ApplicationAutoScalingClient {
    ...
    async fn delete_scaling_policy(
        ...
        let response = self
            ...
            .await
            .map_err(DeleteScalingPolicyError::refine)?;
    ...
    async fn deregister_scalable_target(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DeregisterScalableTargetError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn describe_scalable_targets(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeScalableTargetsError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn describe_scaling_policies(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(DescribeScalingPoliciesError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
    ...
    async fn put_scheduled_action(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(PutScheduledActionError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn register_scalable_target(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(RegisterScalableTargetError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
        proto::json::ResponsePayload::new(&response)
