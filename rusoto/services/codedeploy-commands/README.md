...
# Rusoto CodeDeployCommands
Rust SDK for AWS CodeDeploy Command Service
...
To use `rusoto_codedeploy_commands` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
rusoto_codedeploy_commands = "0.32.0"
```
