...
impl CompleteSnapshotError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<CompleteSnapshotError> {
        match err {
...
impl GetSnapshotBlockError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<GetSnapshotBlockError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ListChangedBlocksError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<ListChangedBlocksError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ListSnapshotBlocksError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<ListSnapshotBlocksError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl PutSnapshotBlockError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<PutSnapshotBlockError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl StartSnapshotError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<StartSnapshotError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
