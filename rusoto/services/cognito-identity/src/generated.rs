...
pub trait CognitoIdentity {
    ...
    fn create_identity_pool(
        ...
        Box<
            dyn Future<Output = Result<IdentityPool, RusotoError<CreateIdentityPoolError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_identities(
        ...
        Box<
            dyn Future<
                    Output = Result<DeleteIdentitiesResponse, RusotoError<DeleteIdentitiesError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn delete_identity_pool(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<DeleteIdentityPoolError>>> + Send + 'static>,
    >;
    ...
    fn describe_identity(
        ...
        Box<
            dyn Future<Output = Result<IdentityDescription, RusotoError<DescribeIdentityError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn describe_identity_pool(
        ...
        Box<
            dyn Future<Output = Result<IdentityPool, RusotoError<DescribeIdentityPoolError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_id(
        ...
        Box<dyn Future<Output = Result<GetIdResponse, RusotoError<GetIdError>>> + Send + 'static>,
    >;
    ...
    fn get_open_id_token(
        ...
        Box<
            dyn Future<Output = Result<GetOpenIdTokenResponse, RusotoError<GetOpenIdTokenError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_identity_pools(
        ...
        Box<
            dyn Future<
                    Output = Result<ListIdentityPoolsResponse, RusotoError<ListIdentityPoolsError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn set_identity_pool_roles(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<SetIdentityPoolRolesError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn unlink_developer_identity(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<UnlinkDeveloperIdentityError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<UnlinkIdentityError>>> + Send + 'static>>;
    ...
    fn update_identity_pool(
        ...
        Box<
            dyn Future<Output = Result<IdentityPool, RusotoError<UpdateIdentityPoolError>>>
                + Send
                + 'static,
        >,
    >;
