...
pub trait MarketplaceMetering {
    ...
    fn batch_meter_usage(
        ...
        Box<
            dyn Future<Output = Result<BatchMeterUsageResult, RusotoError<BatchMeterUsageError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn meter_usage(
        ...
        Box<
            dyn Future<Output = Result<MeterUsageResult, RusotoError<MeterUsageError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn register_usage(
        ...
        Box<
            dyn Future<Output = Result<RegisterUsageResult, RusotoError<RegisterUsageError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn resolve_customer(
        ...
        Box<
            dyn Future<Output = Result<ResolveCustomerResult, RusotoError<ResolveCustomerError>>>
                + Send
                + 'static,
        >,
    >;
