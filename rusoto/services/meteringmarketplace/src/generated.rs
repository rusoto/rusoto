...
impl BatchMeterUsageError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<BatchMeterUsageError> {
        match err {
...
impl MeterUsageError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<MeterUsageError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl RegisterUsageError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<RegisterUsageError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl ResolveCustomerError {
    ...
    fn refine(err: RusotoError<std::convert::Infallible>) -> RusotoError<ResolveCustomerError> {
        match err {
            RusotoError::Service(err) => match err {},
            RusotoError::HttpDispatch(err) => RusotoError::HttpDispatch(err),
            RusotoError::Credentials(err) => RusotoError::Credentials(err),
...
impl MarketplaceMetering for MarketplaceMeteringClient {
    ...
    async fn batch_meter_usage(
        ...
        let response = self
            ...
            .await
            .map_err(BatchMeterUsageError::refine)?;
    ...
    async fn meter_usage(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(MeterUsageError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn register_usage(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(RegisterUsageError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
    ...
    async fn resolve_customer(
        ...
        let response = self
            .sign_and_dispatch(request)
            .await
            .map_err(ResolveCustomerError::refine)?;
        let mut response = response;
        let response = response.buffer().await.map_err(RusotoError::HttpDispatch)?;
