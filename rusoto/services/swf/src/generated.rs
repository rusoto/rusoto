...
#[derive(Default, Debug, Clone, PartialEq, Serialize)]
pub struct CountClosedWorkflowExecutionsRequest {
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct CountClosedWorkflowExecutionsResponse {
...
#[derive(Default, Debug, Clone, PartialEq, Serialize)]
pub struct CountOpenWorkflowExecutionsRequest {
    /// <p>The name of the domain containing the workflow executions to count.</p>
    #[serde(rename = "domain")]
    pub domain: String,
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct CountOpenWorkflowExecutionsResponse {
    /// <p>The number of workflow executions.</p>
    #[serde(rename = "count")]
    pub count: i64,
    /// <p>If set to true, indicates that the actual count was more than the maximum supported by this API and the count returned is the truncated value.</p>
...
#[derive(Default, Debug, Clone, PartialEq, Serialize)]
pub struct CountPendingActivityTasksRequest {
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct CountPendingActivityTasksResponse {
...
#[derive(Default, Debug, Clone, PartialEq, Serialize)]
pub struct CountPendingDecisionTasksRequest {
    /// <p>The name of the domain that contains the task list.</p>
    #[serde(rename = "domain")]
    pub domain: String,
    /// <p>The name of the task list.</p>
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct CountPendingDecisionTasksResponse {
    /// <p>The number of tasks in the task list.</p>
    #[serde(rename = "count")]
    pub count: i64,
    /// <p>If set to true, indicates that the actual count was more than the maximum supported by this API and the count returned is the truncated value.</p>
...
#[derive(Default, Debug, Clone, PartialEq, Serialize)]
pub struct DeprecateActivityTypeRequest {
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DeprecateActivityTypeResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DeprecateWorkflowTypeResponse {}

#[derive(Default, Debug, Clone, PartialEq, Serialize)]
pub struct DescribeActivityTypeRequest {
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DescribeActivityTypeResponse {
...
#[derive(Default, Debug, Clone, PartialEq, Serialize)]
pub struct DescribeWorkflowTypeRequest {
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct DescribeWorkflowTypeResponse {
...
#[derive(Default, Debug, Clone, PartialEq, Serialize)]
pub struct ListWorkflowTypesRequest {
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct ListWorkflowTypesResponse {
    /// <p>If a <code>NextPageToken</code> was returned by a previous call, there are more results available. To retrieve the next page of results, make the call again using the returned token in <code>nextPageToken</code>. Keep all other arguments unchanged.</p> <p>The configured <code>maximumPageSize</code> determines how many results can be returned in a single call.</p>
    #[serde(rename = "nextPageToken")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub next_page_token: Option<String>,
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct RegisterActivityTypeResponse {}
...
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
pub struct RegisterWorkflowTypeResponse {}
...
pub trait Swf {
    ...
    fn count_closed_workflow_executions(
        &self,
        input: CountClosedWorkflowExecutionsRequest,
    ...
    fn count_open_workflow_executions(
        &self,
        input: CountOpenWorkflowExecutionsRequest,
    ...
    fn count_pending_activity_tasks(
        &self,
        input: CountPendingActivityTasksRequest,
    ...
    fn count_pending_decision_tasks(
        &self,
        input: CountPendingDecisionTasksRequest,
    ...
    fn deprecate_activity_type(
        &self,
        input: DeprecateActivityTypeRequest,
    ...
    fn deprecate_domain(&self, input: DeprecateDomainRequest) -> Request<DeprecateDomainRequest>;
    ...
    fn deprecate_workflow_type(
        &self,
        input: DeprecateWorkflowTypeRequest,
    ...
    fn describe_activity_type(
        &self,
        input: DescribeActivityTypeRequest,
    ...
    fn describe_workflow_type(
        &self,
        input: DescribeWorkflowTypeRequest,
    ...
    fn list_activity_types(
        &self,
        input: ListActivityTypesRequest,
    ...
    fn list_closed_workflow_executions(
        &self,
        input: ListClosedWorkflowExecutionsRequest,
    ...
    fn list_open_workflow_executions(
        &self,
        input: ListOpenWorkflowExecutionsRequest,
    ...
    fn list_workflow_types(
        &self,
        input: ListWorkflowTypesRequest,
    ...
    fn poll_for_activity_task(
        &self,
        input: PollForActivityTaskRequest,
    ...
    fn poll_for_decision_task(
        &self,
        input: PollForDecisionTaskRequest,
    ...
    fn register_activity_type(
        &self,
        input: RegisterActivityTypeRequest,
    ...
    fn register_domain(&self, input: RegisterDomainRequest) -> Request<RegisterDomainRequest>;
    ...
    fn register_workflow_type(
        &self,
        input: RegisterWorkflowTypeRequest,
    ...
    fn respond_decision_task_completed(
        &self,
        input: RespondDecisionTaskCompletedRequest,
...
impl ServiceRequest for CountClosedWorkflowExecutionsRequest {
    type Output = CountClosedWorkflowExecutionsResponse;
    type Error = CountClosedWorkflowExecutionsError;
    ...
    fn dispatch(
        ...
        let mut request = SignedRequest::new("POST", "swf", region, "/");
            ...
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<CountClosedWorkflowExecutionsResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for CountOpenWorkflowExecutionsRequest {
    type Output = CountOpenWorkflowExecutionsResponse;
    type Error = CountOpenWorkflowExecutionsError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<CountOpenWorkflowExecutionsResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for CountPendingActivityTasksRequest {
    type Output = CountPendingActivityTasksResponse;
    type Error = CountPendingActivityTasksError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<CountPendingActivityTasksResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for CountPendingDecisionTasksRequest {
    type Output = CountPendingDecisionTasksResponse;
    type Error = CountPendingDecisionTasksError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<CountPendingDecisionTasksResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DeprecateActivityTypeRequest {
    type Output = DeprecateActivityTypeResponse;
    type Error = DeprecateActivityTypeError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeprecateActivityTypeResponse, _>()
                }))
            } else {
                Box::new(
...
impl ServiceRequest for DeprecateDomainRequest {
    type Output = DeprecateDomainResponse;
    type Error = DeprecateDomainError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeprecateDomainResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for DeprecateWorkflowTypeRequest {
    type Output = DeprecateWorkflowTypeResponse;
    type Error = DeprecateWorkflowTypeError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DeprecateWorkflowTypeResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DescribeActivityTypeRequest {
    type Output = DescribeActivityTypeResponse;
    type Error = DescribeActivityTypeError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DescribeActivityTypeResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DescribeWorkflowExecutionRequest {
    type Output = DescribeWorkflowExecutionResponse;
    type Error = DescribeWorkflowExecutionError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DescribeWorkflowExecutionResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for DescribeWorkflowTypeRequest {
    type Output = DescribeWorkflowTypeResponse;
    type Error = DescribeWorkflowTypeError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<DescribeWorkflowTypeResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for GetWorkflowExecutionHistoryRequest {
    type Output = GetWorkflowExecutionHistoryResponse;
    type Error = GetWorkflowExecutionHistoryError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<GetWorkflowExecutionHistoryResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for ListActivityTypesRequest {
    type Output = ListActivityTypesResponse;
    type Error = ListActivityTypesError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<ListActivityTypesResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for ListClosedWorkflowExecutionsRequest {
    type Output = ListClosedWorkflowExecutionsResponse;
    type Error = ListClosedWorkflowExecutionsError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<ListClosedWorkflowExecutionsResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for ListOpenWorkflowExecutionsRequest {
    type Output = ListOpenWorkflowExecutionsResponse;
    type Error = ListOpenWorkflowExecutionsError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<ListOpenWorkflowExecutionsResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for ListWorkflowTypesRequest {
    type Output = ListWorkflowTypesResponse;
    type Error = ListWorkflowTypesError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<ListWorkflowTypesResponse, _>()
                }))
            } else {
                Box::new(
                    response
...
impl ServiceRequest for PollForActivityTaskRequest {
    type Output = PollForActivityTaskResponse;
    type Error = PollForActivityTaskError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<PollForActivityTaskResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for PollForDecisionTaskRequest {
    type Output = PollForDecisionTaskResponse;
    type Error = PollForDecisionTaskError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<PollForDecisionTaskResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for RecordActivityTaskHeartbeatRequest {
    type Output = RecordActivityTaskHeartbeatResponse;
    type Error = RecordActivityTaskHeartbeatError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<RecordActivityTaskHeartbeatResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for RegisterActivityTypeRequest {
    type Output = RegisterActivityTypeResponse;
    type Error = RegisterActivityTypeError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<RegisterActivityTypeResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for RegisterDomainRequest {
    type Output = RegisterDomainResponse;
    type Error = RegisterDomainError;
...
impl ServiceRequest for RegisterWorkflowTypeRequest {
    type Output = RegisterWorkflowTypeResponse;
    type Error = RegisterWorkflowTypeError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<RegisterWorkflowTypeResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for RequestCancelWorkflowExecutionRequest {
    type Output = RequestCancelWorkflowExecutionResponse;
    type Error = RequestCancelWorkflowExecutionError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<RequestCancelWorkflowExecutionResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for RespondActivityTaskCanceledRequest {
    type Output = RespondActivityTaskCanceledResponse;
    type Error = RespondActivityTaskCanceledError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<RespondActivityTaskCanceledResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for RespondActivityTaskCompletedRequest {
    type Output = RespondActivityTaskCompletedResponse;
    type Error = RespondActivityTaskCompletedError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<RespondActivityTaskCompletedResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for RespondActivityTaskFailedRequest {
    type Output = RespondActivityTaskFailedResponse;
    type Error = RespondActivityTaskFailedError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<RespondActivityTaskFailedResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for RespondDecisionTaskCompletedRequest {
    type Output = RespondDecisionTaskCompletedResponse;
    type Error = RespondDecisionTaskCompletedError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<RespondDecisionTaskCompletedResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for SignalWorkflowExecutionRequest {
    type Output = SignalWorkflowExecutionResponse;
    type Error = SignalWorkflowExecutionError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<SignalWorkflowExecutionResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for StartWorkflowExecutionRequest {
    type Output = StartWorkflowExecutionResponse;
    type Error = StartWorkflowExecutionError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<StartWorkflowExecutionResponse, _>()
                }))
            } else {
                Box::new(
                    response.buffer().from_err().and_then(|response| {
...
impl ServiceRequest for TerminateWorkflowExecutionRequest {
    type Output = TerminateWorkflowExecutionResponse;
    type Error = TerminateWorkflowExecutionError;
    ...
    fn dispatch(
        ...
        dispatcher.dispatch(request, |response| {
            if response.status.is_success() {
                Box::new(response.buffer().from_err().and_then(|response| {
                    proto::json::ResponsePayload::new(&response)
                        .deserialize::<TerminateWorkflowExecutionResponse, _>()
                }))
            } else {
                Box::new(response.buffer().from_err().and_then(|response| {
