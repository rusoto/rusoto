...
pub trait Swf {
    ...
    fn count_pending_activity_tasks(
        ...
        Box<
            dyn Future<
                    Output = Result<PendingTaskCount, RusotoError<CountPendingActivityTasksError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn count_pending_decision_tasks(
        ...
        Box<
            dyn Future<
                    Output = Result<PendingTaskCount, RusotoError<CountPendingDecisionTasksError>>,
                > + Send
                + 'static,
        >,
    >;
    ...
    fn deprecate_activity_type(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<DeprecateActivityTypeError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<DeprecateDomainError>>> + Send + 'static>>;
    ...
    fn deprecate_workflow_type(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<DeprecateWorkflowTypeError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn describe_activity_type(
        ...
        Box<
            dyn Future<Output = Result<ActivityTypeDetail, RusotoError<DescribeActivityTypeError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn describe_domain(
        ...
        Box<
            dyn Future<Output = Result<DomainDetail, RusotoError<DescribeDomainError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn describe_workflow_type(
        ...
        Box<
            dyn Future<Output = Result<WorkflowTypeDetail, RusotoError<DescribeWorkflowTypeError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn get_workflow_execution_history(
        ...
        Box<
            dyn Future<Output = Result<History, RusotoError<GetWorkflowExecutionHistoryError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_activity_types(
        ...
        Box<
            dyn Future<Output = Result<ActivityTypeInfos, RusotoError<ListActivityTypesError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_domains(
        ...
        Box<
            dyn Future<Output = Result<DomainInfos, RusotoError<ListDomainsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn list_workflow_types(
        ...
        Box<
            dyn Future<Output = Result<WorkflowTypeInfos, RusotoError<ListWorkflowTypesError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn poll_for_activity_task(
        ...
        Box<
            dyn Future<Output = Result<ActivityTask, RusotoError<PollForActivityTaskError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn poll_for_decision_task(
        ...
        Box<
            dyn Future<Output = Result<DecisionTask, RusotoError<PollForDecisionTaskError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn register_activity_type(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<RegisterActivityTypeError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    ) -> Pin<Box<dyn Future<Output = Result<(), RusotoError<RegisterDomainError>>> + Send + 'static>>;
    ...
    fn register_workflow_type(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<RegisterWorkflowTypeError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn request_cancel_workflow_execution(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<RequestCancelWorkflowExecutionError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn respond_activity_task_canceled(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<RespondActivityTaskCanceledError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn respond_activity_task_completed(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<RespondActivityTaskCompletedError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn respond_activity_task_failed(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<RespondActivityTaskFailedError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn respond_decision_task_completed(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<RespondDecisionTaskCompletedError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn signal_workflow_execution(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<SignalWorkflowExecutionError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn start_workflow_execution(
        ...
        Box<
            dyn Future<Output = Result<Run, RusotoError<StartWorkflowExecutionError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn terminate_workflow_execution(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<TerminateWorkflowExecutionError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn undeprecate_activity_type(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<UndeprecateActivityTypeError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn undeprecate_domain(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<UndeprecateDomainError>>> + Send + 'static>,
    >;
    ...
    fn undeprecate_workflow_type(
        &self,
        input: UndeprecateWorkflowTypeInput,
    ) -> Pin<
        Box<
            dyn Future<Output = Result<(), RusotoError<UndeprecateWorkflowTypeError>>>
                + Send
                + 'static,
        >,
    >;
