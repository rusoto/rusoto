...
pub trait Efs {
    ...
    fn create_access_point(
        ...
        Box<
            dyn Future<Output = Result<AccessPointDescription, RusotoError<CreateAccessPointError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn create_file_system(
        ...
        Box<
            dyn Future<Output = Result<FileSystemDescription, RusotoError<CreateFileSystemError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn create_mount_target(
        ...
        Box<
            dyn Future<Output = Result<MountTargetDescription, RusotoError<CreateMountTargetError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_access_point(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<DeleteAccessPointError>>> + Send + 'static>,
    >;
    ...
    fn delete_file_system(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<DeleteFileSystemError>>> + Send + 'static>,
    >;
    ...
    fn delete_file_system_policy(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<DeleteFileSystemPolicyError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn delete_mount_target(
        ...
        Box<dyn Future<Output = Result<(), RusotoError<DeleteMountTargetError>>> + Send + 'static>,
    >;
        ...
        Box<
            dyn Future<
                    Output = Result<
                        ...
                        RusotoError<DescribeFileSystemsError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn describe_tags(
        ...
        Box<
            dyn Future<Output = Result<DescribeTagsResponse, RusotoError<DescribeTagsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn modify_mount_target_security_groups(
        ...
        Box<
            dyn Future<Output = Result<(), RusotoError<ModifyMountTargetSecurityGroupsError>>>
                + Send
                + 'static,
        >,
    >;
    ...
    fn put_file_system_policy(
        ...
        Box<
            dyn Future<
                    Output = Result<
                        FileSystemPolicyDescription,
                        RusotoError<PutFileSystemPolicyError>,
                    >,
                > + Send
                + 'static,
        >,
    ...
    fn update_file_system(
        ...
        Box<
            dyn Future<Output = Result<FileSystemDescription, RusotoError<UpdateFileSystemError>>>
                + Send
                + 'static,
        >,
    >;
