...
impl Service {
    ...
    pub fn service_type_name(&self) -> &str {
        match &self.metadata.service_full_name[..] {
            ...
            "AWS Cost and Usage Report Service" => "CostAndUsageReportService",
            ...
            "AWS Health APIs and Notifications" => "HealthAndNotifications",
            ...
            "AWS OpsWorks for Chef Automate" => "OpsWorksChefAutomate",
            ...
            // Not sure if we want to panic or just skip this one, as new services
            // in botocore causes compilation to fail.
