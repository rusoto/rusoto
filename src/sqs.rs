...
//!
//! Check
//! [SQSHelper](http://dualspark.github.io/rusoto/rusoto/sqs/struct.SQSHelper.html) for
...
use xmlutil::{Next, Peek, XmlParseError, XmlResponseFromAws, characters, end_element,
              peek_at_name, start_element};
