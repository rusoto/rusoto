...
fn main() {
	...
	// match s3_list_multipart_uploads(&mut s3, "blehbucket2222") {
	...
	// // }
	//
	match s3_multipart_upload_test(&mut s3, "blehbucket2222") {
	...
	// }
	//
	// match s3_put_object_test(&mut s3, "blehbucket2222") {
	// 	Ok(_) => {
